...
IF (CMAKE_ANSI_CXXFLAGS MATCHES "[^ ]")
  SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${CMAKE_ANSI_CXXFLAGS}")
ENDIF (CMAKE_ANSI_CXXFLAGS MATCHES "[^ ]")
IF (CMAKE_ANSI_CFLAGS MATCHES "[^ ]")
  SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${CMAKE_ANSI_CFLAGS}")
ENDIF (CMAKE_ANSI_CFLAGS MATCHES "[^ ]")

IF(CMAKE_TEMPLATE_FLAGS MATCHES "[^ ]")
  SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${CMAKE_TEMPLATE_FLAGS}")
ENDIF(CMAKE_TEMPLATE_FLAGS MATCHES "[^ ]")
