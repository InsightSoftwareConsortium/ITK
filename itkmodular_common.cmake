# ITK Modular Common Dashboard Script
#
...
# Submit to the separate public "ITKModular" dashboard from this script.
#   (Intentionally overriding CTestConfig.cmake)
set(main_project_name "ITKModular")
macro(override_drop_settings)
  set(CTEST_DROP_METHOD "http")
  set(CTEST_DROP_SITE "www.cdash.org")
  set(CTEST_DROP_LOCATION "/CDash/submit.php?project=${main_project_name}")
endmacro()
...
while(NOT dashboard_done)
  ...
  if(dashboard_fresh OR NOT dashboard_continuous OR count GREATER 0)
    ...
    include("${CTEST_BINARY_DIRECTORY}/${main_project_name}.SubProjects.cmake")
    if(NOT dashboard_no_submit)
    ...
    foreach(subproj ${itk_subprojects})
      ...
      ctest_build(BUILD "${CTEST_BINARY_DIRECTORY}" TARGET "${subproj}-all" APPEND)
      if(NOT dashboard_no_submit)
      ...
      if(dashboard_do_coverage)
        ...
        ctest_coverage(BUILD "${CTEST_BINARY_DIRECTORY}" LABELS "${subproj}")
        if(NOT dashboard_no_submit)
