...
meeting](https://web.archive.org/web/20120313011742/http://visual.nlm.nih.gov/itk/itk2010/agenda.html) for this
...
-   Adopt a code review system
    -   ITK Gerrit (since retired; ITK now uses GitHub pull requests at
...
-   [Modern C++](https://insightsoftwareconsortium.github.io/ITKWikiArchive/Wiki/ITK_Release_4/Modern_C%252B%252B/)
...
-   [Refactoring itk::FEM framework -
    V4](https://insightsoftwareconsortium.github.io/ITKWikiArchive/Wiki/ITK_Release_4/Refactoring_FEM_Framework/)

### Level Sets

-   [Refactoring Level-Set framework -
    V4](https://insightsoftwareconsortium.github.io/ITKWikiArchive/Wiki/ITK/Release_4/Refactoring_Level_Set_Framework/Refactoring_Level_Set_Framework/)
...
-   [GPU Acceleration - V4 (deprecated
    link)](https://insightsoftwareconsortium.github.io/ITKWikiArchive/Wiki/ITK_Release_4/GPU_Acceleration/GPU_Acceleration/)
