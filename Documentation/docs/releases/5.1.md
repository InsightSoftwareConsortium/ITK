...
In addition to the [`ImageBufferRange`](https://docs.itk.org/projects/doxygen/en/stable/classitk_1_1ImageBufferRange.html), [`ShapedImageNeighborhoodRange`](https://docs.itk.org/projects/doxygen/en/stable/classitk_1_1ShapedImageNeighborhoodRange.html), and [`IndexRange`](https://docs.itk.org/projects/doxygen/en/stable/classitk_1_1IndexRange.html) classes introduced in ITK 5.0, ITK 5.1 adds an [`ImageRegionRange`](https://docs.itk.org/projects/doxygen/en/stable/classitk_1_1ImageRegionRange.html). These range classes conform to the Standard C++ Iterator requirements so they can be used in range-based for loop's and passed to Standard C++ algorithms. Range-based for loops provide an elegant syntax for iteration. Moreover, they are often more performant than other iteration classes available.
...
A guide for updating to the new enum's can be found in the [Strongly Typed Enumerations](https://github.com/InsightSoftwareConsortium/ITK/blob/main/Documentation/docs/migration_guides/itk_5_migration_guide.md#strongly-typed-enumerations) section of the ITK 5 Migration Guide.
