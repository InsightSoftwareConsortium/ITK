...
1.  Improving features binary erode and dilate
    [1](https://www.insight-journal.org/browse/publication/80)
    (Shepherd: Gaetan Lehman) \[now in CVS\]
2.  An ITK Filter for Bayesian Segmentation:
    itkBayesianClassifierImageFilter
    [2](https://www.insight-journal.org/browse/publication/69)
    (Shepherd: Karthik Krishnan)
3.  Watershed transform
    [3](https://www.insight-journal.org/browse/publication/92)
    (Shepherd: Gaetan Lehman)
4.  Label Overlay
    [4](https://www.insight-journal.org/browse/publication/79)
    (Shepherd: Andinet Enquobahrie) \[now in CVS Review\]
5.  Finding regional extrema - methods and performance
    [5](https://www.insight-journal.org/browse/publication/65)
    (Shepherd: Andinet Enquobahrie) \[now in CVS Review\]
6.  Neural Networks IO
    [6](https://www.insight-journal.org/browse/publication/93)
    (Shepherd: Stephen Aylward) \[now in CVS Review\]
7.  Contour Extractor 2D
    [7](https://www.insight-journal.org/browse/publication/72)
    (Shepherd: Andinet Enquobahrie) \[now in CVS Review\]
8.  Image projections along an axis
    [8](https://www.insight-journal.org/browse/publication/71)
    (Shepherd: Andinet Enquobahrie) \[now in CVS Review\]
9.  itk Quad Mesh
    [9](https://www.insight-journal.org/browse/publication/122)
...
10. Using a mask to decrease computation for Spatial Object to image
    [10](https://www.insight-journal.org/browse/publication/117)
    (Shepherd: Julien Jomier)
11. Conformal Flattening ITK Filter
    [11](https://www.insight-journal.org/browse/publication/112)
    (Shepherd: Sylvain Jaume) \[now in CVS Review\]
12. Improving performance of morphological reconstruction
    [12](https://www.insight-journal.org/browse/publication/76)
13. Optimization of connected component labelling
    [13](https://www.insight-journal.org/browse/publication/75)
...
1.  Probability Distributions for the Insight Toolkit
    [14](https://www.insight-journal.org/browse/publication/68)
    (Shepherd: Stephen Aylward) \[now in CVS Review\]
