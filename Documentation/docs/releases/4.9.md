...
`  Web browser reproducibility: `[`https://wasm.itk.org/`](https://wasm.itk.org/)

-   Core Improvements

`External Modules can now be developed outside of the ITK source tree and on GitHub`\
`Details: `[`https://docs.itk.org/en/latest/contributing/module_workflows.html`](https://docs.itk.org/en/latest/contributing/module_workflows.html)\
