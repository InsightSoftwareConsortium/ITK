...
//
//  The \itkref{PointSet} class was designed to interact with the
...
main(int, char *[])
{
  ...
  //  \itkref{VectorContainer} while dynamic point sets will use an
  //  \itkref{MapContainer}.  The type of the data container is defined as
