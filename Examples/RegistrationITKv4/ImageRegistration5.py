...
if len(argv) < 4:
    ...
    'Missing Parameters'
    print
    'Usage: ImageRegistration5.py fixedImageFile  movingImageFile',
    'outputImagefile'
    exit()
...
centerFixed = (fixedOrigin.GetElement(0)
...
centerMoving = (movingOrigin.GetElement(0)
...
"Initial Parameters: "
print
"Angle: %f" % (initialParameters.GetElement(0),)
print
"Center: %f, %f" \
...
def iterationUpdate():
    ...
    print
    "M: %f   P: %f %f %f %f %f " % (optimizer.GetValue(),
...
print
"Angle in radians  = %f" % finalParameters.GetElement(0)
print
"Rotation Center X = %f" % finalParameters.GetElement(1)
print
"Rotation Center Y = %f" % finalParameters.GetElement(2)
print
"Translation in  X = %f" % finalParameters.GetElement(3)
print
"Translation in  Y = %f" % finalParameters.GetElement(4)
