...
//                   FILTER.
//
// The use of the \itkref{CurvesLevelSetImageFilter} is
...
// \itkref{ShapeDetectionLevelSetImageFilter} by the addition of a third
...
// an initial level set in the form of an \itkref{Image}. The second input
...
// \itkref{FastMarchingImageFilter} in order to compute the distance map. A
...
main(int argc, char * argv[])
{
  ...
  //  the \itkref{SigmoidImageFilter} are presented in
