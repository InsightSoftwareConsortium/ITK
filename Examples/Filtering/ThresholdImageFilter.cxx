...
// \itkcaption{ThresholdImageFilter using the threshold-below mode.}
...
// \itkcaption{ThresholdImageFilter using the threshold-above mode.}
...
// \itkcaption{ThresholdImageFilter using the threshold-outside mode.}
