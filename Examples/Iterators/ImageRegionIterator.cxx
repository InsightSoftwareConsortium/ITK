...
// The \itkref{ImageRegionIterator} is optimized for
...
// \itkref{ImageRegionConstIterator} and ImageRegionIterator.
...
main(int argc, char * argv[])
{
  ...
  // The subregion is defined by an \itkref{ImageRegion} object, with a
