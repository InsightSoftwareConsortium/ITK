...
# help@hdfgroup.org.
#
if (FALSE) # XXX(kitware): avoid this showing up in ITK's cache file
option (USE_LIBAEC_STATIC "Use static AEC library " OFF)
else ()
set (USE_LIBAEC_STATIC OFF)
endif ()
...
if (FALSE) # XXX(kitware): disallow external support.
...
endif () # XXX(kitware): disallow external support
...
endif () # XXX(kitware): no need for szip support.
