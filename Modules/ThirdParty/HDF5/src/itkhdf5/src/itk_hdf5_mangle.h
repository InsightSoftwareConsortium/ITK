...
Linux: nm -g lib/libitkhdf5* 2> /dev/null | grep " [TDRS] " | awk '{ print $3 }' | awk '{ sub(/itk_/, ""); print }' | sed 's/\(.*\)/#define \1\ itk_\1/' | sort -u
...
6) The sort commands sorts the lines alphabetically and discards duplicates.
...
#define H5AC_ind_read_dxpl_id itk_H5AC_ind_read_dxpl_id
...
#define H5AC_noio_dxpl_id itk_H5AC_noio_dxpl_id
...
#define H5A__term_deprec_interface itk_H5A__term_deprec_interface
...
#define H5A_exists_by_name itk_H5A_exists_by_name
#define H5A_free itk_H5A_free
#define H5A_get_ainfo itk_H5A_get_ainfo
#define H5A_get_create_plist itk_H5A_get_create_plist
...
#define H5A_get_type itk_H5A_get_type
...
#define H5A_open_common itk_H5A_open_common
#define H5A_read itk_H5A_read
#define H5A_rename_by_name itk_H5A_rename_by_name
...
#define H5A_write itk_H5A_write
...
#define H5D__chunk_dest itk_H5D__chunk_dest
...
#define H5D__chunk_init itk_H5D__chunk_init
#define H5D__chunk_is_space_alloc itk_H5D__chunk_is_space_alloc
#define H5D__chunk_lock itk_H5D__chunk_lock
...
#define H5D__chunk_unlock itk_H5D__chunk_unlock
...
#define H5D__get_dxpl_cache itk_H5D__get_dxpl_cache
...
#define H5D__pre_write itk_H5D__pre_write
...
#define H5D__term_deprec_interface itk_H5D__term_deprec_interface
#define H5D__term_pub_interface itk_H5D__term_pub_interface
...
#define H5D_get_space itk_H5D_get_space
#define H5D_get_type itk_H5D_get_type
...
#define H5E__term_deprec_interface itk_H5E__term_deprec_interface
...
#define H5FD_direct_term itk_H5FD_direct_term
...
#define H5FS_sect_query_last_sect itk_H5FS_sect_query_last_sect
...
#define H5F_alloc itk_H5F_alloc
...
#define H5F_close itk_H5F_close
...
#define H5F_get_file_image itk_H5F_get_file_image
...
#define H5F_is_hdf5 itk_H5F_is_hdf5
...
#define H5F_set_libver_bounds itk_H5F_set_libver_bounds
...
#define H5F_super_ext_remove_msg itk_H5F_super_ext_remove_msg
...
#define H5F_try_extend itk_H5F_try_extend
...
#define H5G__init itk_H5G__init
...
#define H5G__loc_copy itk_H5G__loc_copy
...
#define H5G__term_deprec_interface itk_H5G__term_deprec_interface
...
#define H5HF_space_create_root itk_H5HF_space_create_root
...
#define H5HF_space_revert_root itk_H5HF_space_revert_root
...
#define H5L_exists itk_H5L_exists
...
#define H5L_link_copy_file itk_H5L_link_copy_file
...
#define H5MF_add_sect itk_H5MF_add_sect
...
#define H5MF_alloc_to_fs_type itk_H5MF_alloc_to_fs_type
#define H5MF_close itk_H5MF_close
#define H5MF_find_sect itk_H5MF_find_sect
...
#define H5MF_open_fstype itk_H5MF_open_fstype
#define H5MF_sect_free itk_H5MF_sect_free
#define H5MF_sect_new itk_H5MF_sect_new
...
#define H5MF_start_fstype itk_H5MF_start_fstype
...
#define H5O_obj_class itk_H5O_obj_class
...
#define H5O_refresh_metadata_close itk_H5O_refresh_metadata_close
...
#define H5O_visit itk_H5O_visit
...
#define H5PL_term_interface itk_H5PL_term_interface
...
#define H5P__term_deprec_interface itk_H5P__term_deprec_interface
#define H5P__term_pub_interface itk_H5P__term_pub_interface
...
#define H5P_verify_apl_and_dxpl itk_H5P_verify_apl_and_dxpl
...
#define H5R__term_deprec_interface itk_H5R__term_deprec_interface
#define H5R_create itk_H5R_create
#define H5R_dereference itk_H5R_dereference
#define H5R_get_name itk_H5R_get_name
#define H5R_get_obj_type itk_H5R_get_obj_type
#define H5R_get_region itk_H5R_get_region
...
#define H5T__term_deprec_interface itk_H5T__term_deprec_interface
...
#define H5VM_hyper_disjointp itk_H5VM_hyper_disjointp
