...
test_xtreeio_matrix_fixed()
{
  ...
  TEST("XML I/O for vnl_matrix_fixed<double,2,4>",
       s.str(),
       "<vnl_matrix_fixed rows=\"2\" cols=\"4\">\n<row> <cell> 1.000000 </cell> <cell> 2.000000 </cell> <cell> "
       "3.000000 </cell> <cell> 4.000000 </cell> </row> <row> <cell> 5.000000 </cell> <cell> 6.000000 </cell> <cell> "
       "7.000000 </cell> <cell> 8.000000 </cell> </row>\n</vnl_matrix_fixed>\n");
}
...
test_xtreeio_matrix()
{
  ...
  TEST("XML I/O for vnl_matrix<double>",
       s.str(),
       "<vnl_matrix rows=\"2\" cols=\"4\">\n<row> <cell> 1.000000 </cell> <cell> 2.000000 </cell> <cell> 3.000000 "
       "</cell> <cell> 4.000000 </cell> </row> <row> <cell> 5.000000 </cell> <cell> 6.000000 </cell> <cell> 7.000000 "
       "</cell> <cell> 8.000000 </cell> </row>\n</vnl_matrix>\n");
}
...
test_xtreeio_vector_fixed()
{
  ...
  TEST("XML I/O for vnl_vector_fixed<double,3>",
       s.str(),
       "<vnl_vector_fixed size=\"3\">\n<element> 10.000000 </element> <element> 20.000000 </element> <element> "
       "5.000000 </element>\n</vnl_vector_fixed>\n");
}
...
test_xtreeio_vector()
{
  ...
  TEST("XML I/O for vnl_vector<double>",
       s.str(),
       "<vnl_vector size=\"9\">\n<element> 1.000000 </element> <element> 2.000000 </element> <element> 3.000000 "
       "</element> <element> 4.000000 </element> <element> 5.000000 </element> <element> 6.000000 </element> <element> "
       "7.000000 </element> <element> 8.000000 </element> <element> 9.000000 </element>\n</vnl_vector>\n");
}
