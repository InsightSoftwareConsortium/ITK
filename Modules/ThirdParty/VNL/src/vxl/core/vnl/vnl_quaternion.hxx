...
template <class T>
vnl_quaternion<T>::vnl_quaternion(const vnl_vector_fixed<T, 3> & vec)
{
...
vnl_quaternion<T>::rotation_euler_angles() const
{
...
vnl_quaternion<T>::rotation_matrix_transpose_4() const
{
...
template <class T>
vnl_quaternion<T>
vnl_quaternion<T>::operator*(const vnl_quaternion<T> & rhs) const
{
