...
T
sum_vector(const vnl_vector_fixed<T, n> & v)
{
  return v.sum();
}
...
test_multiply()
{
  ...
  TEST("Matrix-matrix multiply",
       mr(0, 0) == 14 && mr(0, 1) == 17 && mr(0, 2) == 20 && mr(0, 3) == 23 && mr(1, 0) == 30 && mr(1, 1) == 37 &&
         mr(1, 2) == 44 && mr(1, 3) == 51 && mr(2, 0) == 46 && mr(2, 1) == 57 && mr(2, 2) == 68 && mr(2, 3) == 79,
       true);
...
test_int()
{
  ...
  vnl_int_2x2 m2(2);
  TEST("vnl_int_2x2 m2(2)", (m2.get(0, 0) == 2 && m2.get(0, 1) == 2 && m2.get(1, 0) == 2 && m2.get(1, 1) == 2), true);
  TEST("m2 = vnl_int_2x2(2)",
       (m2 = vnl_int_2x2(2), (m2.get(0, 0) == 2 && m2.get(0, 1) == 2 && m2.get(1, 0) == 2 && m2.get(1, 1) == 2)),
       true);
  const vnl_int_2x2 ma = m2;
  TEST("(const vnl_matrix_fixed)(i,j)", (ma(0, 0) == 2 && ma(0, 1) == 2 && ma(1, 0) == 2 && ma(1, 1) == 2), true);
  vnl_int_2x2 mb = m2;
  TEST(
  ...
  TEST("m0 != m2", (m0 != m2), true);
  TEST("m1.fill(3)",
       (m1.fill(3), (m1.get(0, 0) == 3 && m1.get(1, 1) == 3 && m1.get(2, 2) == 3 && m1.get(2, 3) == 3)),
       true);
  TEST("m2.fill(2)",
  ...
  TEST("m0=m2+3",
       ((m0 = m2 + 3), (m0.get(0, 0) == 5 && m0.get(0, 1) == 5 && m0.get(1, 0) == 5 && m0.get(1, 1) == 5)),
       true);
  TEST("m0=3+m2",
       ((m0 = 3 + m2), (m0.get(0, 0) == 5 && m0.get(0, 1) == 5 && m0.get(1, 0) == 5 && m0.get(1, 1) == 5)),
       true);
  TEST(
    "m0+=(-3)", (m0 += (-3), (m0.get(0, 0) == 2 && m0.get(0, 1) == 2 && m0.get(1, 0) == 2 && m0.get(1, 1) == 2)), true);
  TEST(
    "m0-=(-3)", (m0 -= (-3), (m0.get(0, 0) == 5 && m0.get(0, 1) == 5 && m0.get(1, 0) == 5 && m0.get(1, 1) == 5)), true);
  TEST("m0=m2-3",
       ((m0 = m2 - 3), (m0.get(0, 0) == -1 && m0.get(0, 1) == -1 && m0.get(1, 0) == -1 && m0.get(1, 1) == -1)),
       true);
  TEST("m0=3-m2",
       ((m0 = 3 - m2), (m0.get(0, 0) == 1 && m0.get(0, 1) == 1 && m0.get(1, 0) == 1 && m0.get(1, 1) == 1)),
       true);
  TEST("m0= -m2",
       (m0 = -m2, (m0.get(0, 0) == -2 && m0.get(0, 1) == -2 && m0.get(1, 0) == -2 && m0.get(1, 1) == -2)),
       true);

  vnl_int_2x2 m5;
  m0 = m2;
  TEST("m5=m0+m2",
       ((m5 = m0 + m2), (m5.get(0, 0) == 4 && m5.get(0, 1) == 4 && m5.get(1, 0) == 4 && m5.get(1, 1) == 4)),
       true);
  TEST("m5=m0-m2",
       ((m5 = m0 - m2), (m5.get(0, 0) == 0 && m5.get(0, 1) == 0 && m5.get(1, 0) == 0 && m5.get(1, 1) == 0)),
       true);
  TEST(
    "m0+=m2", ((m0 += m2), (m0.get(0, 0) == 4 && m0.get(0, 1) == 4 && m0.get(1, 0) == 4 && m0.get(1, 1) == 4)), true);
  TEST(
    "m0-=m2", ((m0 -= m2), (m0.get(0, 0) == 2 && m0.get(0, 1) == 2 && m0.get(1, 0) == 2 && m0.get(1, 1) == 2)), true);

  // test multiplications and divisions
  m2(0, 0) = 1;
  m2(0, 1) = 2;
  m2(1, 0) = 3;
  TEST("m0=m2*5", ((m0 = m2 * 5), (m0.get(0, 0) == 5 && m0.get(0, 1) == 10 && m0.get(1, 0) == 15)), true);
  TEST("m0=5*m2", ((m0 = 5 * m2), (m0.get(0, 0) == 5 && m0.get(0, 1) == 10 && m0.get(1, 0) == 15)), true);
  ...
  TEST(
    "m.transpose()", ((m0 = m.transpose()), (m0(0, 0) == 0 && m0(0, 1) == 2 && m0(1, 0) == -2 && m0(1, 1) == 0)), true);
  TEST("element_product(m,m)",
       ((m0 = element_product(m, m)), (m0(0, 0) == 0 && m0(0, 1) == 4 && m0(1, 0) == 4 && m0(1, 1) == 0)),
       true);
  TEST("element_quotient(m,[2])",
       ((m2 = 2), (m0 = element_quotient(m, m2)), (m0(0, 0) == 0 && m0(0, 1) == -1 && m0(1, 0) == 1 && m0(1, 1) == 0)),
       true);
  TEST("m.extract(1,1,1,1)",
       ((m3 = m.extract(1, 1, 1, 1)), (m3.rows() == 1 && m3.columns() == 1 && m3(0, 0) == m(1, 1))),
       true);
  TEST("m.update([4],1,1)",
...
test_float()
{
  ...
  TEST("vnl_float_2x2 d2(2.0)",
       ...
       true);
  TEST("d0=2.0",
       (d0 = 2.0, (d0.get(0, 0) == 2.0 && d0.get(0, 1) == 2.0 && d0.get(1, 0) == 2.0 && d0.get(1, 1) == 2.0)),
       true);
  ...
  TEST("d0 != d2", (d0 != d2), true);
  TEST("d1.fill(3.0)",
       (d1.fill(3.0), (d1.get(0, 0) == 3.0 && d1.get(1, 1) == 3.0 && d1.get(2, 2) == 3.0 && d1.get(2, 3) == 3.0)),
       true);
  TEST("d2.fill(2.0)",
  ...
  TEST("d0=d2+3.0",
       ((d0 = d2 + (float)3.0),
        (d0.get(0, 0) == 5.0 && d0.get(0, 1) == 5.0 && d0.get(1, 0) == 5.0 && d0.get(1, 1) == 5.0)),
       true);
  TEST("d0+=(-3.0)",
       (d0 += (-3.0), (d0.get(0, 0) == 2.0 && d0.get(0, 1) == 2.0 && d0.get(1, 0) == 2.0 && d0.get(1, 1) == 2.0)),
       true);
  vnl_float_2x2 d5;
  TEST("d5=d0+d2",
       ((d5 = d0 + d2), (d5.get(0, 0) == 4.0 && d5.get(0, 1) == 4.0 && d5.get(1, 0) == 4.0 && d5.get(1, 1) == 4.0)),
       true);
  TEST("d0+=d2",
       ((d0 += d2), (d0.get(0, 0) == 4.0 && d0.get(0, 1) == 4.0 && d0.get(1, 0) == 4.0 && d0.get(1, 1) == 4.0)),
       true);
  ...
  d2(0, 1) = 2;
  d2(1, 0) = 3;
  TEST("d0=d2*5.0f", ((d0 = d2 * 5.0f), (d0.get(0, 0) == 5 && d0.get(0, 1) == 10 && d0.get(1, 0) == 15)), true);
  TEST("d0=5.0f*d2", ((d0 = 5.0f * d2), (d0.get(0, 0) == 5 && d0.get(0, 1) == 10 && d0.get(1, 0) == 15)), true);
  ...
  TEST("d5=d6*d7",
       ...
       true);
  TEST("d6*=d7",
       ((d6 *= d7), (d6.get(0, 0) == 19.0 && d6.get(0, 1) == 22.0 && d6.get(1, 0) == 43.0 && d6.get(1, 1) == 50.0)),
       true);
  ...
  TEST("m.arg_min()", m.arg_min(), 1);
  TEST(
    "m.transpose()", ((m1 = m.transpose()), (m1(0, 0) == 0 && m1(0, 1) == 2 && m1(1, 0) == -2 && m1(1, 1) == 0)), true);
  TEST("element_product(m,m)",
       ((m1 = element_product(m, m)), (m1(0, 0) == 0 && m1(0, 1) == 4 && m1(1, 0) == 4 && m1(1, 1) == 0)),
       true);
  TEST("element_quotient(m,[2])",
       ((m2 = 2), (m1 = element_quotient(m, m2)), (m1(0, 0) == 0 && m1(0, 1) == -1 && m1(1, 0) == 1 && m1(1, 1) == 0)),
       true);
  TEST("m.extract(1,1,1,1)",
       ((m3 = m.extract(1, 1, 1, 1)), (m3.rows() == 1 && m3.columns() == 1 && m3(0, 0) == m(1, 1))),
       true);
...
test_double()
{
  ...
  // test additions and subtractions
  TEST("d0=d2+3.0",
       ((d0 = d2 + 3.0), (d0.get(0, 0) == 5.0 && d0.get(0, 1) == 5.0 && d0.get(1, 0) == 5.0 && d0.get(1, 1) == 5.0)),
       true);
  TEST("d0+=(-3.0)",
       (d0 += (-3.0), (d0.get(0, 0) == 2.0 && d0.get(0, 1) == 2.0 && d0.get(1, 0) == 2.0 && d0.get(1, 1) == 2.0)),
       true);
  ...
  d2(0, 1) = 2;
  d2(1, 0) = 3;
  TEST("d0=d2*5.0", ((d0 = d2 * 5.0), (d0.get(0, 0) == 5 && d0.get(0, 1) == 10 && d0.get(1, 0) == 15)), true);
  TEST("d0=5.0*d2", ((d0 = 5.0 * d2), (d0.get(0, 0) == 5 && d0.get(0, 1) == 10 && d0.get(1, 0) == 15)), true);
