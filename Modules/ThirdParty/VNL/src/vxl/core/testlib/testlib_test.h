...
void
testlib_test_start(const char * name = nullptr);
...
void
testlib_test_assert_near(const std::string & msg, double expr, double target = 0, double tol = 1e-12);
//: output msg, then perform test to see if expr is within tol of target
void
...
void
testlib_test_assert_near_relative(const std::string & msg, double expr, double target = 0, double tol = 1e-12);
//: output msg, then test to see if expr is within relative tol of target
void
...
void
testlib_test_assert_far(const std::string & msg, double expr, double target = 0, double tol = 1e-12);
//: output msg, then perform test to see if expr is not within tol of target
void
