...
{
template <typename T>
class itkDescoteauxEigenToMeasureParameterFunctorUnitTest : public ::testing::Test
{
public:
  /* Useful typedefs */
  ...
  typedef typename itk::Functor::DescoteauxEigenToMeasureParameterFunctor<EigenValueArrayType> FunctorType;
  ...
  ~itkDescoteauxEigenToMeasureParameterFunctorUnitTest() override {}
...
TYPED_TEST_CASE(itkDescoteauxEigenToMeasureParameterFunctorUnitTest, TestingLabelTypes);

TYPED_TEST(itkDescoteauxEigenToMeasureParameterFunctorUnitTest, InitialParameters)
{
...
TYPED_TEST(itkDescoteauxEigenToMeasureParameterFunctorUnitTest, SetGetFrobeniusNormWeight)
{
  EXPECT_DOUBLE_EQ(0.5, this->m_Functor.GetFrobeniusNormWeight());
...
TYPED_TEST(itkDescoteauxEigenToMeasureParameterFunctorUnitTest, TestPixelOfZero)
{
...
TYPED_TEST(itkDescoteauxEigenToMeasureParameterFunctorUnitTest, TestPixelOfOne)
{
...
TYPED_TEST(itkDescoteauxEigenToMeasureParameterFunctorUnitTest, TestPixelOfOneWithDifferentWeight)
{
  this->m_EigenPixel[0] = 1;
  this->m_EigenPixel[1] = 1;
  this->m_EigenPixel[2] = 1;
...
TYPED_TEST(itkDescoteauxEigenToMeasureParameterFunctorUnitTest, TestMultiplePixels)
{
  unsigned int num = 10;
  this->m_EigenPixel[0] = 0;
  this->m_EigenPixel[1] = 0;
