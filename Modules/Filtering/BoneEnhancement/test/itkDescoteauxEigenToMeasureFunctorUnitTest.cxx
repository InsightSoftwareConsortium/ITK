...
{
template <typename T>
class itkDescoteauxEigenToMeasureFunctorUnitTest : public ::testing::Test
{
public:
  /* Useful typedefs */
  ...
  typedef typename itk::Functor::DescoteauxEigenToMeasureFunctor<EigenValueArrayType, PixelType> FunctorType;
