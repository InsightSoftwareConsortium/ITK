...
int
itkEigenvalueToScalarImageFilterTestStaticMethods(int, char *[])
{
  ...
  TEST_EXPECT_EQUAL(EigenvalueToScalarImageFilterType::EigenValueOrder,
                    EigenvalueToScalarImageFilterType::OrderByMagnitude);
