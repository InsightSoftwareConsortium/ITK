...
KrcahEigenToScalarImageFilter<TInputImage, TOutputImage, TMaskImage>::KrcahEigenToScalarImageFilter()
{
  /* Instantiate filters. */
...
template <typename TInputImage, typename TOutputImage, typename TMaskImage>
void
KrcahEigenToScalarImageFilter<TInputImage, TOutputImage, TMaskImage>::EnlargeOutputRequestedRegion(DataObject * data)
{
...
template <typename TInputImage, typename TOutputImage, typename TMaskImage>
void
KrcahEigenToScalarImageFilter<TInputImage, TOutputImage, TMaskImage>::GenerateData()
{
  /* Get input */
...
template <typename TInputImage, typename TOutputImage, typename TMaskImage>
void
KrcahEigenToScalarImageFilter<TInputImage, TOutputImage, TMaskImage>::PrintSelf(std::ostream & os, Indent indent) const
{
