...
DescoteauxEigenToScalarImageFilter<TInputImage, TOutputImage, TMaskImage>::DescoteauxEigenToScalarImageFilter()
{
  /* Instantiate filters. */
...
template <typename TInputImage, typename TOutputImage, typename TMaskImage>
void
DescoteauxEigenToScalarImageFilter<TInputImage, TOutputImage, TMaskImage>::GenerateInputRequestedRegion()
{
...
template <typename TInputImage, typename TOutputImage, typename TMaskImage>
void
DescoteauxEigenToScalarImageFilter<TInputImage, TOutputImage, TMaskImage>::EnlargeOutputRequestedRegion(
  DataObject * data)
{
...
template <typename TInputImage, typename TOutputImage, typename TMaskImage>
void
DescoteauxEigenToScalarImageFilter<TInputImage, TOutputImage, TMaskImage>::PrintSelf(std::ostream & os,
                                                                                     Indent         indent) const
{
