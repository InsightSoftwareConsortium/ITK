...
KrcahEigenToMeasureImageFilter<TInputImage, TOutputImage, TInputSpatialObject>::KrcahEigenToMeasureImageFilter()
  : Superclass()
  , m_EnhanceType(-1.0f)
{}
...
template <typename TInputImage, typename TOutputImage, typename TInputSpatialObject>
void
KrcahEigenToMeasureImageFilter<TInputImage, TOutputImage, TInputSpatialObject>::DynamicThreadedGenerateData(
...
KrcahEigenToMeasureImageFilter<TInputImage, TOutputImage, TInputSpatialObject>::ProcessPixel(
...
template <typename TInputImage, typename TOutputImage, typename TInputSpatialObject>
void
KrcahEigenToMeasureImageFilter<TInputImage, TOutputImage, TInputSpatialObject>::PrintSelf(std::ostream & os,
                                                                                          Indent         indent) const
{
