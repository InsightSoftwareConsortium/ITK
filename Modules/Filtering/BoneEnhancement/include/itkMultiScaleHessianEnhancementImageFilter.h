...
public:
   ...
   * into the class using TODO: link to SetSigmaArray. Implementation taken from
   * itkMultiScaleHessianBasedMeasureImageFilter. Note that these methods cannot throw exceptions according to the
   * standard itkExceptionMacro since they are static methods. Instead, they will return an empty sigma array on error.
   */
