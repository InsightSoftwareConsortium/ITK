...
KrcahEigenToScalarPreprocessingImageToImageFilter<TInputImage,
                                                  TOutputImage>::KrcahEigenToScalarPreprocessingImageToImageFilter()
  : m_Sigma(1.0f)
...
template <typename TInputImage, typename TOutputImage>
void
KrcahEigenToScalarPreprocessingImageToImageFilter<TInputImage, TOutputImage>::GenerateData()
{
  /* Get Input */
...
template <typename TInputImage, typename TOutputImage>
void
KrcahEigenToScalarPreprocessingImageToImageFilter<TInputImage, TOutputImage>::PrintSelf(std::ostream & os,
                                                                                        Indent         indent) const
{
