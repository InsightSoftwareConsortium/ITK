...
public:
  ...
  /** Procesing filters */
  typedef DescoteauxEigenToScalarParameterEstimationImageFilter<TInputImage, TMaskImage> ParameterEstimationFilterType;
  typedef DescoteauxEigenToScalarFunctorImageFilter<TInputImage, TOutputImage>           UnaryFunctorFilterType;
  ...
  virtual void
  SetFrobeniusNormWeight(const typename ParameterEstimationFilterType::RealType weight)
  {
    this->m_ParameterEstimationFilter->SetFrobeniusNormWeight(weight);
    this->Modified();
  }
  typename ParameterEstimationFilterType::RealType
