...
public:
  ...
  virtual void
  SetAlpha(const RealType alpha)
  {
    this->m_Alpha = alpha;
  }
  virtual void
  SetBeta(const RealType beta)
  {
    this->m_Beta = beta;
  }
  virtual void
  SetC(const RealType c)
  {
    this->m_C = c;
  }
  RealType
...
public:
  ...
  typedef typename DescoteauxFunctorType::RealType RealType;
