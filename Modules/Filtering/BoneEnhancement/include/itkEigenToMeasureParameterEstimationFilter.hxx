...
template <typename TInputImage, typename TInputSpatialObject, typename TFunction>
void
EigenToMeasureParameterEstimationFilter<TInputImage, TInputSpatialObject, TFunction>::ThreadedGenerateData(
...
template <typename TInputImage, typename TInputSpatialObject, typename TFunction>
void
EigenToMeasureParameterEstimationFilter<TInputImage, TInputSpatialObject, TFunction>::UpdateOutputData(
...
EigenToMeasureParameterEstimationFilter<TInputImage, TInputSpatialObject, TFunction>::ThreaderCallback(void * arg)
{
  ThreadStruct * str;
...
EigenToMeasureParameterEstimationFilter<TInputImage, TInputSpatialObject, TFunction>::GetParametersOutput()
{
  return static_cast<ParameterDecoratedType *>(this->ProcessObject::GetOutput(1));
}

template <typename TInputImage, typename TInputSpatialObject, typename TFunction>
const typename EigenToMeasureParameterEstimationFilter<TInputImage, TInputSpatialObject, TFunction>::
  ParameterDecoratedType *
  EigenToMeasureParameterEstimationFilter<TInputImage, TInputSpatialObject, TFunction>::GetParametersOutput() const
{
...
template <typename TInputImage, typename TInputSpatialObject, typename TFunction>
void
EigenToMeasureParameterEstimationFilter<TInputImage, TInputSpatialObject, TFunction>::PrintSelf(std::ostream & os,
                                                                                                Indent indent) const
{
