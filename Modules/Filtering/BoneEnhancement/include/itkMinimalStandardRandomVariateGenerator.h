...
#include "BoneEnhancementExport.h"
 ...
 */
class BoneEnhancement_EXPORT MinimalStandardRandomVariateGenerator : public RandomVariateGeneratorBase
{
public:
