...
MultiScaleHessianEnhancementImageFilter<TInputImage, TOutputImage>::MultiScaleHessianEnhancementImageFilter()
{
  ...
  m_EigenToMeasureImageFilter = ITK_NULLPTR;               // has to be provided by the user.
  m_EigenToMeasureParameterEstimationFilter = ITK_NULLPTR; // has to be provided by the user.
