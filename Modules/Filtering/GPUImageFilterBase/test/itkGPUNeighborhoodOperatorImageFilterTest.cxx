...
runGPUNeighborhoodOperatorImageFilterTest(const std::string & inFile, const std::string & outFile)
{
  ...
  using NeighborhoodFilterType =
    itk::NeighborhoodOperatorImageFilter<InputImageType, OutputImageType, RealOutputPixelValueType>;
  using GPUNeighborhoodFilterType =
    itk::GPUNeighborhoodOperatorImageFilter<InputImageType, OutputImageType, RealOutputPixelValueType>;
