...
itkFastMarchingUpwindGradientTest(int, char *[])
{
  ...
  // tests to pass.
  static constexpr double targetOffset{ 0.0 };
  ...
  static constexpr FloatImage::OffsetType offset2{ 40, 40 };
  static constexpr FloatImage::OffsetType offset1{ 50, 50 };
  // This point is farthest from the AlivePoint:
  static constexpr FloatImage::OffsetType offset3{ 0, 0 };
  ...
  static constexpr double newStoppingValue{ 10.0 };
