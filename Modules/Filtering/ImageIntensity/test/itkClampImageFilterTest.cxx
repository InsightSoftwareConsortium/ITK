...
TestClampFromTo()
{
  ...
  it.GoToBegin();
  ot.GoToBegin();
  static constexpr auto expectedMin{ static_cast<double>(itk::NumericTraits<TOutputPixelType>::NonpositiveMin()) };
  static constexpr auto expectedMax{ static_cast<double>(itk::NumericTraits<TOutputPixelType>::max()) };
  while (!it.IsAtEnd())
  {
