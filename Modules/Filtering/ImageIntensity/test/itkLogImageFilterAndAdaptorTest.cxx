...
int itkLogImageFilterAndAdaptorTest(int, char* [] )
{
  ...
  typedef itk::LogImageFilter< InputImageType,
  ...
  //---------------------------------------
  // This section tests for LogImageAdaptor
  //---------------------------------------

  typedef itk::LogImageAdaptor<InputImageType,
