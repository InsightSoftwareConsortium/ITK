...
int itkMaskImageFilterTest(int, char* [] )
{
  ...
  using myFilterType = itk::MaskImageFilter<
                           myImageType1,
                           myImageType2,
                           myImageType3  >;
  ...
  // Vector image tests
  using myVectorImageType =
      itk::VectorImage<float, myDimension>;
  ...
  using myVectorFilterType = itk::MaskImageFilter< myVectorImageType,
                                myImageType2,
                                myVectorImageType>;
