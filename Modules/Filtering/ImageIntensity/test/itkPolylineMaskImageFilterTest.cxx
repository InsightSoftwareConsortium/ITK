...
int
itkPolylineMaskImageFilterTest(int argc, char * argv[])
{
  ...
  using PolylineMaskImageFilterType =
    itk::PolylineMaskImageFilter<inputImageType, inputPolylineType, inputVectorType, outputImageType>;
