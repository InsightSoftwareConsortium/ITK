 ...
 * ration [BSBV]. To do so, the filter needs a 3D input scan and a threshold. All voxels with an intensity higher than
 * the threshold will be considered as part of the bone. A mask can also be specified in order to have more precise
