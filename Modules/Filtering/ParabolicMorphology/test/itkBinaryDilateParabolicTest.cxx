...
#include "itkBinaryDilateParabolicImageFilter.h"

int
itkBinaryDilateParabolicTest(int argc, char * argv[])
{
  if (argc != 5)
  {
  ...
  using FilterType = itk::BinaryDilateParabolicImageFilter<IType, IType>;
