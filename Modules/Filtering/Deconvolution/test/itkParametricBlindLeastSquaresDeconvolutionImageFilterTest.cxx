...
itkParametricBlindLeastSquaresDeconvolutionImageFilterTest(int argc, char * argv[])
{
  ...
  constexpr KernelSourceType::ParametersValueType expectedSigmaX{ 2.90243 };
  if (itk::Math::Absolute(kernelSource->GetParameters()[0] - expectedSigmaX) > 1e-5)
  {
  ...
  constexpr KernelSourceType::ParametersValueType expectedSigmaY{ 2.90597 };
  if (itk::Math::Absolute(kernelSource->GetParameters()[1] - expectedSigmaY) > 1e-5)
  {
