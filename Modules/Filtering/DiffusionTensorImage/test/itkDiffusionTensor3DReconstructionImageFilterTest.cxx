...
itkDiffusionTensor3DReconstructionImageFilterTest(int argc, char * argv[])
{
  ...
  for (unsigned int pass = 0; pass < 2; ++pass)
  {
    ...
    static constexpr ReferenceSizeType  sizeReferenceImage{ 4, 4, 4 };
    static constexpr ReferenceIndexType indexReferenceImage{ 0, 0, 0 };
    ...
    static constexpr unsigned int numberOfGradientImages{ 6 };
    ...
    for (unsigned int i = 0; i < numberOfGradientImages; ++i)
    {
      ...
      static constexpr GradientSizeType  sizeGradientImage{ 4, 4, 4 };
      static constexpr GradientIndexType indexGradientImage{ 0, 0, 0 };
      ...
      static constexpr TensorReconstructionImageFilterType::GradientDirectionType::element_type epsilon{ 1e-3 };
    ...
    static constexpr TensorImageIndexType tensorImageIndex{ 3, 3, 3 };
    static constexpr GradientIndexType    gradientImageIndex{ 3, 3, 3 };
    static constexpr ReferenceIndexType   referenceImageIndex{ 3, 3, 3 };
    ...
    static constexpr double expectedResult[3][3]{ { 4.60517, -2.6698, -8.4079 },
