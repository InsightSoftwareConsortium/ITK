...
itkDiffusionTensor3DTest(int, char *[])
{
  ...
  // Test Eigen values computation
  {
    ...
    static constexpr double v[3]{ 19.0, 23.0, 29.0 };
  ...
  // Test GetTrace() and GetFractionalAnisotropy methods
  {
    ...
    static constexpr RealValueType expectedInternalScalarProduct{ 1829 };
    ...
    static constexpr RealValueType expectedFractionalAnisotropy{ 0.349177 };
    ...
    static constexpr RealValueType expectedRelativeAnisotropy{ 1.9044 };
