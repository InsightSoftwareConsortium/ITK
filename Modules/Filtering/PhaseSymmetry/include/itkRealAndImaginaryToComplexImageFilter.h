...
public:
  ...
  ~RealAndImaginaryToComplex() {};
  bool
  operator!=(const RealAndImaginaryToComplex &) const
  {
    return false;
  }
  bool
  operator==(const RealAndImaginaryToComplex & other) const
  {
    return !(*this != other);
  }
...
class ITK_EXPORT RealAndImaginaryToComplexImageFilter
  : public BinaryFunctorImageFilter<Image<TInputPixel1, NDimension>,
...
public:
  ...
  typedef BinaryFunctorImageFilter<Image<TInputPixel1, NDimension>,
                                   Image<TInputPixel2, NDimension>,
                                   Image<std::complex<TOutputPixel>, NDimension>,
                                   Functor::RealAndImaginaryToComplex<TInputPixel1, TInputPixel2, TOutputPixel>>
    Superclass;
  ...
  itkConceptMacro(Input1ConvertibleToDoubleCheck, (Concept::Convertible<TInputPixel1, double>));
  itkConceptMacro(Input2ConvertibleToDoubleCheck, (Concept::Convertible<TInputPixel2, double>));
  itkConceptMacro(DoubleConvertibleToOutputCheck, (Concept::Convertible<double, TOutputPixel>));
