...
protected:
  ...
  static void
  WriteImage(const TImageType * inputImage, const std::string & fileName)
  {
  ...
  MD5Hash(const TImageType * image)
  {
    ...
    typedef itk::Testing::HashImageFilter<TImageType> HashFilter;
...
TEST_F(SLICFixture, SetGetPrint)
{
  ...
  typename Utils::FilterType::Pointer filter = Utils::FilterType::New();
...
TEST_F(SLICFixture, Blank2DImage)
{
  ...
  typename Utils::InputImageType::Pointer image = Utils::CreateImage(100);
