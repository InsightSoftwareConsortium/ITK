...
// Compare FFT using PocketFFT and FFTW libraries. The test is performed for
...
int
itkPocketFFTFFTWD_RealFFTTest(int, char *[])
{
...
#  endif
  ...
  int          rval = 0;
  std::cerr << "PocketFFT-FFTWD:double,1 (4,4,4)" << std::endl;
  if ((test_fft_rtc<double,
    ...
    rval++;
  std::cerr << "PocketFFT-FFTWD:double,2 (4,4,4)" << std::endl;
  if ((test_fft_rtc<double,
                    2,
    ...
    rval++;
  std::cerr << "PocketFFT-FFTWD:double,3 (4,4,4)" << std::endl;
  if ((test_fft_rtc<double,
                    3,
