...
#  endif
  ...
  const itk::FFTWRealToHalfHermitianForwardFFTImageFilter<ImageD3>::Pointer fft =
  ...
  const itk::FFTWHalfHermitianToRealInverseFFTImageFilter<ImageCD3>::Pointer ifft =
