...
#  endif
  ...
  if ((test_fft_rtc<float, 1, itk::PocketFFTForwardFFTImageFilter<ImageF1>, itk::FFTWForwardFFTImageFilter<ImageF1>>(
        SizeOfDimensions1)) != 0)
    rval++;
  std::cerr << "PocketFFT-FFTWF:float,2 (4,4,4)" << std::endl;
  if ((test_fft_rtc<float, 2, itk::PocketFFTForwardFFTImageFilter<ImageF2>, itk::FFTWForwardFFTImageFilter<ImageF2>>(
        SizeOfDimensions1)) != 0)
    rval++;
  std::cerr << "PocketFFT-FFTWF:float,3 (4,4,4)" << std::endl;
  if ((test_fft_rtc<float, 3, itk::PocketFFTForwardFFTImageFilter<ImageF3>, itk::FFTWForwardFFTImageFilter<ImageF3>>(
        SizeOfDimensions1)) != 0)
    rval++;
