...
HostnameWisdomFilenameGenerator ::GenerateWisdomFilename(const std::string & baseCacheDirectory) const
{
  ...
  hostInfo.RunOSCheck();
  return baseCacheDirectory + FFTWPathSep + ".itkwisdomfftw" + FFTWPathSep + ".itk_" + hostInfo.GetHostname() +
         ".wisdom";
}
...
itkGetGlobalSimpleMacro(FFTWGlobalConfiguration, FFTWGlobalConfigurationGlobals, PimplGlobals);
