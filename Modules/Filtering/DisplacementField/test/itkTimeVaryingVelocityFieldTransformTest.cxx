...
{
  static constexpr unsigned int ComponentDimension{ 3 };
  static constexpr unsigned int VelocityFieldDimension{ 4 };
  ...
  static constexpr TimeVaryingVelocityFieldType::PointType origin{};
