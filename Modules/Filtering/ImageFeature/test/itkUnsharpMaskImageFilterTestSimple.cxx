...
itkUnsharpMaskImageFilterTestSimple(int, char *[])
{
  ...
  static constexpr SizeType size{ 20, 4 };
  IndexType                 start{};
  ...
  static constexpr UnsharpMaskImageFilterFilterType::SigmaArrayType::ValueType sigma{ 2.5 };
  ...
  static constexpr UnsharpMaskImageFilterFilterType::InternalPrecisionType amount{ 0.8 };
  ...
  static constexpr bool clamp{ std::is_integral_v<UnsharpMaskImageFilterFilterType::OutputPixelType> };
  ...
  start[0] = 9;
  static constexpr float mins[4]{ -0.21f, -0.33f, 1.32f, 1.20f };
  static constexpr float maxs[4]{ -0.20f, -0.32f, 1.33f, 1.21f };
