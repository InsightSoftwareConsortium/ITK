...
Test_GetLines_should_return_empty_list_when_NumberOfLines_is_set_to_zero()
{
  ...
  static constexpr ImageType::SizeType size{ sizeX, sizeY };
  image->SetRegions(size);
  image->AllocateInitialized();
...
itkHoughTransform2DLinesImageTest(int, char *[])
{
  ...
  // Create a line
  static constexpr unsigned int lines{ 1 };
  static constexpr double       theta{ 0.20 }; // radians
  ...
  static constexpr unsigned char lowerThreshold{ 10 };
  static constexpr unsigned char upperThreshold{ 200 };
  ...
  static constexpr float discRadius{ 25.0 };
  ...
  static constexpr double angleTolerance{ 0.1 };
