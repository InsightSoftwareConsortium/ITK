...
int itkConvertLabelMapFilterTest2(int argc, char * argv[])
{
  ...
  typedef itk::Functor::CastShapeLabelObjectFunctor<InputShapeLabelMapType::LabelObjectType, OutputShapeLabelMapType::LabelObjectType>   CastShapeFunctorType;
  typedef itk::ConvertLabelMapFilter< InputShapeLabelMapType, OutputShapeLabelMapType, CastShapeFunctorType > CastShapeType;
  ...
  typedef itk::Functor::CastStatisticsLabelObjectFunctor<InputStatisticsLabelMapType::LabelObjectType, OutputStatisticsLabelMapType::LabelObjectType>   CastStatisticsFunctorType;
  typedef itk::ConvertLabelMapFilter< InputStatisticsLabelMapType, OutputStatisticsLabelMapType, CastStatisticsFunctorType > CastStatType;
  ...
  typedef itk::Functor::CastLabelObjectFunctor<L2MType::OutputImageType::LabelObjectType, \
                                                        LabelMapType::LabelObjectType>     CastFunctorType;
  typedef itk::ConvertLabelMapFilter< L2MType::OutputImageType, LabelMapType, CastFunctorType >     CastType;
