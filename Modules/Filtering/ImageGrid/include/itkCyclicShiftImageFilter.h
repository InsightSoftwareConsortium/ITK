 ...
 *
 *=========================================================================*/
#ifndef __itkCyclicShiftImageFilter_h
#define __itkCyclicShiftImageFilter_h
...
class ITK_EXPORT CyclicShiftImageFilter:
...
private:
  CyclicShiftImageFilter(const Self &); // purposely not implemented
