...
template <typename TInputImage, typename TOutputImage>
void
BSplineResampleImageFilterBase<TInputImage, TOutputImage>::SetSplineOrder(int splineOrder)
{
                                                                         ...
                                                                         ProgressReporter &          progress)
{
  ...
  const unsigned int inModK = inTraverseSize - 1; // number for modulus math of in
  ...
  else
  {
    for (unsigned int outK = 0; outK < outTraverseSize; ++outK)
    {
      const unsigned int inK = 2L * outK;
                                                                         ...
                                                                         ProgressReporter &          progress)
{
  const unsigned int outTraverseSize = inTraverseSize * 2;
  // inTraverseSize = outTraverseSize/2;  // ensures that an even number is used.
  const int inModK = inTraverseSize - 1; // number for modulus math of in
...
template <typename TInputImage, typename TOutputImage>
void
BSplineResampleImageFilterBase<TInputImage, TOutputImage>::CopyLineToScratch(ConstInputImageIterator & Iter)
{
  unsigned int j = 0;
...
template <typename TInputImage, typename TOutputImage>
void
BSplineResampleImageFilterBase<TInputImage, TOutputImage>::CopyInputLineToScratch(ConstInputImageIterator & Iter)
{
  unsigned int j = 0;
...
template <typename TInputImage, typename TOutputImage>
void
BSplineResampleImageFilterBase<TInputImage, TOutputImage>::CopyOutputLineToScratch(ConstOutputImageIterator & Iter)
{
  unsigned int j = 0;
