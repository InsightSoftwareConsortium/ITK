...
itkCropImageFilter3DTest(int, char *[])
{
  ...
  static constexpr ImageType::RegionType::SizeType  size{ dimSize, dimSize, dimSize };
  static constexpr ImageType::RegionType::IndexType index{ 0, 0, 0 };
  region = { index, size };
  ...
  static constexpr ImageType::SizeType extractSize{ 1, 1, 1 };
  ...
  static constexpr ImageType::RegionType::SizeType  subSize{ dimSize - 2, dimSize - 2, dimSize - 2 };
  static constexpr ImageType::RegionType::IndexType subIndex{ 1, 1, 1 };
