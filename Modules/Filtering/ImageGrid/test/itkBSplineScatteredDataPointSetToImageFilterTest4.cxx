...
{
  static constexpr unsigned int ParametricDimension{ 3 };
  ...
  static constexpr VectorImageType::PointType origin{};
  ...
  static constexpr RealType weight1{ 1.0 };
  ...
  static constexpr RealType weight2{ 3.0 };
  ...
  static constexpr RealType weight3{ 0.5 };
