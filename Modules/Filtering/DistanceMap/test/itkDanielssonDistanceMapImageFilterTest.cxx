...
itkDanielssonDistanceMapImageFilterTest(int, char *[])
{
  ...
  static constexpr myImageType2D1::SizeType size2D{ 9, 9 };
  ...
  static constexpr bool squaredDistance{ true };
  ...
  static constexpr myImageType2D2::PixelType epsilon{ 1e-5 };
  ...
  static constexpr bool inputIsBinary{ true };
  ...
  static constexpr ImageType3D::SizeType  size3D{ 200, 200, 200 };
  static constexpr ImageType3D::IndexType index3D{ 0, 0 };
