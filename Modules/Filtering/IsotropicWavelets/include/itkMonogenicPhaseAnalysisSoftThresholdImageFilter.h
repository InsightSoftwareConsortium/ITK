...
class MonogenicPhaseAnalysisSoftThresholdImageFilter : public ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  ...
  itkTypeMacro(MonogenicPhaseAnalysisSoftThresholdImageFilter, ImageToImageFilter);
