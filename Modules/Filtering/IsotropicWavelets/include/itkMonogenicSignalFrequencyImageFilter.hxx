  ...
  ThreadIdType                  itkNotUsed(threadId))
{
  ...
  typedef itk::RieszFrequencyFunction<typename InputImageType::PixelType::value_type, ImageDimension> RieszFunctionType;
  ...
  {
    typename RieszFunctionType::OutputArrayType evaluatedArray = evaluator->EvaluateArray(inFreqIt.GetFrequencyIndex());
