            ...
            const double        noiseModelFidelityWeight)
{
  ...
  static constexpr unsigned int patchRadius{ 4 };
  ...
  static constexpr bool useSmoothDiscPatchWeights{ true };
  ITK_TEST_SET_GET_BOOLEAN(filter, UseSmoothDiscPatchWeights, useSmoothDiscPatchWeights);
  static constexpr bool useFastTensorComputations{ true };
  ...
  static constexpr double smoothingWeight{ 1.0 };
  ...
  static constexpr double kernelBandwidthFractionPixelsForEstimation{ 0.20 };
