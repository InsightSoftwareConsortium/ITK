...
{
template <typename T>
class itkDescoteauxEigenToMeasureParameterEstimationFilterUnitTest
  : public ::testing::Test
{
public:
  /* Useful typedefs */
  ...
  typedef typename itk::DescoteauxEigenToMeasureParameterEstimationFilter< EigenImageType, SpatialObjectType>
                                                        FilterType;
