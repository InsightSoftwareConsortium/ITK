...
{
template <typename T>
class itkKrcahEigenToMeasureParameterEstimationFilterUnitTest
  : public ::testing::Test
{
public:
  /* Useful typedefs */
  ...
  typedef typename itk::KrcahEigenToMeasureParameterEstimationFilter< EigenImageType, SpatialObjectType>
                                                        FilterType;
