 ...
 *
 *=========================================================================*/
#ifndef itkNPasteImageFilter_h
#define itkNPasteImageFilter_h
...
public:
  ...
  /** NPasteImageFilter needs to set the input requested regions for its
...
protected:
  NPasteImageFilter();
  ~NPasteImageFilter() override = default;
  void
  ...
  static_assert(InputImageDimension >= SourceImageDimension, "The source image is greater than the input image.");
};
} // end namespace itk
