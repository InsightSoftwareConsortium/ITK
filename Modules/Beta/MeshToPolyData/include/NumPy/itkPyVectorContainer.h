...
public:
   ...
   */
  static PyObject * _array_view_from_vector_container( VectorContainerType * vector );

  /**
   * Get a vnl vector from a Python array
   */
  static const typename VectorContainerType::Pointer _vector_container_from_array( PyObject *arr, PyObject *shape );
