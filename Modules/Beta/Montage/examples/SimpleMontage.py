...
if len(sys.argv) < 4:
    print(
        f"Usage: {sys.argv[0]} <directoryWithInputTiles> <outputDirectory> <outputFilename>"
    )
    sys.exit(1)
...
resampleF = itk.TileMergeImageFilter[
    color_image_type, accum_type, interpolater_function_type
].New()
