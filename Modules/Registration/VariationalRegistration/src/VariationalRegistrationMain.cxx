...
PrintHelp()
{
  ...
  std::cout << "    Estimation of lung motion fields in 4D CT data by variational non-linear intensity-based"
            << std::endl;
  std::cout << "    registration: A comparison and evaluation study, Phys. Med. Biol., 2014" << std::endl << std::endl;
...
main(int argc, char * argv[])
{
  ...
  typedef VariationalRegistrationNCCFunction<ImageType, ImageType, DisplacementFieldType>    NCCFunctionType;
