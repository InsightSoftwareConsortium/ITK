...
itkPointSetToPointSetRegistrationTest(int, char *[])
{
  ...
  static constexpr unsigned int numberOfPoints{ 500 };
  ...
  static constexpr unsigned long numberOfIterations{ 100 };
  static constexpr double        gradientTolerance{ 1e-1 }; // convergence criterion
  static constexpr double        valueTolerance{ 1e-1 };    // convergence criterion
  static constexpr double        epsilonFunction{ 1e-9 };   // convergence criterion
