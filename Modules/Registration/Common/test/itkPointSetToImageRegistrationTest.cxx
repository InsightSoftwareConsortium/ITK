...
itkPointSetToImageRegistrationTest(int, char *[])
{
  ...
  static constexpr unsigned int numberOfPoints{ 10000 };
  ...
  static constexpr unsigned long numberOfIterations{ 50 };
  static constexpr double        maximumStepLength{ 1.0 }; // no step will be larger than this
  static constexpr double        minimumStepLength{ 0.01 };
  static constexpr double        gradientTolerance{ 1e-6 }; // convergence criterion
