...
::AdaptTransformParameters()
{
  ...
  interpolator->SetInputImage( this->m_Transform->GetTimeVaryingVelocityField() );
  ...
  resampler->SetInput( this->m_Transform->GetTimeVaryingVelocityField() );
  ...
  this->m_Transform->SetTimeVaryingVelocityField( newTimeVaryingVelocityField );
