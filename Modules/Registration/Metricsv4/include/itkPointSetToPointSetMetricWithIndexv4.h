...
public:
  ...
  SetFixedObject(const ObjectType * object) override
  {
    ...
    {
      itkExceptionStringMacro("Incorrect object type.  Should be a point set.");
    }
  }
...
protected:
  ...
  GetLocalNeighborhoodDerivativeWithIndex(const PointIdentifier &, const PointType &, const PixelType & pixel) const;
