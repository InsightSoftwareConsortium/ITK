...
public:
  ...
  void Execute(const itk::Object * object, const itk::EventObject & event)
    ...
    std::cout << "It- " << optimizer->GetCurrentIteration() << " gradient: " << optimizer->GetGradient() << " metric value: " << optimizer->GetValue()
...
int itkObjectToObjectMultiMetricv4RegistrationTest(int argc, char *argv[])
{
  ...
  CorrelationMetricType::MeasureType singleValueResult;
  ...
  CorrelationMetricType::MeasureType multiValueResult;
