...
GPUDemonsRegistrationFunction<TFixedImage, TMovingImage, TDisplacementField>::GPUDemonsRegistrationFunction()
{
  ...
  m_GPUPixelCounter = nullptr;
  m_GPUSquaredChange = nullptr;
  m_GPUSquaredDifference = nullptr;
                                                                                        ...
                                                                                        Indent         indent) const
{
  ...
  print_helper::PrintNumericTrait(os, indent, "ZeroUpdateReturn", m_ZeroUpdateReturn);
  ...
  unsigned int numPixels)
{
  ...
  // if (m_GPUPixelCounter == (GPUReduction<int>::Pointer)nullptr)
...
template <typename TFixedImage, typename TMovingImage, typename TDisplacementField>
void
GPUDemonsRegistrationFunction<TFixedImage, TMovingImage, TDisplacementField>::GPUReleaseMetricData()
{
  ...
  void *                       itkNotUsed(gd))
{
  ...
  this->m_GPUKernelManager->SetKernelArgWithImage(
    m_ComputeUpdateGPUKernelHandle, argidx++, fixedImage->GetGPUDataManager());
  this->m_GPUKernelManager->SetKernelArgWithImage(
    m_ComputeUpdateGPUKernelHandle, argidx++, movingImage->GetGPUDataManager());
  this->m_GPUKernelManager->SetKernelArgWithImage(
    m_ComputeUpdateGPUKernelHandle, argidx++, output->GetGPUDataManager());
  this->m_GPUKernelManager->SetKernelArgWithImage(
    m_ComputeUpdateGPUKernelHandle, argidx++, update->GetGPUDataManager());

  this->m_GPUKernelManager->SetKernelArgWithImage(
    m_ComputeUpdateGPUKernelHandle, argidx++, m_GPUPixelCounter->GetGPUDataManager());
  this->m_GPUKernelManager->SetKernelArgWithImage(
    m_ComputeUpdateGPUKernelHandle, argidx++, m_GPUSquaredChange->GetGPUDataManager());
  this->m_GPUKernelManager->SetKernelArgWithImage(
