...
private:
  PhysicsBasedNonRigidRegistrationMethod( const PhysicsBasedNonRigidRegistrationMethod & ) ITK_DELETED_FUNCTION;
  void operator=( const PhysicsBasedNonRigidRegistrationMethod & ) ITK_DELETED_FUNCTION;
