...
class ITK_TEMPLATE_EXPORT InMemoryMontageTest : public itk::Object
{
  public:
     ...
     * DO | DS | DT
     * ----------------------------------------------------------------------------------------------- */
    int execute( const itk::TileLayout2D& stageTiles, const std::string& inputPath, std::string& outFilename,
  ...
  private:
     ...
     * ----------------------------------------------------------------------------------------------- */
    int inMemoryMontageTest0( const itk::TileLayout2D& stageTiles, const std::string& inputPath,
     ...
     * ----------------------------------------------------------------------------------------------- */
    int inMemoryMontageTest1( const itk::TileLayout2D& stageTiles, const std::string& inputPath,
                                const std::string& outFilename, unsigned streamSubdivisions)
    {
      unsigned yMontageSize = stageTiles.size();
      unsigned xMontageSize = stageTiles[0].size();
     ...
     * ----------------------------------------------------------------------------------------------- */
    int inMemoryMontageTest2( const itk::TileLayout2D& stageTiles, const std::string& inputPath,
                                const std::string& outFilename, unsigned streamSubdivisions)
    {
      unsigned yMontageSize = stageTiles.size();
      unsigned xMontageSize = stageTiles[0].size();
     ...
     * ----------------------------------------------------------------------------------------------- */
    int inMemoryMontageTest3( const itk::TileLayout2D& stageTiles, const std::string& inputPath,
                                const std::string& outFilename, unsigned streamSubdivisions)
    {
      unsigned yMontageSize = stageTiles.size();
      unsigned xMontageSize = stageTiles[0].size();
     ...
     * ----------------------------------------------------------------------------------------------- */
    int inMemoryMontageTest4( const itk::TileLayout2D& stageTiles, const std::string& inputPath,
                                const std::string& outFilename, unsigned streamSubdivisions)
    {
      unsigned yMontageSize = stageTiles.size();
      unsigned xMontageSize = stageTiles[0].size();
     ...
     * ----------------------------------------------------------------------------------------------- */
    int inMemoryMontageTest5( const itk::TileLayout2D& stageTiles, const std::string& inputPath,
                                const std::string& outFilename, unsigned streamSubdivisions)
    {
      unsigned yMontageSize = stageTiles.size();
      unsigned xMontageSize = stageTiles[0].size();
     ...
     * ----------------------------------------------------------------------------------------------- */
    int inMemoryMontageTest6( const itk::TileLayout2D& stageTiles, const std::string& inputPath,
                                const std::string& outFilename, unsigned streamSubdivisions)
    {
      unsigned yMontageSize = stageTiles.size();
      unsigned xMontageSize = stageTiles[0].size();
     ...
     * ----------------------------------------------------------------------------------------------- */
    int inMemoryMontageTest7( const itk::TileLayout2D& stageTiles, const std::string& inputPath,
                                const std::string& outFilename, unsigned streamSubdivisions)
    {
      unsigned yMontageSize = stageTiles.size();
      unsigned xMontageSize = stageTiles[0].size();
     ...
     * ----------------------------------------------------------------------------------------------- */
    int stitchMontage( const itk::TileLayout2D& stageTiles, const std::string& inputPath,
    ...
    Origin2D createOrigin2DFromStageTiles(itk::TileLayout2D stageTiles)
    {
      Origin2D UO;
    ...
    Transform2D createTransform2DFromStageTiles(itk::TileLayout2D stageTiles)
    {
      Transform2D UT;
