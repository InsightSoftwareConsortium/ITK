...
int itkPointSetToPointSetMetricTest( int, char* [] )
{
  ...
  typedef itk::JensenHavrdaCharvatTsallisPointSetMetric<PointSetType> PointSetMetricType;
  ...
  metric->SetDerivativeSource( PointSetMetricType::Moving );
  ...
  metric->SetDerivativeSource( PointSetMetricType::Fixed );
