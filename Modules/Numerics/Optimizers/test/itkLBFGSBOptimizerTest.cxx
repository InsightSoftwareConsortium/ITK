...
itkLBFGSBOptimizerTest(int, char *[])
{
  ...
  static constexpr double F_Convergence_Factor{ 1e+7 };  // Function value tolerance
  static constexpr double Projected_G_Tolerance{ 1e-5 }; // Proj gradient tolerance
  static constexpr int    Max_Iterations{ 100 };         // Maximum number of iterations
  ...
  static constexpr unsigned int maximumNumberOfCorrections{ 5 };
  ...
  static constexpr double trueParameters[2]{ 4.0 / 3.0, -1.0 };
