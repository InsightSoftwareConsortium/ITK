...
PSOTest3()
{
  ...
  static constexpr unsigned int numberOfGenerationsWithMinimalImprovement{ 1 };
  ...
  static constexpr double percentageParticlesConverged{ 0.6 };
  ...
  static constexpr double inertiaCoefficient{ 0.7298 };
  ...
  static constexpr double personalCoefficient{ 1.496 };
  ...
  static constexpr double gobalCoefficient{ 1.496 };
