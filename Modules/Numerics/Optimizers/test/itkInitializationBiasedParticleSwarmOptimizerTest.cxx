...
itkInitializationBiasedParticleSwarmOptimizerTest(int argc, char * argv[])
{
  ...
  static constexpr unsigned int allIterations{ 10 };
           ...
           typename OptimizerType::CoefficientType initializationCoefficient)
{
  ...
  static constexpr unsigned int numberOfParticles{ 10 };
  static constexpr unsigned int maxIterations{ 200 };
  static constexpr double       xTolerance{ 0.1 };
           ...
           typename OptimizerType::CoefficientType initializationCoefficient)
{
  ...
  bounds.emplace_back(-100, 100);
  static constexpr unsigned int numberOfParticles{ 100 };
  static constexpr unsigned int maxIterations{ 1000 };
  static constexpr double       xTolerance{ 0.1 };
  static constexpr double       fTolerance{ 0.01 };
  OptimizerType::ParametersType initialParameters(2);
