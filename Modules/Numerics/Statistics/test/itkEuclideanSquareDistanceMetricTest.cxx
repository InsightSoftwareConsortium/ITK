...
itkEuclideanSquareDistanceMetricTest(int, char *[])
{
  ...
  using DistanceMetricType = itk::Statistics::EuclideanSquareDistanceMetric<MeasurementVectorType>;
  ...
  static constexpr double trueValue{ 11.0 };
  ...
  static constexpr double trueValue2{ 1.29 };
