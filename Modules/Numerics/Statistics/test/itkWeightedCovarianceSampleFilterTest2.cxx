...
static constexpr unsigned int MeasurementVectorSize2{ 3 };
...
itkWeightedCovarianceSampleFilterTest2(int, char *[])
{
  ...
  static constexpr float value33[3]{ 4.10f, 2.08f, 0.604f };
  ...
  static constexpr float value3[3]{ 4.10f, 2.08f, 0.604f };
