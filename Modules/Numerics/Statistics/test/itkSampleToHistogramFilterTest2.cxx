...
itkSampleToHistogramFilterTest2(int, char *[])
{
  ...
  static constexpr unsigned int expectedFrequency2{ 5 };
  while (histogramItr != histogramEnd)
  {
  ...
  static constexpr unsigned int expectedFrequency3{ 15 };
  while (histogramItr != histogramEnd)
  {
  ...
  static constexpr unsigned int expectedFrequency4{ 105 };
  while (histogramItr != histogramEnd)
  {
