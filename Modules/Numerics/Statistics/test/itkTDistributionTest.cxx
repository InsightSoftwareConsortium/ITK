...
itkTDistributionTest(int, char *[])
{
  ...
  // values of -5:1:5
  static constexpr double expected1[]{ 6.283295818900114e-002, 7.797913037736926e-002, 1.024163823495667e-001,
  ...
  // values of -5:1:5
  static constexpr double expected11[]{ 2.012649090622596e-004, 1.043096783487477e-003, 6.039919735960683e-003,
  ...
  for (int i = -5; i <= 5; ++i)
  {
    ...
    value = distributionFunction->EvaluateCDF(x, static_cast<itk::SizeValueType>(params[0]));
  ...
  static constexpr unsigned long dof{ 5 };
  ...
  static constexpr unsigned long newdof{ 17 };
