...
struct ITK_TEMPLATE_EXPORT KdTreeNonterminalNode:public KdTreeNode<TSample>
  ...
  ~KdTreeNonterminalNode() ITK_OVERRIDE {}

  bool IsTerminal() const ITK_OVERRIDE
  {
    return false;
  }

  void GetParameters( unsigned int &, MeasurementType & ) const ITK_OVERRIDE;

  /** Returns the pointer to the left child of this node */
  Superclass * Left() ITK_OVERRIDE
  {
    return m_Left;
  }

  /** Returns the pointer to the right child of this node */
  Superclass * Right() ITK_OVERRIDE
  {
    return m_Right;
  }

  /** Returns the const pointer to the left child of this node */
  const Superclass * Left() const ITK_OVERRIDE
  {
    return m_Left;
  }

  /** Returns the const pointer to the right child of this node */
  const Superclass * Right() const ITK_OVERRIDE
  {
    return m_Right;
  }
   ...
   */
  void GetWeightedCentroid( CentroidType & ) ITK_OVERRIDE {}

  /**
   * Returns the centroid. weighted centroid divided by the size. Do nothing for
   * this class.
   */
  void GetCentroid( CentroidType & ) ITK_OVERRIDE {}
   ...
   */
  InstanceIdentifier GetInstanceIdentifier( InstanceIdentifier ) const ITK_OVERRIDE
  {
   ...
   */
  void AddInstanceIdentifier( InstanceIdentifier valueId ) ITK_OVERRIDE
  {
...
struct ITK_TEMPLATE_EXPORT KdTreeWeightedCentroidNonterminalNode:public KdTreeNode<TSample>
  ...
  ~KdTreeWeightedCentroidNonterminalNode() ITK_OVERRIDE {}
   ...
   * Returns the vector sum of the all measurement vectors under this node.
   */
  void GetWeightedCentroid(CentroidType & centroid) ITK_OVERRIDE
  {
   ...
   * Returns the centroid. weighted centroid divided by the size.
   */
  void GetCentroid(CentroidType & centroid) ITK_OVERRIDE
  {
    centroid = m_Centroid;
  }
...
struct ITK_TEMPLATE_EXPORT KdTreeTerminalNode:public KdTreeNode<TSample>
  ...
  ~KdTreeTerminalNode() ITK_OVERRIDE
  {
   ...
   * the distance computation when querying the tree.
   */
  InstanceIdentifier GetInstanceIdentifier( InstanceIdentifier index ) const ITK_OVERRIDE
  {
   ...
   * Set the identifier of the node.
   */
  void AddInstanceIdentifier( InstanceIdentifier id ) ITK_OVERRIDE
  {
