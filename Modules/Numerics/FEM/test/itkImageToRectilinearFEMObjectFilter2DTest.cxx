...
{
  static constexpr int inputFileDataCheckArgs{ 8 };
  // numberOfNodesToTest (a least 1) + nodeNumber (at least 1) + nodeCoords (2 per node)
  static constexpr unsigned int minArgNodes{ 4 };
  // numberOfElementsToTest (a least 1) + elementNumber (at least 1) + elementNodes (4 per element)
  static constexpr unsigned int minArgElements{ 6 };
  ...
  static constexpr unsigned int nodeSize{ 4 };
