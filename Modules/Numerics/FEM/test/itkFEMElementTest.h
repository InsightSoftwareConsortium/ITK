...
int
itkFEMElementTest(int, char *[]);

// void PrintResults(Solver&, int, char);
void
PrintK(itk::fem::Solver &, int, char);

void
PrintF(itk::fem::Solver &, int, char);

void
PrintNodalCoordinates(itk::fem::Solver &, int, char);

void
PrintU(itk::fem::Solver &, int, char);
