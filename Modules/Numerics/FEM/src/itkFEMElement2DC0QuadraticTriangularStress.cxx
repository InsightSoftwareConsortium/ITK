  ...
  : Superclass()
{
  ...
  if (!m_mat)
  {
    throw FEMExceptionWrongClass(
      __FILE__, __LINE__, "Element2DC0QuadraticTriangularStress::Element2DC0QuadraticTriangularStress()");
  }
}

void
Element2DC0QuadraticTriangularStress::PrintSelf(std::ostream & os, Indent indent) const
{
