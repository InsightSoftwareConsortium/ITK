  ...
  : Superclass()
{
  ...
  if (!m_mat)
  {
    throw FEMExceptionWrongClass(
      __FILE__, __LINE__, "Element2DC0LinearTriangularStress::Element2DC0LinearTriangularStress()");
  }
}

void
Element2DC0LinearTriangularStress::PrintSelf(std::ostream & os, Indent indent) const
{
