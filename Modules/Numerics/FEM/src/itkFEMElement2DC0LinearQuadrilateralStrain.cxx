  ...
  : Superclass()
{
  ...
  if (!m_mat)
  {
    throw FEMExceptionWrongClass(
      __FILE__, __LINE__, "Element2DC0LinearQuadrilateralStrain::Element2DC0LinearQuadrilateralStrain()");
  }
}

void
Element2DC0LinearQuadrilateralStrain::PrintSelf(std::ostream & os, Indent indent) const
{
