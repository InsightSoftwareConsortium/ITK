...
template <typename TBaseClass>
void
Element3DMembrane<TBaseClass>::GetStrainDisplacementMatrix(MatrixType & B, const MatrixType & shapeDgl) const
{
  unsigned int p;
...
template <typename TBaseClass>
void
Element3DMembrane<TBaseClass>::GetMassMatrix(MatrixType & Me) const
{
...
template <typename TBaseClass>
void
Element3DMembrane<TBaseClass>::GetMaterialMatrix(MatrixType & D) const
{
  unsigned int d = 9;
...
template <typename TBaseClass>
void
Element3DMembrane<TBaseClass>::PrintSelf(std::ostream & os, Indent indent) const
{
