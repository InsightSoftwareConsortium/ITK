...
template <unsigned int VDimension>
void
SolverHyperbolic<VDimension>::InitializeLinearSystemWrapper()
{
...
template <unsigned int VDimension>
void
SolverHyperbolic<VDimension>::AssembleElementMatrix(Element::Pointer e)
{
...
template <unsigned int VDimension>
void
SolverHyperbolic<VDimension>::InitializeMatrixForAssembly(unsigned int N)
{
...
template <unsigned int VDimension>
void
SolverHyperbolic<VDimension>::FinalizeMatrixAfterAssembly()
{
...
template <unsigned int VDimension>
void
SolverHyperbolic<VDimension>::Solve()
{
  this->m_LinearSystem->InitializeVector(vector_tmp);
  ...
  for (unsigned int i = 0; i < this->m_LinearSystem->GetSystemOrder(); i++)
  {
    ...
    this->m_LinearSystem->SetVectorValue(
      i,
  ...
  for (unsigned int i = 0; i < this->m_LinearSystem->GetSystemOrder(); i++)
  {
    ...
    this->m_LinearSystem->SetSolutionValue(
      i, dhat + this->m_Beta * this->m_TimeStep * this->m_TimeStep * a1, solution_d);

    this->m_LinearSystem->SetSolutionValue(i, vhat + this->m_Gamma * this->m_TimeStep * a1, solution_v);
  }
...
template <unsigned int VDimension>
void
SolverHyperbolic<VDimension>::GenerateData()
{
  // Call Solver
  this->RunSolver();
}
...
template <unsigned int VDimension>
void
SolverHyperbolic<VDimension>::RunSolver()
{
