...
public:
  ...
  using Self = Element2DC0QuadraticTriangularStress;
  using Superclass = Element2DStress<Element2DC0QuadraticTriangular>;
  ...
  itkOverrideGetNameOfClassMacro(Element2DC0QuadraticTriangularStress);
