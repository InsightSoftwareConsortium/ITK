...
extern "C"
{
   ...
   */
  extern int
  dcopy_(integer * n, doublereal * dx, integer * incx, doublereal * dy, integer * incy);
   ...
   */
  extern doublereal
  eigvns_(integer * n, doublereal * tri, doublereal * d__, doublereal * e2, integer * ier);
   ...
   */
  extern doublereal
  eigvss_(integer * n, doublereal * tri, doublereal * start, doublereal * zeta, integer * itmax, integer * ier);
   ...
   */
  extern doublereal
  pbeta_(integer * nn, integer * ia, integer * ja, doublereal * a, doublereal * v, doublereal * w1, doublereal * w2);

  /*
   * FIXME: add doc
   */
  extern int
  pbsor_(integer * nn, integer * ia, integer * ja, doublereal * a, doublereal * u, doublereal * rhs);
   ...
   */
  extern int
  pfsor_(integer * nn, integer * ia, integer * ja, doublereal * a, doublereal * u, doublereal * rhs);

  /*
   * FIXME: add doc
   */
  extern int
  pfsor1_(integer * nn, integer * ia, integer * ja, doublereal * a, doublereal * u, doublereal * rhs);

  /*
   * FIXME: add doc
   */
  extern int
  pjac_(integer * nn, integer * ia, integer * ja, doublereal * a, doublereal * u, doublereal * rhs);

  /*
   * FIXME: add doc
   */
  extern int
  pmult_(integer * nn, integer * ia, integer * ja, doublereal * a, doublereal * u, doublereal * w);
   ...
   */
  extern int
  prsblk_(integer * nnb, integer * nnr, integer * ia, integer * ja, doublereal * a, doublereal * ur, doublereal * vb);

  /*
   * FIXME: add doc
   */
  extern int
  prsred_(integer * nnb, integer * nnr, integer * ia, integer * ja, doublereal * a, doublereal * ub, doublereal * vr);
   ...
   */
  extern int
  sbend_(integer * nn, integer * nz, integer * ia, integer * ja, doublereal * a, integer * iwork);
   ...
   */
  extern int
  sbini_(integer * nn, integer * nz, integer * ia, integer * ja, doublereal * a, integer * iwork);
   ...
   */
  extern int
  unscal_(integer * n, integer * ia, integer * ja, doublereal * a, doublereal * rhs, doublereal * u, doublereal * d__);
   ...
   */
  extern int
  vout_(integer * n, doublereal * v, integer * iswt, integer * noutt);
