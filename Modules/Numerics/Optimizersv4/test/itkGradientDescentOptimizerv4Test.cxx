                                  ...
                                  GradientDescentOptimizerv4TestMetric::ParametersType & trueParameters)
{
  ...
  static constexpr ParametersType::ValueType eps{ 0.03 };
...
itkGradientDescentOptimizerv4Test(int, char *[])
{
  ...
  static constexpr double maximumStepSizeInPhysicalUnits{ 0.0 };
  ...
  static constexpr bool doEstimateLearningRateOnce{ true };
  ITK_TEST_SET_GET_BOOLEAN(itkOptimizer, DoEstimateLearningRateOnce, doEstimateLearningRateOnce);

  static constexpr bool returnBestParametersAndValue{ false };
