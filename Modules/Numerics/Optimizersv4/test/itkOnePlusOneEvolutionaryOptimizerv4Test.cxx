...
itkOnePlusOneEvolutionaryOptimizerv4Test(int, char *[])
{
  ...
  static constexpr double growthFactor{ 1.05 };
  ...
  static constexpr double initialRadius{ 1.01 };
  ...
  static constexpr double metricWorstPossibleValue{ 0 };
  ...
  static constexpr bool catchGetValueException{ false };
