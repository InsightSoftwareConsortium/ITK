...
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(GradientDescentOptimizerBasev4ModifyGradientByScalesThreaderTemplate);
  ...
  itkOverrideGetNameOfClassMacro(GradientDescentOptimizerBasev4ModifyGradientByScalesThreaderTemplate);
