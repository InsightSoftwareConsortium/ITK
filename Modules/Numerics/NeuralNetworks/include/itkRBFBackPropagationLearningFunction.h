...
public:
  ...
  void Learn(LayerType* layer,ValueType learningrate) ITK_OVERRIDE;
  void Learn(LayerType* layer, TTargetVector error, ValueType learningrate) ITK_OVERRIDE;
...
protected:
  ...
  ~RBFBackPropagationLearningFunction() ITK_OVERRIDE {};
