...
{
  itk::ArrowSpatialObject<3>::Pointer ArrowSpatialObjectObj =
    itk::ArrowSpatialObject<3>::New();
  ...
  itk::BoxSpatialObject<3>::Pointer BoxSpatialObjectObj =
    itk::BoxSpatialObject<3>::New();
  std::cout << "----------BoxSpatialObject " << BoxSpatialObjectObj;

  itk::ContourSpatialObject<3>::Pointer ContourSpatialObjectObj =
    itk::ContourSpatialObject<3>::New();
  std::cout << "----------ContourSpatialObject " << ContourSpatialObjectObj;

  itk::DTITubeSpatialObject<3>::Pointer DTITubeSpatialObjectObj =
    itk::DTITubeSpatialObject<3>::New();
  ...
  itk::GaussianSpatialObject<3>::Pointer GaussianSpatialObjectObj =
    itk::GaussianSpatialObject<3>::New();
  ...
  itk::ImageMaskSpatialObject<3>::Pointer ImageMaskSpatialObjectObj =
