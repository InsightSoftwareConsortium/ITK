...
int
itkBasicFiltersPrintTest2(int, char *[])
{
  ...
  using SphereSpatialFunctionType = itk::SphereSpatialFunction<MeshType::PointDimension, MeshType::PointType>;
  ...
  itk::ImportImageFilter<float>::Pointer ImportImageFilterObj = itk::ImportImageFilter<float>::New();
  ...
  itk::InteriorExteriorMeshFilter<MeshType, MeshType, SphereSpatialFunctionType>::Pointer
    InteriorExteriorMeshFilterObj =
  ...
  itk::MaskNeighborhoodOperatorImageFilter<InputType, InputType, OutputType>::Pointer
    MaskNeighborhoodOperatorImageFilterObj =
  ...
  itk::PasteImageFilter<InputType>::Pointer PasteImageFilterObj = itk::PasteImageFilter<InputType>::New();
  ...
  itk::RandomImageSource<OutputType>::Pointer RandomImageSourceObj = itk::RandomImageSource<OutputType>::New();
  ...
  itk::SparseFieldLayer<node_type>::Pointer SparseFieldLayerObj = itk::SparseFieldLayer<node_type>::New();
  std::cout << "-------------SparseFieldLayer" << SparseFieldLayerObj;

  itk::SpatialFunctionImageEvaluatorFilter<GaussianSpatialFunctionType, InputType, OutputType>::Pointer
    SpatialFunctionImageEvaluatorFilterObj =
  ...
  itk::TernaryMagnitudeImageFilter<InputType, InputType, InputType, OutputType>::Pointer
    TernaryMagnitudeImageFilterObj =
  ...
  itk::TernaryMagnitudeSquaredImageFilter<InputType, InputType, InputType, OutputType>::Pointer
    TernaryMagnitudeSquaredImageFilterObj =
  ...
  itk::ThresholdImageFilter<InputType>::Pointer ThresholdImageFilterObj = itk::ThresholdImageFilter<InputType>::New();
  std::cout << "-------------ThresholdImageFilter" << ThresholdImageFilterObj;

  itk::TobogganImageFilter<InputType>::Pointer TobogganImageFilterObj = itk::TobogganImageFilter<InputType>::New();
  ...
  itk::VTKImageExport<InputType>::Pointer VTKImageExportObj = itk::VTKImageExport<InputType>::New();
  std::cout << "-------------VTKImageExport" << VTKImageExportObj;

  itk::VTKImageImport<OutputType>::Pointer VTKImageImportObj = itk::VTKImageImport<OutputType>::New();
  std::cout << "-------------VTKImageImport" << VTKImageImportObj;

  itk::VectorCurvatureAnisotropicDiffusionImageFilter<VectorImageType, VectorImageType>::Pointer
    VectorCurvatureAnisotropicDiffusionImageFilterObj =
      itk::VectorCurvatureAnisotropicDiffusionImageFilter<VectorImageType, VectorImageType>::New();
  std::cout << "-------------VectorCurvatureAnisotropicDiffusionImageFilter"
            << VectorCurvatureAnisotropicDiffusionImageFilterObj;

  itk::VectorCurvatureNDAnisotropicDiffusionFunction<VectorImageType>::Pointer
    VectorCurvatureNDAnisotropicDiffusionFunctionObj =
      itk::VectorCurvatureNDAnisotropicDiffusionFunction<VectorImageType>::New();
  std::cout << "-------------VectorCurvatureNDAnisotropicDiffusionFunction"
            << VectorCurvatureNDAnisotropicDiffusionFunctionObj;
  ...
  itk::VectorGradientAnisotropicDiffusionImageFilter<VectorImageType, VectorImageType>::Pointer
    VectorGradientAnisotropicDiffusionImageFilterObj =
      itk::VectorGradientAnisotropicDiffusionImageFilter<VectorImageType, VectorImageType>::New();
  std::cout << "-------------VectorGradientAnisotropicDiffusionImageFilter"
            << VectorGradientAnisotropicDiffusionImageFilterObj;
  ...
  itk::VectorGradientNDAnisotropicDiffusionFunction<VectorImageType>::Pointer
    VectorGradientNDAnisotropicDiffusionFunctionObj =
      itk::VectorGradientNDAnisotropicDiffusionFunction<VectorImageType>::New();
  std::cout << "-------------VectorGradientNDAnisotropicDiffusionFunction"
            << VectorGradientNDAnisotropicDiffusionFunctionObj;

  itk::VectorIndexSelectionCastImageFilter<VectorImageType, VectorImageType>::Pointer
    VectorIndexSelectionCastImageFilterObj =
  ...
  itk::VectorNeighborhoodOperatorImageFilter<VectorImageType, VectorImageType>::Pointer
    VectorNeighborhoodOperatorImageFilterObj =
  ...
  itk::ZeroCrossingBasedEdgeDetectionImageFilter<InputType, OutputType>::Pointer
    ZeroCrossingBasedEdgeDetectionImageFilterObj =
