...
itkBasicFiltersPrintTest(int, char *[])
{
  ...
  itk::ComposeImageFilter<InputType>::Pointer ComposeImageFilterObj = itk::ComposeImageFilter<InputType>::New();
  ...
  itk::CurvatureAnisotropicDiffusionImageFilter<InputType, OutputType>::Pointer
  ...
  itk::SignedDanielssonDistanceMapImageFilter<InputType, OutputType>::Pointer
  ...
  itk::DiffusionTensor3DReconstructionImageFilter<float, double, float>::Pointer
  ...
  itk::DilateObjectMorphologyImageFilter<InputType, OutputType, KernelType>::Pointer
  ...
  itk::ErodeObjectMorphologyImageFilter<InputType, OutputType, KernelType>::Pointer
  ...
  itk::FlipImageFilter<InputType>::Pointer FlipImageFilterObj = itk::FlipImageFilter<InputType>::New();
  std::cout << "-------------FlipImageFilter" << FlipImageFilterObj;

  itk::GaussianImageSource<OutputType>::Pointer GaussianImageSourceObj = itk::GaussianImageSource<OutputType>::New();
  std::cout << "-------------GaussianImageSource" << GaussianImageSourceObj;

  itk::GradientAnisotropicDiffusionImageFilter<InputType, OutputType>::Pointer
  ...
  itk::GradientImageFilter<InputType>::Pointer GradientImageFilterObj = itk::GradientImageFilter<InputType>::New();
  ...
  itk::GradientMagnitudeRecursiveGaussianImageFilter<InputType>::Pointer
  ...
  itk::GrayscaleFunctionDilateImageFilter<InputType, OutputType, KernelType>::Pointer
  ...
  itk::GrayscaleFunctionErodeImageFilter<InputType, OutputType, KernelType>::Pointer
