...
itkAreaOpeningImageFilterTest(int argc, char * argv[])
{
  ...
  using FilterType = itk::AreaOpeningImageFilter<IType, IType>;
  auto filter = FilterType::New();

  ITK_EXERCISE_BASIC_OBJECT_METHODS(filter, AreaOpeningImageFilter, AttributeMorphologyBaseImageFilter);
