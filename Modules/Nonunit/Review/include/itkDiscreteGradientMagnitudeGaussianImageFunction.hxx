...
template <typename TInputImage, typename TOutput>
void
DiscreteGradientMagnitudeGaussianImageFunction<TInputImage, TOutput>::SetInputImage(const InputImageType * ptr)
{
...
template <typename TInputImage, typename TOutput>
void
DiscreteGradientMagnitudeGaussianImageFunction<TInputImage, TOutput>::RecomputeGaussianKernel()
{
