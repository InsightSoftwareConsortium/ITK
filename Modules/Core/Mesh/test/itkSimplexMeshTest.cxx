...
itkSimplexMeshTest(int, char *[])
{
   ...
   */
  const SimplexMeshType::CoordinateType testPointCoords[8][3] = { { 0, 0, 0 }, { 9, 0, 0 }, { 9, 0, 9 }, { 0, 0, 9 },
   ...
   */
  using PointType = SimplexMeshType::PointType;
   ...
   */
  simplexMesh->SetCellsAllocationMethod(
