...
private:
  ImageToParametricSpaceFilter(const ImageToParametricSpaceFilter &) ITK_DELETED_FUNCTION;
  void operator=(const ImageToParametricSpaceFilter &) ITK_DELETED_FUNCTION;
