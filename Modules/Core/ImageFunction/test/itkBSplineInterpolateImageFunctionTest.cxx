...
test1DCubicSpline()
{
  ...
  static constexpr bool useImageDirection{ true };
...
#define NPOINTS 5 // number of points
  ...
  static constexpr double           truth[NPOINTS]{ 334.41265437584, 18.158173426944, 4.0000, 0, 442.24157192006658 };
  static constexpr bool             b_Inside[NPOINTS]{ true, true, true, false, true };
...
test2DSpline()
{
  ...
  /* Set origin and spacing of physical coordinates */
  static constexpr double origin[]{ 0.5, 1.0 };
  static constexpr double spacing[]{ 0.1, 0.5 };
  image->SetOrigin(origin);
  image->SetSpacing(spacing);
...
#define NPOINTS2 4 // number of points
    ...
    static constexpr bool b_Inside[NPOINTS2]{ true, true, true, false };
...
test3DSpline()
{
  ...
  /* Set origin and spacing of physical coordinates */
  static constexpr double origin[]{ 0.5, 1.0, 1.333 };
  static constexpr double spacing[]{ 0.1, 0.5, 0.75 };
  image->SetOrigin(origin);
  image->SetSpacing(spacing);
...
#define NPOINTS3 5 // number of points
    ...
    static constexpr bool b_Inside[NPOINTS3]{ true, true, true, false, true };
...
test3DSplineDerivative()
{
  ...
  /* Set origin and spacing of physical coordinates */
  static constexpr double origin[]{ 0.0, 0.0, 0.0 };
  static constexpr double spacing[]{ 1, 1, 1 };
  image->SetOrigin(origin);
  image->SetSpacing(spacing);
...
#define NPOINTS4 4 // number of points
    ...
    static constexpr bool b_Inside[NPOINTS4]{ true, true, true, false };
...
#define NPOINTS4b 4 // number of points
    ...
    constexpr double      truth[NPOINTS4b][4] = { { 48.621593795, 48.651173138, 48.656914878, 48.662256571 },
                                                  ...
                                                  { 42.0, 42.0, 42.0, 42.0 },
                                                  { 0, 0, 0, 0 } };
    static constexpr bool b_Inside[NPOINTS4b]{ true, true, true, false };
...
{
  static constexpr SizeType1D size{ 36 };
  static constexpr double mydata[36]{ 454.0000, 369.4000,  295.2000,  230.8000, 175.6000, 129.0000, 90.4000, 59.2000,
...
{
  static constexpr SizeType2D size{ 7, 7 };
  static constexpr double     mydata[49]{
