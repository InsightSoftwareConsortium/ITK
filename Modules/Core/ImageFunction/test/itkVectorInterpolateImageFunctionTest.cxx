...
itkVectorInterpolateImageFunctionTest(int, char *[])
{
  ...
  // position near image border
  {
    ...
    static constexpr double                  temp[3]{ 79, 158, 237 };
    output = OutputType(temp);
    cindex = ContinuousIndexType(darray);
    passed = TestContinuousIndex(interp, cindex, true, output);
  }
  ...
  {
    static constexpr itk::SpacePrecisionType darray[3]{ 20, 20, 40 };
    static constexpr double                  temp[3]{ 1, 1, 1 };
    output = OutputType(temp);
    cindex = ContinuousIndexType(darray);
  ...
  {
    static constexpr itk::SpacePrecisionType darray[3]{ 5.25, 12.5, 42.0 };
    static constexpr double                  temp[3]{ 59.75, 119.5, 179.25 };
    output = OutputType(temp);
    cindex = ContinuousIndexType(darray);
    passed = TestContinuousIndex(interp, cindex, true, output);
  }
