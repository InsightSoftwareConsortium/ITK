...
itkBSplineDecompositionImageFilterTest(int argc, char * argv[])
{
  ...
  const itk::SimpleFilterWatcher watcher(filter, "BSplineDecompositionImageFilter");

  filter->SetInput(randImage);

  static constexpr int unsupportedSplineOrder{ 6 };
  ...
  static constexpr double           tolerance1{ 1e-10 };
  ...
  static constexpr double tolerance2{ 1e-5 };
