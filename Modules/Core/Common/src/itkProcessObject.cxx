...
static constexpr size_t ITK_GLOBAL_INDEX_NAMES_NUMBER{ 10 };
static constexpr size_t ITK_GLOBAL_INDEX_NAMES_LENGTH{ 3 };
static constexpr char   globalIndexNames[ITK_GLOBAL_INDEX_NAMES_NUMBER][ITK_GLOBAL_INDEX_NAMES_LENGTH]{
