...
public:
  ...
  virtual NeighborhoodType
  GetNeighborhood() const final;

  /** Returns the pixel value located at a linear array location i. */
  virtual PixelType
  GetPixel(const NeighborIndexType i) const final
  {
  ...
  virtual PixelType
  GetPixel(NeighborIndexType i, bool & IsInBounds) const final;

  /** Returns the pixel value located at the itk::Offset o from the center of
      the neighborhood. */
  virtual PixelType
  GetPixel(const OffsetType & o) const final
  {
    bool inbounds;
   ...
   * image and the pixel value returned is a boundary condition. */
  virtual PixelType
  GetPixel(const OffsetType & o, bool & IsInBounds) const final
  {
  ...
  virtual PixelType
  GetNext(const unsigned int axis, NeighborIndexType i) const final
  {
  ...
  virtual PixelType
  GetNext(const unsigned int axis) const final
  {
   ...
   *  is done on the size of the neighborhood. */
  virtual PixelType
  GetPrevious(const unsigned int axis, NeighborIndexType i) const final
  {
    return (this->GetPixel(this->GetCenterNeighborhoodIndex() - (i * this->GetStride(axis))));
  }
   ...
   *  done on the size of the neighborhood. */
  virtual PixelType
  GetPrevious(const unsigned int axis) const final
  {
    return (this->GetPixel(this->GetCenterNeighborhoodIndex() - this->GetStride(axis)));
  }
  ...
  virtual void
  OverrideBoundaryCondition(const ImageBoundaryConditionPointerType i) final
  {
  ...
  virtual void
  SetRegion(const RegionType & region) final;
...
protected:
   ...
   * \sa SetLocation */
  virtual void
  SetPixelPointers(const IndexType &) final;
