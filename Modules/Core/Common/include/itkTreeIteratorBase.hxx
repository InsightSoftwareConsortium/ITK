...
class ITKCommon_EXPORT TreeNodeChangeEvent;

template< typename TTreeType >
class ITKCommon_EXPORT TreeAddEvent;

template< typename TTreeType >
class ITKCommon_EXPORT TreePruneEvent;

template< typename TTreeType >
class ITKCommon_EXPORT TreeRemoveEvent;
