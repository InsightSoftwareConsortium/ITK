...
class ITKCommon_EXPORT TreeChangeEvent:public ModifiedEvent
{
public:
 ...
 */
template< typename TTreeType >
class ITKCommon_EXPORT TreeAddEvent:public TreeChangeEvent< TTreeType >
{
public:
 ...
 */
template< typename TTreeType >
class ITKCommon_EXPORT TreeRemoveEvent:public TreeChangeEvent< TTreeType >
{
public:
 ...
 */
template< typename TTreeType >
class ITKCommon_EXPORT TreePruneEvent:public TreeRemoveEvent< TTreeType >
{
public:
