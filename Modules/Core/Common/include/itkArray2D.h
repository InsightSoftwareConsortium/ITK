...
template<> ITK_TEMPLATE_EXPORT std::ostream & operator<<(std::ostream & os, const Array2D< float > & arr);
template<> ITK_TEMPLATE_EXPORT std::ostream & operator<<(std::ostream & os, const Array2D< double > & arr);
