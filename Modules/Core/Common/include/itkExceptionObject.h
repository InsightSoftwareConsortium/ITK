...
public:
  ...
  * the copy constructor of ExceptionObject never throw an exception. */
  ...
  ~ExceptionObject() ITK_NOEXCEPT ITK_OVERRIDE;
  ...
  const char * what() const ITK_NOEXCEPT ITK_OVERRIDE;
...
public:
  ...
  /** Virtual destructor needed for subclasses. Has to have empty throw(). */
  ~MemoryAllocationError() ITK_NOEXCEPT ITK_OVERRIDE;
...
public:
  ...
  /** Virtual destructor needed for subclasses. Has to have empty throw(). */
  ~RangeError() ITK_NOEXCEPT ITK_OVERRIDE;
...
public:
  ...
  /** Virtual destructor needed for subclasses. Has to have empty throw(). */
  ~InvalidArgumentError() ITK_NOEXCEPT ITK_OVERRIDE;
...
public:
  ...
  /** Virtual destructor needed for subclasses. Has to have empty throw(). */
  ~IncompatibleOperandsError() ITK_NOEXCEPT ITK_OVERRIDE;
...
public:
  ...
  /** Virtual destructor needed for subclasses. Has to have empty throw(). */
  ~ProcessAborted()  ITK_NOEXCEPT ITK_OVERRIDE;
