...
public:
  ...
  virtual void
  SetCenterPixel(const PixelType & p) final
  {
  ...
  virtual void
  SetNeighborhood(const NeighborhoodType &) final;
  ...
  virtual void
  SetPixel(const unsigned int i, const PixelType & v, bool & status) final;

  /** Set the pixel at the ith location. */
  virtual void
  SetPixel(const unsigned int i, const PixelType & v) final;

  //  { *(this->operator[](i)) = v; }

  /** Set the pixel at offset o from the neighborhood center */
  virtual void
  SetPixel(const OffsetType o, const PixelType & v) final
  {
  ...
  virtual void
  SetNext(const unsigned int axis, const unsigned int i, const PixelType & v) final
  {
  ...
  virtual void
  SetNext(const unsigned int axis, const PixelType & v) final
  {
  ...
  /** Sets the pixel value located i pixels distant from the neighborhood center in
      ...
      the size of the neighborhood. */
  virtual void
  SetPrevious(const unsigned int axis, const unsigned int i, const PixelType & v) final
  {
    this->SetPixel(this->GetCenterNeighborhoodIndex() - (i * this->GetStride(axis)), v);
  }
  ...
  /** Sets the pixel value located one pixel distant from the neighborhood center in
      ...
      size of the neighborhood. */
  virtual void
  SetPrevious(const unsigned int axis, const PixelType & v) final
  {
    this->SetPixel(this->GetCenterNeighborhoodIndex() - this->GetStride(axis), v);
  }
};
