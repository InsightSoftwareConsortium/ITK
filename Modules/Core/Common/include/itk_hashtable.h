...
// Use this hashtable that is already define for GNU_C versions >= 3.1, IBMCPP
// >=600, or Intel compilers with GCCv4
...
struct hashtable_iterator {
  ...
  hashtable_iterator(): cur(NULL), ht(NULL) {}
...
class hashtable;
template< class Value, class Key, class HashFcn, class ExtractKey, class EqualKey, class Alloc >
bool operator==(hashtable< Value, Key, HashFcn, ExtractKey, EqualKey, Alloc > const &,
...
hashtable< Value, Key, HashFcn, ExtractKey, EqualKey,
           Alloc >::erase(const hashtable_iterator< Value, Key, HashFcn, ExtractKey, EqualKey,
                                                    Alloc > & it)
{
  node *const p = it.cur;
...
void
hashtable< Value, Key, HashFcn, ExtractKey, EqualKey,
           Alloc >::erase(hashtable_iterator< Value, Key, HashFcn, ExtractKey, EqualKey, Alloc > first,
                          hashtable_iterator< Value, Key, HashFcn,
                                              ExtractKey, EqualKey,
                                              Alloc > last)
{
...
inline void
hashtable< Value, Key, HashFcn, ExtractKey, EqualKey,
           Alloc >::erase(hashtable_const_iterator< Value, Key, HashFcn, ExtractKey, EqualKey, Alloc > first,
                          hashtable_const_iterator< Value, Key, HashFcn,
                                                    ExtractKey, EqualKey,
                                                    Alloc > last)
{
...
inline void
hashtable< Value, Key, HashFcn, ExtractKey, EqualKey,
           Alloc >::erase(const hashtable_const_iterator< Value, Key, HashFcn, ExtractKey, EqualKey,
                                                          Alloc > & it)
{
...
#if ( defined ( _MSC_VER ) && ( _MSC_VER < 1600 ) ) || ( ( defined( __ICC ) || defined( __ECC ) ) && defined( linux ) )
// This should be replaced with a try_compile that tests the availability of
// std::identity. FIXME
namespace std
{
template< class T >
...
#if defined ( _MSC_VER ) || ( ( defined( __ICC ) || defined( __ECC ) ) && defined( linux ) )
// This should be replaced with a try_compile that tests the availability of
// std::select*. FIXME
...
template< class _Pair >
struct select2nd:public itk_Select2nd< _Pair > {};
}
