...
itkImageIteratorTest(int, char *[])
{
  ...
  static constexpr itk::Image<itk::Vector<unsigned short, 5>, ImageDimension>::SizeType imageSize3D{ { 20, 40, 60 } };

  static constexpr itk::Image<itk::Vector<unsigned short, 5>, ImageDimension>::IndexType startIndex3D{ { 5, 4, 1 } };
  static constexpr itk::Image<itk::Vector<unsigned short, 5>, ImageDimension>::IndexType regionStartIndex3D{
    { 5, 10, 12 }
  };
  static constexpr itk::Image<itk::Vector<unsigned short, 5>, ImageDimension>::IndexType regionEndIndex3D{
    { 8, 15, 17 }
  };
