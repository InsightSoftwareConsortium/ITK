...
itkStdStreamStateSaveTest(int, char *[])
{
...

  {
    ...
    std::cout.width(25);
    static constexpr int anInt{ 123 };
    std::cout.fill('%');
    ...
    static constexpr bool aBool{ false };
    std::cout << aBool << std::endl;
    std::cout << std::boolalpha << aBool << std::endl;
    static constexpr double aDouble{ 123.e-5 };
  ...
  static constexpr int originalInt{ 10 };
  {
    ...
    stream.precision(14);
    stream.width(25);
    static constexpr int anInt{ originalInt };
    stream.fill('%');
