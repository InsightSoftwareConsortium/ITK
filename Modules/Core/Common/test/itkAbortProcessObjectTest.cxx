...
itkAbortProcessObjectTest(int, char *[])
{
  ...
  static constexpr ShortImage::SizeType  size{ 100, 100 };
  ...
  // fill in an image
  static constexpr ShortImage::IndexType extractIndex{ 0, 0 };
  static constexpr ShortImage::SizeType  extractSize{ 99, 99 };
