...
ExtractImageInPlaceTest()
{
  ...
  static constexpr ImageType::SizeType size{ 32, 32, 32 };
  source->SetSize(size);

  source->UpdateLargestPossibleRegion();


  static constexpr ImageType::IndexType extractIndex{ 16, 16, 16 };
  static constexpr ImageType::SizeType  extractSize{ 8, 8, 8 };
  static constexpr ImageType::SizeType  zeroSize{ 0, 0, 0 };
