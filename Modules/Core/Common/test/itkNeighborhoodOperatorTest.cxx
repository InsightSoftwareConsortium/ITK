...
itkNeighborhoodOperatorTest(int, char *[])
{
  ...
  static constexpr unsigned int Dimension1D{ 1 };
  static constexpr unsigned int Dimension2D{ 2 };
  static constexpr unsigned int Dimension3D{ 3 };
  static constexpr unsigned int Dimension4D{ 4 };
  ...
  static constexpr double variance{ 2.3 };
  g.SetVariance(variance);
  ITK_TEST_SET_GET_VALUE(variance, g.GetVariance());

  static constexpr double maximumError{ .01 };
  ...
  static constexpr double scales_1d[]{ 1.0 / 2.0 };
  ...
  static constexpr double scales_2d[]{ 1.0 / 2.0, 1.0 / 4.0 };
  ...
  static constexpr double scales_3d[]{ 1.0 / 2.0, 1.0 / 4.0, 1.0 / 5.0 };
