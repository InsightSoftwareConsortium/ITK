...
TEST(SpatialOrientationAdaptor, test1)
{
  ...
  EXPECT_EQ(itk::SpatialOrientation::ITK_COORDINATE_ORIENTATION_RAI, adapter.FromDirectionCosines(d1));
  ...
  EXPECT_EQ(itk::SpatialOrientation::ITK_COORDINATE_ORIENTATION_ASL, adapter.FromDirectionCosines(d2));
}
