...
template class itk::Experimental::IndexRange<1>;
template class itk::Experimental::IndexRange<2>;
...
TEST(IndexRange, SupportsImageRegion)
{
  ...
  const IndexRange<Dimension> indexRange(size);
