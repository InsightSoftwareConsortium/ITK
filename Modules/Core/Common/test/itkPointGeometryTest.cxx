...
itkPointGeometryTest(int, char *[])
{
  ...
  {
    PointType                             midpoint;
    static constexpr PointType::ValueType aInit[3]{ 2.0, 4.0, 7.0 };
    static constexpr PointType::ValueType bInit[3]{ 6.0, 2.0, 9.0 };
    PointType                             A = aInit;
    PointType                             B = bInit;
  ...
  // Test the Barycentric combination
  {
    static constexpr double               tolerance{ 1e-10 };
    PointType                             combination;
    static constexpr PointType::ValueType aInit[3]{ 12.0, 0.0, 0.0 };
    static constexpr PointType::ValueType bInit[3]{ 0.0, 0.0, 12.0 };
    static constexpr PointType::ValueType cInit[3]{ 0.0, 12.0, 0.0 };
    PointType                             A = aInit;
    PointType                             B = bInit;
    PointType                             C = cInit;
    static constexpr double               alpha{ 1.0 / 3.0 };
    static constexpr double               beta{ 1.0 / 3.0 };
  ...
  // Test the Barycentric combination for an array
  {
    static constexpr double       tolerance{ 1e-10 };
    PointType                     combination;
    static constexpr unsigned int NP{ 3 };
    PointType                     A[NP];
    double                        w[NP - 1];
    static constexpr double       K{ 12.0 };
