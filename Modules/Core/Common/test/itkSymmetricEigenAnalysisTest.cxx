...
itkSymmetricEigenAnalysisTest(int argc, char * argv[])
{
...

  {
         ...
         ++useEigenLibrary)
    {
      ...
      static constexpr double eigvec3[6]{ 0.5236407, -0.0013422, -0.4199706, -0.5942299, 0.4381326, 0.0659837 };
      static constexpr double eigvals[6]{ 0.170864, 2.16934, 3.79272, 15.435, 24.6083, 78.2994 };
...

  {
    ...
    static constexpr double Sdata[36]{
      30.0000, -3.4273, 13.9254, 13.7049, -2.4446, 20.2380, -3.4273, 13.7049, -2.4446, 1.3659,  3.6702,  -0.2282,
      13.9254, -2.4446, 20.2380, 3.6702,  -0.2282, 28.6779, 13.7049, 1.3659,  3.6702,  12.5273, -1.6045, 3.9419,
      -2.4446, 3.6702,  -0.2282, -1.6045, 3.9419,  2.5821,  20.2380, -0.2282, 28.6779, 3.9419,  2.5821,  44.0636,
    };
...

  {
    ...
    EigenValuesArrayType                        eigenvalues;
    EigenVectorMatrixType                       eigenvectors;
    static constexpr SymmetricEigenAnalysisType symmetricEigenSystem;
...

  {
    ...
    static constexpr double Sdata[9]{
         ...
         ++useEigenLibrary)
    {
      ...
      static constexpr double eigvec3[3]{ 0.0, 1.0, 0.0 };
      static constexpr double eigvals[3]{ -1.0, -3.0, 5.0 };
...

  {
    ...
    static constexpr float Sdata[9]{ -7.31129000e+00f, 2.33080000e+01f,  0.00000000e+00f,
         ...
         ++useEigenLibrary)
    {
      ...
      static constexpr float eigvec2[3]{ 0.75674412f, -0.6537112f, 0.0f };
      static constexpr float eigvals[3]{ -3.26256000e-06f, 1.96703376e+01f, -2.74458376e+01f };
