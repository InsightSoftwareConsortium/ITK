...
itkImageRegionTest(int, char *[])
{
  ...
  static constexpr SizeType sizeA{ 10, 20, 30 };
  static constexpr SizeType sizeB{ 5, 10, 15 };

  static constexpr IndexType startA{ 12, 12, 12 };
  static constexpr IndexType startB{ 14, 14, 14 };
  static constexpr IndexType endA{ 21, 31, 41 };
  ...
  if (!itk::FloatingPointExceptions::GetEnabled() && ContinuousIndexNumericTraits::has_quiet_NaN)
  {
    ...
    static constexpr CoordinateType NaN{ ContinuousIndexNumericTraits::quiet_NaN() };
  ...
  static constexpr itk::OffsetValueType offsetValueRadius{ 4 };
