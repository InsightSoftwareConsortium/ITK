...
itkIteratorTests(int, char *[])
{
  ...
  static constexpr ScalarImage::SizeType imageSize3D{ 200, 200, 200 };
  static constexpr ScalarImage::SizeType bufferSize3D{ 200, 200, 200 };
  static constexpr ScalarImage::SizeType regionSize3D{ 190, 190, 190 };

  static constexpr ScalarImage::IndexType startIndex3D{ 0, 0, 0 };
  static constexpr ScalarImage::IndexType bufferStartIndex3D{ 0, 0, 0 };
  static constexpr ScalarImage::IndexType regionStartIndex3D{ 5, 5, 5 };
  ...
  static constexpr unsigned short scalar{ 5 };
