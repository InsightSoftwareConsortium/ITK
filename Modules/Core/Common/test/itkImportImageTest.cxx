...
itkImportImageTest(int, char *[])
{
  ...
  // but with the ImportImageContainer is creates.
  {
    ...
    static constexpr itk::SpacePrecisionType data[2]{ 1.0, 1.0 };
    import->SetSpacing(data);

    static constexpr float data2[2]{ 1.0, 1.0 };
    ...
    static constexpr double data3[2]{ 1.0, 1.0 };
    import->SetOrigin(data3);

    static constexpr float data4[2]{ 1.0, 1.0 };
