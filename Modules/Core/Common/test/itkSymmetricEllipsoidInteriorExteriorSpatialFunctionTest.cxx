...
itkSymmetricEllipsoidInteriorExteriorSpatialFunctionTest(int, char *[])
{
  ...
  static constexpr double uniqueAxisLength{ 45 };
  static constexpr double symmetricAxesLength{ 30 };
  ...
  static constexpr double volume{ 4.18879013333 * (uniqueAxisLength / 2) * (symmetricAxesLength / 2) *
