...
TEST(ShapedImageNeighborhoodRange, EquivalentBeginOrEndIteratorsCompareEqual)
{
  ...
  static constexpr itk::Size<ImageType::ImageDimension>     radius{};
  static constexpr ImageType::IndexType                     location{};
...
TEST(ShapedImageNeighborhoodRange, IteratorsCanBePassedToStdVectorConstructor)
{
  ...
  static constexpr ImageType::IndexType                     location{};
  static constexpr itk::Size<ImageType::ImageDimension>     radius{ 0, 1 };
  const std::vector<itk::Offset<ImageType::ImageDimension>> offsets =
    itk::GenerateRectangularImageNeighborhoodOffsets(radius);
  const itk::ShapedImageNeighborhoodRange<ImageType> range{ *image, location, offsets };
...
TEST(ShapedImageNeighborhoodRange, IteratorsCanBePassedToStdReverseCopy)
{
  ...
  static constexpr unsigned int numberOfNeighborhoodPixels{ 3 };
...
TEST(ShapedImageNeighborhoodRange, CanBeUsedAsExpressionOfRangeBasedForLoop)
{
  ...
  static constexpr PixelType reference_value{ 42 };
...
TEST(ShapedImageNeighborhoodRange, DistanceBetweenIteratorsCanBeObtainedBySubtraction)
{
  ...
  static constexpr ImageType::IndexType                     location{};
  static constexpr itk::Size<ImageType::ImageDimension>     radius{ 2, 3 };
  const std::vector<itk::Offset<ImageType::ImageDimension>> offsets =
    itk::GenerateRectangularImageNeighborhoodOffsets(radius);
  const itk::ShapedImageNeighborhoodRange<ImageType> range{ *image, location, offsets };
...
TEST(ShapedImageNeighborhoodRange, IteratorRetrievesSamePixelValuesAsConstNeighborhoodIterator)
{
  ...
  static constexpr ImageType::IndexType                     initialLocation{};
  static constexpr ImageType::IndexType                     testLocations[]{ {}, { { 0, 1 } }, { { 1, 0 } } };
  static constexpr itk::Size<ImageType::ImageDimension>     radius{ 2, 3 };
  const std::vector<itk::Offset<ImageType::ImageDimension>> offsets =
    itk::GenerateRectangularImageNeighborhoodOffsets(radius);
...
TEST(ShapedImageNeighborhoodRange, IteratorReferenceActsLikeARealReference)
{
  ...
  static constexpr ImageType::IndexType                     location{ 1, 0 };
  static constexpr itk::Size<ImageType::ImageDimension>     radius{ 1, 0 };
  const std::vector<itk::Offset<ImageType::ImageDimension>> offsets =
    itk::GenerateRectangularImageNeighborhoodOffsets(radius);
  const RangeType     range{ *image, location, offsets };
  ...
  const RangeType::const_iterator::reference reference4 = reference1;
  const RangeType::const_iterator::reference reference5 = reference2;
  const RangeType::const_iterator::reference reference6 = reference3;
...
TEST(ShapedImageNeighborhoodRange, SupportsVectorImage)
{
  ...
  static constexpr ImageType::IndexType                     location{ 0, 1 };
  static constexpr itk::Size<ImageType::ImageDimension>     radius{ 0, 1 };
  const std::vector<itk::Offset<ImageType::ImageDimension>> offsets =
    itk::GenerateRectangularImageNeighborhoodOffsets(radius);
...
TEST(ShapedImageNeighborhoodRange, IteratorsCanBePassedToStdSort)
{
  ...
  static constexpr ImageType::IndexType                     location{ 1, 1 };
  static constexpr itk::Size<ImageType::ImageDimension>     radius{ 1, 1 };
  const std::vector<itk::Offset<ImageType::ImageDimension>> offsets =
    itk::GenerateRectangularImageNeighborhoodOffsets(radius);
  const itk::ShapedImageNeighborhoodRange<ImageType> range{ *image, location, offsets };
...
TEST(ShapedImageNeighborhoodRange, ConstructorSupportsCArrayOfShapeOffsets)
{
  ...
  static constexpr OffsetType arrayOfShapeOffsets[]{ OffsetType{}, itk::MakeFilled<OffsetType>(1) };
...
TEST(ShapedImageNeighborhoodRange, SupportsArbitraryBufferedRegionIndex)
{
  ...
  static constexpr itk::Size<ImageType::ImageDimension> radius{ 0 };
  const auto offsets = itk::GenerateRectangularImageNeighborhoodOffsets(radius);

  static constexpr ImageType::IndexType zeroIndex{ 0 };
  static constexpr ImageType::IndexType arbitraryIndex{ 10, -1 };
  static constexpr ImageType::SizeType  imageSize{ 2, 3 };
  ...
  static constexpr ImageType::PixelType magicPixelValue{ 42 };
