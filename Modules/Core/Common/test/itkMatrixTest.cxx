...
itkMatrixTest(int, char *[])
{
  ...
  static constexpr PointType::ValueType p1Init[3]{ 3, 4, 5 };
  ...
  static constexpr NumericType value{ 2 };
  matrix5[1][1] = value;
  ...
  static constexpr NumericType value2{ 19 };
  matrix5(1, 1) = value2;
  ...
  { // Test for Matrix addition and subtraction
    static constexpr unsigned int nc{ 4 };
    static constexpr unsigned int nr{ 3 };
