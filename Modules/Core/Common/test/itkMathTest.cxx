...
static constexpr auto maxUnsignedValue{ std::numeric_limits<uintmax_t>::max() };
...
main(int, char *[])
{
  ...
  { // Test various equals operations.
    ...
    static constexpr std::complex<double> z1Double(1.1, 2.1);
    static constexpr std::complex<float>  z1Float(1.1f, 2.1f);
...
#if !defined(ITK_LEGACY_REMOVE)
    static constexpr std::complex<double> z2Double(1.0, 3.0);
    static constexpr std::complex<int>    z2Int(1, 3);
    ...
    static constexpr std::complex<double> z3Double(0.123, 0);
    static constexpr float                r3Float{ 0.123 };
    static constexpr double               r3Double{ 0.123 };
    ...
    static constexpr std::complex<float> z4Float(0.123, 0);
