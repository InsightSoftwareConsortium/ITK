...
itkImageTest(int, char *[])
{
  ...
  static constexpr double eps{ 1e-06 };
  ...
  static constexpr Image::IndexType index{};
  static constexpr auto             size{ Image::SizeType::Filled(4) };
  const Image::RegionType           region{ index, size };
  image->SetRegions(region);

  auto                              imageRef = Image::New();
  static constexpr auto             spacingRef{ itk::MakeFilled<Image::SpacingType>(2) };
  static constexpr Image::PointType originRef{};
  ...
  static constexpr Image::IndexType indexRef{};
  static constexpr auto             sizeRef{ itk::MakeFilled<Image::SizeType>(5) };
  ...
  static constexpr Image::IndexType correctIndex{};
  static constexpr auto             correctSize{ Image::SizeType::Filled(3) };
  ...
  static constexpr Image3D::IndexType indexCuboid{};
  ...
  static constexpr Image::IndexType correctRectangleIndex{};
