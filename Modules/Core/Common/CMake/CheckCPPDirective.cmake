...
macro(CHECK_CPP_DIRECTIVE_EXISTS DIRECTIVE VARIABLE)
  if(NOT DEFINED "HAVE_${VARIABLE}")
    message(
      STATUS
      "Checking to see if this platform has the ${DIRECTIVE} C-Preprocessor directive"
    )
    set(DIRECTIVE ${DIRECTIVE})
    configure_file(
      ${_CheckCPPDirective_DIR}/CheckCPPDirectiveExists.cxx.in
    ...
    if(${VARIABLE})
      ...
      message(
        STATUS
        "Checking to see if this platform supports has the ${DIRECTIVE} C-Preprocessor directive - yes"
      )
      file(
        APPEND
      ...
      message(
        STATUS
        "Checking to see if this platform supports has the ${DIRECTIVE} C-Preprocessor directive - no"
      )
      file(
        APPEND
