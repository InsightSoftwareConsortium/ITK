...
itkQuadEdgeMeshNoPointConstTest(int, char *[])
{
  ...
  static constexpr OriginRefType NUM_LIMIT{ std::numeric_limits<OriginRefType>::max() };
  static constexpr OriginRefType GQE_LIMIT{ QEType::m_NoPoint };
  static constexpr OriginRefType QEM_LIMIT{ MeshType::m_NoPoint };
