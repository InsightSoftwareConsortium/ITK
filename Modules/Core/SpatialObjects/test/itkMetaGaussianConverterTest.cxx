...
itkMetaGaussianConverterTest(int argc, char * argv[])
{
  ...
  static constexpr SpatialObjectType::ScalarType maximum{ 2 };
  static constexpr SpatialObjectType::ScalarType radius{ 3 };
  static constexpr SpatialObjectType::ScalarType sigma{ 1.5 };
  ...
  static constexpr double precisionLimit{ .000001 };
