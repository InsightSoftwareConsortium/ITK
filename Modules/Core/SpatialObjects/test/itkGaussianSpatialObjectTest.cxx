...
itkGaussianSpatialObjectTest(int, char *[])
{
  ...
  static constexpr GaussianType::TransformType::OffsetType::ValueType offset10{ 10.0 };
  ...
  static constexpr GaussianType::TransformType::OffsetType::ValueType offset15{ 15.0 };
