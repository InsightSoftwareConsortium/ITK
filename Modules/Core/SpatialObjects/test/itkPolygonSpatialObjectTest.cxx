...
itkPolygonSpatialObjectTest(int, char *[])
{
  ...
  static constexpr double      d1[3]{ 0.0, 0.0, 0.0 };
  const PolygonType::PointType p1(d1);
  static constexpr double      d2[3]{ 2.0, 0.0, 0.0 };
  const PolygonType::PointType p2(d2);
  static constexpr double      d3[3]{ 2.0, 1.0, 0.0 };
  const PolygonType::PointType p3(d3);
  static constexpr double      d4[3]{ 0.0, 1.0, 0.0 };
  ...
  static constexpr double objectSpaceThickness{ 10 };
  ...
  static constexpr bool isClosed{ true };
  ...
  static constexpr double             tp1[3]{ 0.25, 0.0, 0.0 };
  ...
  static constexpr double             tp2[3]{ 0.25, 5.0, 5.0 };
