                       ...
                       const unsigned int                                                componentToExtract)
{
  ...
  static constexpr unsigned int VectorLength{ VVectorLength };
...

  {
    ...
    static constexpr double   diff_tolerance{ 1e-13 };
...
itkVectorImageTest(int, char * argv[])
{
  ...
  // Test IO support.
  {
    ...
    auto                                        image = VectorImageType::New();
    static constexpr VectorImageType::IndexType start{};
...

  {
...

    {
      ...
      static constexpr auto                     size{ ConstNeighborhoodIteratorType::SizeType::Filled(4) };
