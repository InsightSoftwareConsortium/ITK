...
if(EXISTS "${OpenCV_DIR}")
        ...
        foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
                ...
                find_library(OpenCV_${__CVLIB}_LIBRARY_DEBUG NAMES "${__CVLIB}d" "lib${__CVLIB}d" PATHS "${OpenCV_DIR}/lib/" NO_DEFAULT_PATH)
                find_library(OpenCV_${__CVLIB}_LIBRARY_RELEASE NAMES "${__CVLIB}" "lib${__CVLIB}" PATHS "${OpenCV_DIR}/lib/" NO_DEFAULT_PATH)
                ...
                mark_as_advanced(FORCE OpenCV_${__CVLIB}_LIBRARY)
                mark_as_advanced(FORCE OpenCV_${__CVLIB}_LIBRARY_RELEASE)
                mark_as_advanced(FORCE OpenCV_${__CVLIB}_LIBRARY_DEBUG)
                
        endforeach(__CVLIB)

        set(OpenCV_LIBRARY_DIRS ${OpenCV_DIR}/lib CACHE BOOL "" FORCE)
        mark_as_advanced(FORCE OpenCV_FOUND)
