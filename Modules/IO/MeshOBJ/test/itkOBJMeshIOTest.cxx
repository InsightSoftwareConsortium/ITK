...
itkOBJMeshIOTest(int argc, char * argv[])
{
  ...
  static constexpr itk::SizeValueType pointBufferSize{ 100000 };
  static constexpr itk::SizeValueType pointDataBufferSize{ 100000 };

  static constexpr itk::SizeValueType cellBufferSize{ 100000 };
