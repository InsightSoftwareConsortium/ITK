...
int
Test1Type(char * file1, char * file2)
{
  int status = 0;

  status += ReadWrite<TScalar, 2>(
    itk::NumericTraits<TScalar>::NonpositiveMin(), itk::NumericTraits<TScalar>::max(), file1, file2, false);
  status += ReadWrite<TScalar, 2>(
    itk::NumericTraits<TScalar>::NonpositiveMin(), itk::NumericTraits<TScalar>::max(), file1, file2, true);
  status += ReadWrite<TScalar, 3>(
    itk::NumericTraits<TScalar>::NonpositiveMin(), itk::NumericTraits<TScalar>::max(), file1, file2, false);
  status += ReadWrite<TScalar, 3>(
    itk::NumericTraits<TScalar>::NonpositiveMin(), itk::NumericTraits<TScalar>::max(), file1, file2, true);
