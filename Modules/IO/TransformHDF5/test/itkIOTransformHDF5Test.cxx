...
ReadWriteTest(const std::string & fileName, const bool isRealDisplacementField, const bool useCompression)
{
  ...
  static constexpr double aNumberThatCanNotBeRepresentedInFloatingPoint{ 1e-5 + 1e-7 + 1e-9 + 1e-13 };
  static constexpr double requiredSpacing{ 1.2 + aNumberThatCanNotBeRepresentedInFloatingPoint };
  static constexpr double requiredOrigin{ 23.0 + aNumberThatCanNotBeRepresentedInFloatingPoint };
