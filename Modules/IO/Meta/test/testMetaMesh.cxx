...
bool
TestingMetaMesh(MetaMesh * _mesh)
{
  ...
  for (int j = 0; j < static_cast<int>(_mesh->GetCells(MET_TRIANGLE_CELL).size()); ++j)
  {
...
/** Main */
int
testMetaMesh(int argc, char * argv[])
{
  if (argc > 1)
  {
