...
itkCSVNumericObjectFileWriterTest(int argc, char * argv[])
{
  ...
  static constexpr char delimiterCharacter{ ',' };
  ...
  static constexpr unsigned int VMRows{ 3 };
  static constexpr unsigned int VMCols{ 4 };
  ...
  static constexpr unsigned int VRows{ 3 };
  static constexpr unsigned int VColumns{ 3 };
