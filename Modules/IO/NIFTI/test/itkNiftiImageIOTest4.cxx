...
itkNiftiImageIOTest4(int argc, char * argv[])
{
  ...
  //
  static constexpr unsigned int dimsize{ 2 };

  static constexpr Test4ImageType::SizeType  size{ dimsize, dimsize, dimsize };
  static constexpr Test4ImageType::IndexType index{};
