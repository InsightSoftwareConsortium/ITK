                                          ...
                                          bool                                                      flip_x = false)
{
  ...
  const itk::DICOMOrientation orientation_code(img->GetDirection());
  ...
  if (orientation_code != expected_code)
  {
    ...
    std::cerr << "expected orientation " << expected_code.GetAsString() << " but found "
              << orientation_code.GetAsString() << std::endl;
    return EXIT_FAILURE;
  }
  ...
  std::cout << "Analyze orientation :" << static_cast<int>(hist_orient_code) << std::endl
            ...
            << "Code     :" << orientation_code.GetAsString() << std::endl
...
itkNiftiReadAnalyzeTest(int argc, char * argv[])
{
  ...
  return itkNiftiAnalyzeContentsAndCoordinatesTest(
           argv,
           0,
    itk::DICOMOrientation(itk::DICOMOrientation::CoordinateEnum::RightToLeft,
                          itk::DICOMOrientation::CoordinateEnum::PosteriorToAnterior,
           ...
           itk::DICOMOrientation(itk::DICOMOrientation::CoordinateEnum::RightToLeft,
             ...
             itkNiftiAnalyzeContentsAndCoordinatesTest(
               argv,
               2,
           itk::DICOMOrientation(itk::DICOMOrientation::CoordinateEnum::PosteriorToAnterior,
                                 itk::DICOMOrientation::CoordinateEnum::InferiorToSuperior,
                                 itk::DICOMOrientation::CoordinateEnum::RightToLeft),
               itk::NiftiImageIOEnums::Analyze75Flavor::AnalyzeSPM) == EXIT_FAILURE ||
             itkNiftiAnalyzeContentsAndCoordinatesTest(
               argv,
               3,
           itk::DICOMOrientation(itk::DICOMOrientation::CoordinateEnum::RightToLeft,
                                 itk::DICOMOrientation::CoordinateEnum::AnteriorToPosterior,
                                  itk::DICOMOrientation::CoordinateEnum::InferiorToSuperior),
               itk::NiftiImageIOEnums::Analyze75Flavor::AnalyzeSPM) == EXIT_FAILURE ||
             itkNiftiAnalyzeContentsAndCoordinatesTest(
               argv,
               4,
           itk::DICOMOrientation(itk::DICOMOrientation::CoordinateEnum::RightToLeft,
                                 itk::DICOMOrientation::CoordinateEnum::SuperiorToInferior,
                                 itk::DICOMOrientation::CoordinateEnum::PosteriorToAnterior),
               itk::NiftiImageIOEnums::Analyze75Flavor::AnalyzeSPM) == EXIT_FAILURE ||
             itkNiftiAnalyzeContentsAndCoordinatesTest(
               argv,
           ...
           itk::DICOMOrientation(itk::DICOMOrientation::CoordinateEnum::PosteriorToAnterior,
                                 itk::DICOMOrientation::CoordinateEnum::InferiorToSuperior,
                                 itk::DICOMOrientation::CoordinateEnum::LeftToRight),
               itk::NiftiImageIOEnums::Analyze75Flavor::AnalyzeSPM) == EXIT_FAILURE ||
           ...
           itk::DICOMOrientation(itk::DICOMOrientation::CoordinateEnum::RightToLeft,
             ...
             itkNiftiAnalyzeContentsAndCoordinatesTest(
               argv,
               0,
           itk::DICOMOrientation(itk::DICOMOrientation::CoordinateEnum::LeftToRight,
                                 itk::DICOMOrientation::CoordinateEnum::PosteriorToAnterior,
                                 itk::DICOMOrientation::CoordinateEnum::InferiorToSuperior),
