...
TestBaseClassMethodsMeshIO(typename TMeshIO::Pointer meshIO)
{
  ...
  static constexpr FloatType floatValue{ 1.0 };
  ...
  static constexpr itk::SizeValueType length{ 5 };
  ...
  static constexpr itk::SizeValueType rows{ 2 };
  static constexpr itk::SizeValueType cols{ 2 };
  ...
  static constexpr itk::MeshIOBase::SizeValueType numberOfCellPixels{ 600 };
  ...
  static constexpr itk::MeshIOBase::SizeValueType cellBufferSize{ 1000 };
