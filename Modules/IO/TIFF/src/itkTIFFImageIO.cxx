...
TIFFImageIO::InternalWrite(const void * buffer)
{
  ...
  static constexpr SizeType oneKibiByte{ 1024 };
  static constexpr SizeType oneMebiByte{ 1024 * oneKibiByte };
  static constexpr SizeType oneGibiByte{ 1024 * oneMebiByte };
  static constexpr SizeType twoGibiBytes{ 2 * oneGibiByte };
