...
static constexpr uint32_t TIF_CZ_LSMINFO{ 34412 }; /* 0x866c, Type: TIF_BYTE, Length: 512 */
static constexpr uint32_t TIF_CZ_LSMINFO_SIZE_RESERVED{ 90 + 6 };
static constexpr uint32_t TIF_CZ_LSMINFO_SIZE{ 512 };
...
LSMImageIO::Write(const void * buffer)
{
  ...
  static constexpr float resolution{ -1 };
