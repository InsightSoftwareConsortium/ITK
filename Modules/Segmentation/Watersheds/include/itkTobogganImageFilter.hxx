...
void
TobogganImageFilter<TInputImage, TOutputImage>::GenerateInputRequestedRegion()
{
...
template <typename TInputImage, typename TOutputImage>
void
TobogganImageFilter<TInputImage, TOutputImage>::EnlargeOutputRequestedRegion(DataObject * data)
{
...
template <typename TInputImage, typename TOutputImage>
void
TobogganImageFilter<TInputImage, TOutputImage>::PrintSelf(std::ostream & os, Indent indent) const
{
...
TobogganImageFilter<TInputImage, TOutputImage>::GenerateData()
{
  ...
  static constexpr OutputImagePixelType z{};
