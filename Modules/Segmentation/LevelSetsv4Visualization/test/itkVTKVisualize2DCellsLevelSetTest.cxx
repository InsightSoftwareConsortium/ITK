...
visualizeLevelSet( TInputImage * inputImage, const int numberOfIterations, const char * )
{
  ...
  using VisualizationType = typename itk::VTKVisualizeImageLevelSetIsoValues< InputImageType, LevelSetType >;
...
int itkVTKVisualize2DCellsLevelSetTest( int argc, char* argv[] )
{
  if( argc < 5 )
    {
