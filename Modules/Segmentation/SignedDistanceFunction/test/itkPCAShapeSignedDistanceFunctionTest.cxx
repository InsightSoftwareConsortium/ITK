...
itkPCAShapeSignedDistanceFunctionTest(int, char *[])
{
  ...
  static constexpr unsigned int ImageWidth{ 3 };
  static constexpr unsigned int ImageHeight{ 2 };
  static constexpr unsigned int NumberOfPCs{ 3 };
  ...
  static constexpr ImageType::SizeType imageSize{ ImageWidth, ImageHeight };

  static constexpr ImageType::IndexType startIndex{};
