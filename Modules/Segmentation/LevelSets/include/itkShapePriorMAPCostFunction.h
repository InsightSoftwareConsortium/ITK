...
public:
  ...
  MeasureType ComputeLogInsideTerm(const ParametersType & parameters) const ITK_OVERRIDE;
   ...
   * the Gaussian. */
  MeasureType ComputeLogGradientTerm(const ParametersType & parameters) const ITK_OVERRIDE;
  ...
  MeasureType ComputeLogShapePriorTerm(const ParametersType & parameters) const ITK_OVERRIDE;
  ...
  MeasureType ComputeLogPosePriorTerm(const ParametersType & parameters) const ITK_OVERRIDE;
...
protected:
  ...
  ~ShapePriorMAPCostFunction() ITK_OVERRIDE {}
