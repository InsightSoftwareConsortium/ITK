...
itkVotingBinaryIterativeHoleFillingImageFilterTest(int, char *[])
{
  ...
  static constexpr ImageType::PixelType foreground{ 97 }; // prime numbers are good testers
  static constexpr ImageType::PixelType background{ 29 };
  ...
  static constexpr unsigned int maximumNumberOfIterations{ 10 };
  ...
  static constexpr unsigned int currentNumberOfIterations{ 0 };
