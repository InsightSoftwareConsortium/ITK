...
itkRelabelComponentImageFilterTest(int argc, char * argv[])
{
  ...
  static constexpr int      NumBins{ 13 };
  static constexpr RealType LowerBound{ 51.0 };
  static constexpr RealType UpperBound{ 252.0 };
  ...
  static constexpr itk::SizeValueType numberOfObjectsToPrint{ 5 };
  ...
  static constexpr bool sortByObjectSize{ true };
