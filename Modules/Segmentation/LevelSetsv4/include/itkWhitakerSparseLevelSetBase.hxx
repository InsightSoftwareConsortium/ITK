...
::WhitakerSparseLevelSetBase() : m_LabelMap( 0 )
{
  InitializeLayers();
...
// ----------------------------------------------------------------------------
template< typename TOutput, unsigned int VDimension >
typename WhitakerSparseLevelSetBase< TOutput, VDimension >::LayerIdType
WhitakerSparseLevelSetBase< TOutput, VDimension >
...
// ----------------------------------------------------------------------------
template< typename TOutput, unsigned int VDimension >
typename WhitakerSparseLevelSetBase< TOutput, VDimension >::OutputRealType
WhitakerSparseLevelSetBase< TOutput, VDimension >
...
WhitakerSparseLevelSetBase< TOutput, VDimension >::GetLayer( LayerIdType iVal ) const
{
...
WhitakerSparseLevelSetBase< TOutput, VDimension >::GetLayer( LayerIdType iVal )
{
