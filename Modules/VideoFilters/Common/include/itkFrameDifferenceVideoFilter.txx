...
void
FrameDifferenceVideoFilter<TInputVideoStream, TOutputVideoStream>::
SetFrameOffset(unsigned long numFrames)
{
                     ...
                     int threadId)
{
  ...
  unsigned long numFrames = this->TemporalProcessObject::m_UnitInputNumberOfFrames;
  ...
  unsigned long outputFrameNumber = outReqTempRegion.GetFrameStart();
