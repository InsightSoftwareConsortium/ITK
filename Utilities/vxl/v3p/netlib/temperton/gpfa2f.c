        ...
        integer *jump, integer *n, integer *mm, integer *lot, integer *isign)
{
    ...
    /* Local variables */
    integer ninc, left, nvex, j, k, l, m;
    real s;
    integer ipass, nblox;
    real c1;
    integer jstep;
    ...
    integer ja, jb, jc, jd, je, jf, jg, jh, ji, jj, jk, jl, jm, jn, jo, jp, la, nb, mh, kk, ll, mu, nu, laincl;
    real ss;
    integer jstepl;
    real co1, co2, co3;
    integer istart;
    real co4, co5, co6, co7;
    integer jstepx;
    real si1, si2, si3, si4, si5, si6, si7, aja, ajb, ajc, ajd, bja,
