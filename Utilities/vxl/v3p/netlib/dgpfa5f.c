...
/* Subroutine */ void dgpfa5f_(doublereal *a, doublereal *b, const doublereal *trigs, const integer *inc,
         const integer *jump, const integer *n, const integer *mm, const integer *lot, const integer *isign)
{
    ...
    static doublereal t1, t2, t3, t4, t5, t6, t7, t8, t9, u1, u2, u3, u4, u5, u6, u7, u8, u9;
    static integer ja, jb, jc, jd, je, jf, jg, jh, ji, jj, jk, jl, jm, jn, jo, jp, jq, jr, js, jt, ju, jv, jw, jx, jy;
    static doublereal t10, t11, u10, u11;
    static integer la, nb, mh, kk, ll, mu, nu, laincl;
    static doublereal ax, bx;
    static integer jstepl;
    static doublereal co1, co2, co3;
    static integer istart;
    static doublereal co4;
    static integer jstepx;
    static doublereal si1, si2, si3, si4, aja, ajb, ajc, ajd, aje, bjb, bje, bjc, bjd, bja, ajf, ajk, bjf, bjk, ajg, ajj, ajh;
    static integer jjj;
    static doublereal aji, ajl;
    static integer ink;
    static doublereal ajq, bjg, bjj, bjh, bji;
    static integer inq;
    static doublereal bjl, bjq, ajo, ajm, ajn, ajr, ajw, bjo, bjm, bjn, bjr,
            bjw, ajt, ajs, ajx, ajp, bjt, bjs, bjx, bjp, ajv, ajy, aju, bjv,
            bjy, bju;
