  ...
  doublereal *dtwd, doublereal *tri)
{
    ...
    extern /* Subroutine */ int parcon_(doublereal *, doublereal *, 
      doublereal *, doublereal *, doublereal *, doublereal *, 
      doublereal *, integer *);
    static doublereal rhoold, rhotmp;
...
TION \002,i5)";
 ...
 POINTS \002,\002AT ITERATION \002,i5)";
    ...
    /* Local variables */
    static integer i__, n, ip;
    static doublereal qtff;
    static integer imthd;
  ...
  *a, doublereal *u, doublereal *rhs)
{
    ...
    /* Local variables */
    static integer i__, n, ii, jj;
    static doublereal ui, sum, omm1;
    static integer npl1, jajj, ibgn, iend;
  ...
  *ja, doublereal *a, doublereal *ur, doublereal *vb)
{
    ...
    /* Local variables */
    static integer i__, j, nb, nr, jaj, inr;
  ...
  integer *error)
{
    ...
    static integer i__, j, k, n, v, jm1, ip1, top;
    static logical done;
   ...
   doublereal *a, integer *iwork)
{
    ...
    /* Local variables */
    static integer i__, l, jaj;
    static doublereal val;
    static integer top, ideg, link, next, hlink, mhlink, ohlink, nulink, 
      maxtop;
...
\002)";
    ...
    static doublereal val;
    static integer npl1, link;
    static doublereal temp;
    static integer next, nout, level;
...
*******\002/\0020\002,\002    IN ITPACK ROUTINE SCAL    \002/\002 \002,\002 \
   NO DIAGONAL ENTRY IN ROW\002,i10)";
    ...
    static doublereal di;
    static integer ii, jj, im1, np1, jadd, jajj, ibgn, iend, jjpi;
