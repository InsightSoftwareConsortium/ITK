...
def upload_to_azure(
    content_link, externaldata_object_store, blob_service, current_blobs
):
...
if __name__ == "__main__":
    ...
    parser.add_argument("itk_source_dir", help="Path to the ITK source tree.")
    parser.add_argument(
        "externaldata_object_store",
    ...
    run(
        args.itk_source_dir,
        args.externaldata_object_store,
