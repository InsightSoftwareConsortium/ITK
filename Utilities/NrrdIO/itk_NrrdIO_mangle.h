...
#define airTime itk__airTime
#define _biffMsgNoop itk___biffMsgNoop
#define biffMsgAdd itk__biffMsgAdd
#define biffMsgAddVL itk__biffMsgAddVL
#define biffMsgAddf itk__biffMsgAddf
#define biffMsgClear itk__biffMsgClear
#define biffMsgLineLenMax itk__biffMsgLineLenMax
#define biffMsgMove itk__biffMsgMove
#define biffMsgMoveVL itk__biffMsgMoveVL
#define biffMsgMovef itk__biffMsgMovef
#define biffMsgNew itk__biffMsgNew
#define biffMsgNix itk__biffMsgNix
#define biffMsgNoop itk__biffMsgNoop
#define biffMsgStrAlloc itk__biffMsgStrAlloc
#define biffMsgStrGet itk__biffMsgStrGet
#define biffMsgStrSet itk__biffMsgStrSet
#define biffMsgStrlen itk__biffMsgStrlen
#define _nrrdInsertUICH itk___nrrdInsertUICH
#define _nrrdInsertUIDB itk___nrrdInsertUIDB
#define _nrrdInsertUIFL itk___nrrdInsertUIFL
#define _nrrdInsertUIJN itk___nrrdInsertUIJN
#define _nrrdInsertUILL itk___nrrdInsertUILL
#define _nrrdInsertUISH itk___nrrdInsertUISH
#define _nrrdInsertUIUC itk___nrrdInsertUIUC
#define _nrrdInsertUIUI itk___nrrdInsertUIUI
#define _nrrdInsertUIUL itk___nrrdInsertUIUL
#define _nrrdInsertUIUS itk___nrrdInsertUIUS
#define _nrrdLoadUICH itk___nrrdLoadUICH
#define _nrrdLoadUIDB itk___nrrdLoadUIDB
#define _nrrdLoadUIFL itk___nrrdLoadUIFL
#define _nrrdLoadUIJN itk___nrrdLoadUIJN
#define _nrrdLoadUILL itk___nrrdLoadUILL
#define _nrrdLoadUISH itk___nrrdLoadUISH
#define _nrrdLoadUIUC itk___nrrdLoadUIUC
#define _nrrdLoadUIUI itk___nrrdLoadUIUI
#define _nrrdLoadUIUL itk___nrrdLoadUIUL
#define _nrrdLoadUIUS itk___nrrdLoadUIUS
#define _nrrdLookupUICH itk___nrrdLookupUICH
#define _nrrdLookupUIDB itk___nrrdLookupUIDB
#define _nrrdLookupUIFL itk___nrrdLookupUIFL
#define _nrrdLookupUIJN itk___nrrdLookupUIJN
#define _nrrdLookupUILL itk___nrrdLookupUILL
#define _nrrdLookupUISH itk___nrrdLookupUISH
#define _nrrdLookupUIUC itk___nrrdLookupUIUC
#define _nrrdLookupUIUI itk___nrrdLookupUIUI
#define _nrrdLookupUIUL itk___nrrdLookupUIUL
#define _nrrdLookupUIUS itk___nrrdLookupUIUS
#define _nrrdStoreUICH itk___nrrdStoreUICH
#define _nrrdStoreUIDB itk___nrrdStoreUIDB
#define _nrrdStoreUIFL itk___nrrdStoreUIFL
#define _nrrdStoreUIJN itk___nrrdStoreUIJN
#define _nrrdStoreUILL itk___nrrdStoreUILL
#define _nrrdStoreUISH itk___nrrdStoreUISH
#define _nrrdStoreUIUC itk___nrrdStoreUIUC
#define _nrrdStoreUIUI itk___nrrdStoreUIUI
#define _nrrdStoreUIUL itk___nrrdStoreUIUL
#define _nrrdStoreUIUS itk___nrrdStoreUIUS
#define nrrdFprint itk__nrrdFprint
#define nrrdMinMaxExactFind itk__nrrdMinMaxExactFind
#define nrrdUIInsert itk__nrrdUIInsert
#define nrrdUILoad itk__nrrdUILoad
#define nrrdUILookup itk__nrrdUILookup
#define nrrdUIStore itk__nrrdUIStore
#define nrrdValCompare itk__nrrdValCompare
#define nrrdValCompareInv itk__nrrdValCompareInv
#define nrrdDefaultCenter itk__nrrdDefaultCenter
#define nrrdDefaultGetenv itk__nrrdDefaultGetenv
#define nrrdDefaultKernelParm0 itk__nrrdDefaultKernelParm0
#define nrrdDefaultResampleBoundary itk__nrrdDefaultResampleBoundary
#define nrrdDefaultResampleCheap itk__nrrdDefaultResampleCheap
#define nrrdDefaultResampleClamp itk__nrrdDefaultResampleClamp
#define nrrdDefaultResamplePadValue itk__nrrdDefaultResamplePadValue
#define nrrdDefaultResampleRenormalize itk__nrrdDefaultResampleRenormalize
#define nrrdDefaultResampleRound itk__nrrdDefaultResampleRound
#define nrrdDefaultResampleType itk__nrrdDefaultResampleType
#define nrrdDefaultSpacing itk__nrrdDefaultSpacing
#define nrrdDefaultWriteBareText itk__nrrdDefaultWriteBareText
#define nrrdDefaultWriteCharsPerLine itk__nrrdDefaultWriteCharsPerLine
#define nrrdDefaultWriteEncodingType itk__nrrdDefaultWriteEncodingType
#define nrrdDefaultWriteValsPerLine itk__nrrdDefaultWriteValsPerLine
#define nrrdEnvVarDefaultCenter itk__nrrdEnvVarDefaultCenter
#define nrrdEnvVarDefaultCenterOld itk__nrrdEnvVarDefaultCenterOld
#define nrrdEnvVarDefaultKernelParm0 itk__nrrdEnvVarDefaultKernelParm0
#define nrrdEnvVarDefaultSpacing itk__nrrdEnvVarDefaultSpacing
#define nrrdEnvVarDefaultWriteBareText itk__nrrdEnvVarDefaultWriteBareText
#define nrrdEnvVarDefaultWriteBareTextOld itk__nrrdEnvVarDefaultWriteBareTextOld
#define nrrdEnvVarDefaultWriteCharsPerLine itk__nrrdEnvVarDefaultWriteCharsPerLine
#define nrrdEnvVarDefaultWriteEncodingType itk__nrrdEnvVarDefaultWriteEncodingType
#define nrrdEnvVarDefaultWriteValsPerLine itk__nrrdEnvVarDefaultWriteValsPerLine
#define nrrdEnvVarStateAlwaysSetContent itk__nrrdEnvVarStateAlwaysSetContent
#define nrrdEnvVarStateBlind8BitRange itk__nrrdEnvVarStateBlind8BitRange
#define nrrdEnvVarStateDisableContent itk__nrrdEnvVarStateDisableContent
#define nrrdEnvVarStateGrayscaleImage3D itk__nrrdEnvVarStateGrayscaleImage3D
#define nrrdEnvVarStateKeyValuePairsPropagate itk__nrrdEnvVarStateKeyValuePairsPropagate
#define nrrdEnvVarStateKindNoop itk__nrrdEnvVarStateKindNoop
#define nrrdEnvVarStateMeasureHistoType itk__nrrdEnvVarStateMeasureHistoType
#define nrrdEnvVarStateMeasureModeBins itk__nrrdEnvVarStateMeasureModeBins
#define nrrdEnvVarStateMeasureType itk__nrrdEnvVarStateMeasureType
#define nrrdEnvVarStateVerboseIO itk__nrrdEnvVarStateVerboseIO
#define nrrdGetenvBool itk__nrrdGetenvBool
#define nrrdGetenvDouble itk__nrrdGetenvDouble
#define nrrdGetenvEnum itk__nrrdGetenvEnum
#define nrrdGetenvInt itk__nrrdGetenvInt
#define nrrdGetenvUInt itk__nrrdGetenvUInt
#define nrrdStateBlind8BitRange itk__nrrdStateBlind8BitRange
#define nrrdStateDisallowIntegerNonExist itk__nrrdStateDisallowIntegerNonExist
#define nrrdStateGetenv itk__nrrdStateGetenv
#define nrrdStateKeyValuePairsPropagate itk__nrrdStateKeyValuePairsPropagate
#define nrrdStateMeasureHistoType itk__nrrdStateMeasureHistoType
#define nrrdStateMeasureModeBins itk__nrrdStateMeasureModeBins
#define nrrdStateMeasureType itk__nrrdStateMeasureType
#define nrrdAlloc_va itk__nrrdAlloc_va
#define nrrdMaybeAlloc_va itk__nrrdMaybeAlloc_va
#define nrrdWrap_va itk__nrrdWrap_va
#define nrrdAxesDelete itk__nrrdAxesDelete
#define nrrdAxesMerge itk__nrrdAxesMerge
#define nrrdAxesSplit itk__nrrdAxesSplit
#define nrrdAxesSwap itk__nrrdAxesSwap
#define nrrdBlock itk__nrrdBlock
#define nrrdFlip itk__nrrdFlip
#define nrrdJoin itk__nrrdJoin
#define nrrdReshape_nva itk__nrrdReshape_nva
#define nrrdReshape_va itk__nrrdReshape_va
#define nrrdTile2D itk__nrrdTile2D
#define nrrdUnblock itk__nrrdUnblock
#define nrrdUntile2D itk__nrrdUntile2D
#define _nrrdSpaceVecExists itk___nrrdSpaceVecExists
#define nrrdAxisInfoGet_va itk__nrrdAxisInfoGet_va
#define nrrdAxisInfoSet_va itk__nrrdAxisInfoSet_va
#define nrrdNonSpatialAxesGet itk__nrrdNonSpatialAxesGet
#define nrrdOrientationReduce itk__nrrdOrientationReduce
#define nrrdSpatialAxesGet itk__nrrdSpatialAxesGet
#define _nrrdContentSet_va itk___nrrdContentSet_va
#define nrrdContentSet_va itk__nrrdContentSet_va
#define nrrdSpaceVecCopy itk__nrrdSpaceVecCopy
#define nrrdSpaceVecNorm itk__nrrdSpaceVecNorm
#define nrrdSpaceVecScale itk__nrrdSpaceVecScale
#define nrrdSpaceVecScaleAdd2 itk__nrrdSpaceVecScaleAdd2
#define nrrdSpaceVecSetNaN itk__nrrdSpaceVecSetNaN
#define _nrrdKeyValueWrite itk___nrrdKeyValueWrite
#define _nrrdWriteEscaped itk___nrrdWriteEscaped
#define _nrrdContainsPercentThisAndMore itk___nrrdContainsPercentThisAndMore
#define _nrrdHeaderStringOneLine itk___nrrdHeaderStringOneLine
#define _nrrdHeaderStringOneLineStrlen itk___nrrdHeaderStringOneLineStrlen
#define _nrrdLineSep itk___nrrdLineSep
#define _nrrdRead itk___nrrdRead
#define nrrdLoadMulti itk__nrrdLoadMulti
#define nrrdStringRead itk__nrrdStringRead
#define _nrrdWrite itk___nrrdWrite
#define nrrdSaveMulti itk__nrrdSaveMulti
#define nrrdStringWrite itk__nrrdStringWrite
#define nrrdSample_nva itk__nrrdSample_nva
#define nrrdSample_va itk__nrrdSample_va
#define nrrdSimpleCrop itk__nrrdSimpleCrop
#define _nrrdKeyValueWrite itk___nrrdKeyValueWrite
#define _nrrdWriteEscaped itk___nrrdWriteEscaped
