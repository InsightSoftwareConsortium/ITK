...
nifti_image * generate_reference_image()
{
...
int main (int argc, char *argv[])
{
  if(0)
    {//Simple Read Test
    const char test_image_filename[]="test.nii";
    nifti_image * const read_image_test = nifti_image_read(test_image_filename,0);
    nifti_image_infodump(read_image_test);
    }
  {
