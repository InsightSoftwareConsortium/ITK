...
set(
  DOXYGEN_LAYOUT_FILE
  "${ITK_SOURCE_DIR}/Documentation/Doxygen/DoxygenLayout.xml"
)
...
set(
  DOXYGEN_IMAGE_PATH
  "${ITK_SOURCE_DIR}/Documentation/Art"
...
set(
  DOXYGEN_HTML_HEADER
  "${ITK_SOURCE_DIR}/Documentation/Doxygen/DoxygenHeader.html"
)
set(
  DOXYGEN_HTML_FOOTER
  "${ITK_SOURCE_DIR}/Documentation/Doxygen/DoxygenFooter.html"
)
set(
  DOXYGEN_HTML_EXTRA_FILES
  "${ITK_SOURCE_DIR}/Utilities/Doxygen/serviceWorker.js"
...
set(
  ...
  "itkOverrideGetNameOfClassMacro(thisClass)=                   virtual const char *GetNameOfClass() const\;"
...
set(
  ...
  "${ITK_BINARY_DIR}/Utilities/Doxygen/InsightDoxygen.tag"
)
