...
if(MSVC AND ${CMAKE_MINIMUM_REQUIRED_VERSION} LESS 3.16.3)
  message(
    STATUS
    "cmake_minimum_required of ${CMAKE_MINIMUM_REQUIRED_VERSION} is not enough."
  )
...
if(SKBUILD)
  set(
    ...
    CACHE PATH
    "The install prefix for python package contents"
  )
  install(
    CODE
      "
...
if(NOT ITK_INSTALL_INCLUDE_DIR)
  set(
    ...
    include/ITK-${ITK_VERSION_MAJOR}.${ITK_VERSION_MINOR}
  )
endif()
...
if(NOT ITK_INSTALL_DOC_DIR)
  set(
    ITK_INSTALL_DOC_DIR
    share/doc/ITK-${ITK_VERSION_MAJOR}.${ITK_VERSION_MINOR}
  )
endif()
...
set(
  ${itk-module}-targets-build-directory
  "${ITK_DIR}/${ITK_INSTALL_PACKAGE_DIR}/Modules/Targets"
)
file(MAKE_DIRECTORY ${${itk-module}-targets-build-directory})
set(
  ${itk-module}-targets-build
  "${${itk-module}-targets-build-directory}/${itk-module}Targets.cmake"
)
