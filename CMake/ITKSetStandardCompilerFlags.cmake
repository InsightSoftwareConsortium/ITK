...
function(
  check_compiler_optimization_flags
  c_optimization_flags_var
  cxx_optimization_flags_var
)
  ...
  if(CMAKE_COMPILER_IS_GNUCXX)
    if(APPLE)
      option(
        ...
        "Turn on warnings on 64bits to 32bits truncations."
        OFF
      )
      ...
      foreach(listname ${compile_flag_lists})
        if("${${listname}}" MATCHES ".*-fopenmp.*")
          ...
          message(
            "-fopenmp causes incorrect compilation of HDF, removing from ${listname}"
          )
        endif()
      endforeach()
    endif()
    ...
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL "12")
      set(
        ...
        "${ITK_REQUIRED_CXX_FLAGS} -fno-sized-deallocation"
      )
    endif()
