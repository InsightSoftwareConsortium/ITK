...
#  pragma warning( \
    disable : 4251) // 'identifier' : class 'type' needs to have dll-interface to be used by clients of class 'type2'
#  pragma warning(disable : 4275) // non dll-interface class 'type' used as base for dll-interface class 'type2'
#  pragma warning( \
    disable : 4290) // C++ exception specification ignored except to indicate a function is not __declspec(nothrow)
#  pragma warning(disable : 4273) // 'type' : inconsistent dll linkage.  dllexport assumed.
#  pragma warning(disable : 4127) // conditional expression is constant
#  pragma warning(disable : 4505) // unreferenced local function has been removed
#  pragma warning( \
    disable : 4786) // 'identifier' : identifier was truncated to 'number' characters in the debug information
