// This is core/vnl/io/vnl_io_vector.hxx
#ifndef vnl_io_vector_hxx_
#define vnl_io_vector_hxx_
//:
// \file
...
template <class T>
void
vsl_b_write(vsl_b_ostream & os, const vnl_vector<T> & p)
{
...
template <class T>
void
vsl_b_read(vsl_b_istream & is, vnl_vector<T> & p)
{
  if (!is)
    return;
  ...
  switch (ver)
  {
    ...
    default:
      std::cerr << "I/O ERROR: vsl_b_read(vsl_b_istream&, vnl_vector<T>&)\n"
...
template <class T>
void
vsl_print_summary(std::ostream & os, const vnl_vector<T> & p)
{
  os << "Len: " << p.size() << " (";
