...
void
vsl_b_write(vsl_b_ostream & os, const vnl_real_npolynomial & v);

//: Binary load vnl_real_polynomial from stream.
//  \relatesalso vnl_real_npolynomial
void
vsl_b_read(vsl_b_istream & is, vnl_real_npolynomial & v);

//: Print human readable summary of object to a stream
//  \relatesalso vnl_real_npolynomial
void
vsl_print_summary(std::ostream & os, const vnl_real_npolynomial & b);
