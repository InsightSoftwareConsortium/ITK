...
template <class T>
vnl_vector<T>::vnl_vector(size_t len, const T & value)
{
  vnl_vector_alloc_blah(len);
...
template <class T>
vnl_vector<T>::vnl_vector(size_t len, size_t n, const T values[])
{
  vnl_vector_alloc_blah(len);
...
template <class T>
vnl_vector<T>::vnl_vector(const vnl_vector<T> & v)
{
...
template <class T>
vnl_vector<T>::vnl_vector(const T * datablck, size_t len)
{
  vnl_vector_alloc_blah(len);
...
template <class T>
bool
vnl_vector<T>::set_size(size_t n)
{
  if (this->data)
  {
...
template <class T>
vnl_vector<T>
vnl_vector<T>::read(std::istream & s)
{
  vnl_vector<T> V;
  V.read_ascii(s);
  return V;
...
template <class T>
vnl_vector<T> &
vnl_vector<T>::fill(const T & value)
{
  if (this->data) // VS2012 Runtime Library's std::fill_n has debug assertion when data is null
  {
...
template <class T>
vnl_vector<T> &
vnl_vector<T>::copy_in(const T * ptr)
{
...
template <class T>
void
vnl_vector<T>::copy_out(T * ptr) const
{
...
template <class T>
vnl_vector<T> &
vnl_vector<T>::operator=(const vnl_vector<T> & rhs)
{
  if (this != &rhs)
  { // make sure *this != m
    if (rhs.data)
...
template <class T>
vnl_vector<T> &
vnl_vector<T>::pre_multiply(const vnl_matrix<T> & m)
{
#ifndef NDEBUG
...
template <class T>
vnl_vector<T> &
vnl_vector<T>::post_multiply(const vnl_matrix<T> & m)
{
#ifndef NDEBUG
...
template <class T>
vnl_vector<typename vnl_numeric_traits<T>::signed_t>
...
template <class T>
vnl_vector<T>
element_product(const vnl_vector<T> & v1, const vnl_vector<T> & v2)
{
#ifndef NDEBUG
  if (v1.size() != v2.size())
...
template <class T>
vnl_vector<T>
element_quotient(const vnl_vector<T> & v1, const vnl_vector<T> & v2)
{
#ifndef NDEBUG
  if (v1.size() != v2.size())
...
template <class T>
vnl_vector<T>
vnl_vector<T>::apply(T (*f)(const T &)) const
{
...
template <class T>
T
dot_product(const vnl_vector<T> & v1, const vnl_vector<T> & v2)
{
#ifndef NDEBUG
  if (v1.size() != v2.size())
    vnl_error_vector_dimension("dot_product", v1.size(), v2.size());
#endif
  return vnl_c_vector<T>::dot_product(v1.begin(), v2.begin(), v1.size());
}
...
template <class T>
T
inner_product(const vnl_vector<T> & v1, const vnl_vector<T> & v2)
{
#ifndef NDEBUG
  if (v1.size() != v2.size())
    vnl_error_vector_dimension("inner_product", v1.size(), v2.size());
#endif
  return vnl_c_vector<T>::inner_product(v1.begin(), v2.begin(), v1.size());
}
...
template <class T>
T
bracket(const vnl_vector<T> & u, const vnl_matrix<T> & A, const vnl_vector<T> & v)
{
#ifndef NDEBUG
  if (u.size() != A.rows())
...
template <class T>
vnl_matrix<T>
outer_product(const vnl_vector<T> & v1, const vnl_vector<T> & v2)
{
...
template <class T>
void
vnl_vector<T>::swap(vnl_vector<T> & that) noexcept
{
...
template <class T>
void
vnl_vector<T>::assert_finite_internal() const
{
  if (this->is_finite())
    return;
...
template <class T>
void
vnl_vector<T>::assert_size_internal(size_t sz) const
{
  if (this->size() != sz)
  {
...
template <class T>
bool
vnl_vector<T>::is_equal(const vnl_vector<T> & rhs, double tol) const
{
...
template <class T>
bool
vnl_vector<T>::operator_eq(const vnl_vector<T> & rhs) const
{
  if (this == &rhs) // same object => equal.
    return true;
...
template <class T>
std::ostream &
operator<<(std::ostream & s, const vnl_vector<T> & v)
{
...
template <class T>
std::istream &
operator>>(std::istream & s, vnl_vector<T> & M)
{
  M.read_ascii(s);
  return s;
}
