...
build_tree(std::string const & expr, unsigned long s, int l)
{
  ...
  //  (() operator ())
  if (expr[s] == ')')
    ErrorExit(expr, "string begins with closing bracket", s);
  while (l > 0 && expr[s] == '(' && blocklength(expr, s, l) == l)
    ++s, l -= 2;
  if (l <= 0)
  ...
  { // function
    ...
    ++j;
    if (j >= l)
      ErrorExit(expr, "missing parameter list for function", s);
    else if (expr.substr(s, j) == "abs(")
      n.func1 = &vnl_math::abs, n.func2 = nullptr, n.func3 = nullptr;
    else if (expr.substr(s, j) == "floor(")
      n.func1 = &floor, n.func2 = nullptr, n.func3 = nullptr;
    else if (expr.substr(s, j) == "ceil(")
      n.func1 = &ceil, n.func2 = nullptr, n.func3 = nullptr;
    else if (expr.substr(s, j) == "round(")
      n.func1 = &round, n.func2 = nullptr, n.func3 = nullptr;
    else if (expr.substr(s, j) == "min(")
      n.func1 = nullptr, n.func2 = &min, n.func3 = nullptr;
    else if (expr.substr(s, j) == "max(")
      n.func1 = nullptr, n.func2 = &max, n.func3 = nullptr;
    else if (expr.substr(s, j) == "binom(")
      n.func1 = nullptr, n.func2 = &binom, n.func3 = nullptr;
    else if (expr.substr(s, j) == "pow(")
      n.func1 = nullptr, n.func2 = nullptr, n.func3 = &pow;
    else
    ...
    if (n.func2)
    {
      n.param2 = new node();
      if (i > l - 2)
        ErrorExit(expr, "function needs two arguments", s);
    }
    *(node *)(n.param1) = build_tree(expr, s + j, i - j);
    j = i + 1;
    if (n.param2 == nullptr)
    {
      if (j < l)
        ErrorExit(expr, "function needs only one argument", s);
      return n;
    }
    for (i = j; i < l - 1; ++i)
      if (expr[s + i] == ',')
        break;
    if (i < l - 1)
      ErrorExit(expr, "function needs only two arguments", s);
  ...
  if (expr[s + j] == '*')
    n.func1 = nullptr, n.func2 = &prod, n.func3 = nullptr;
  else if (expr[s + j] == '/')
    n.func1 = nullptr, n.func2 = &quot, n.func3 = nullptr;
  else if (expr[s + j] == '%')
    n.func1 = nullptr, n.func2 = &modulo, n.func3 = nullptr;
  else if (expr[s + j] == '+')
    n.func1 = nullptr, n.func2 = &sum, n.func3 = nullptr;
  else if (expr[s + j] == '-')
    n.func1 = nullptr, n.func2 = &diff, n.func3 = nullptr;
  else
    ErrorExit(expr, "unknown operator", s + j);
  return n;
}
...
calc(node * n)
{
  ...
  else if (!n->func1 && !n->func2 && !n->func3)
    return *(vnl_decnum *)(n->param1);
  else if (n->func3 && n->param1 && n->param2)
    return n->func3(calc((node *)n->param1), (unsigned long)calc((node *)n->param2));
  else if (n->param1 && n->param2)
    return n->func2(calc((node *)n->param1), calc((node *)n->param2));
  else if (n->param1 && n->func1)
    return n->func1(calc((node *)n->param1));
  else if (n->param2 && n->func1)
