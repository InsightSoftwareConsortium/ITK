...
template <class I>
inline void
vnl_sample_uniform(I begin, I end, double a, double b)
{
...
template <class I>
inline void
vnl_sample_normal(I begin, I end, double mean, double sigma)
{
  for (I p = begin; p != end; ++p)
...
template <class I>
inline void
vnl_sample_binomial(I begin, I end, int n, double q)
{
  for (I p = begin; p != end; ++p)
...
template <class I>
inline void
vnl_sample_bernoulli(I begin, I end, double q)
{
  for (I p = begin; p != end; ++p)
...
inline void
vnl_sample_uniform(I begin, I end, double a, double b, T /*dummy*/)
{
  for (I p = begin; p != end; ++p)
...
template <class I, class T>
inline void
vnl_sample_normal(I begin, I end, double mean, double sigma, T /*dummy*/)
{
  for (I p = begin; p != end; ++p)
