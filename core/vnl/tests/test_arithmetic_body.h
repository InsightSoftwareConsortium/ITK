...
TEST("3x2 matrix construction",
     m1.rows() == 3 && m1.cols() == 2 && m1(0, 0) == 1 && m1(0, 1) == 2 && m1(1, 0) == 3 && m1(1, 1) == 4 &&
       m1(2, 0) == 5 && m1(2, 1) == 6,
     true);

NewMat(m3, 2, 3, m3_data);
TEST("2x3 matrix construction",
     m3.rows() == 2 && m3.cols() == 3 && m3(0, 0) == 3 && m3(0, 1) == 4 && m3(0, 2) == 5 && m3(1, 0) == 6 &&
       m3(1, 1) == 7 && m3(1, 2) == 8,
     true);

NewVec(v1, 2, v1_data);
TEST("2 vector construction", v1.size() == 2 && v1[0] == 3 && v1[1] == 2, true);

NewVec(v3, 3, v3_data);
TEST("3 vector construction", v3.size() == 3 && v3[0] == 1 && v3[1] == 2 && v3[2] == 3, true);
