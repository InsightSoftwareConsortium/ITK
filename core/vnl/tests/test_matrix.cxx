...
template <typename T>
T
sum_vector(const vnl_vector<T> & v)
{
  return v.sum();
}
...
test_int()
{
...

  {
    ...
    TEST("v = mrc.get_row(1)", (v = mrc.get_row(1), (v.get(0) == 4 && v.get(1) == 5 && v.get(2) == 6)), true);

    TEST("v = mrc.get_column(0)", (v = mrc.get_column(0), (v.get(0) == 1 && v.get(1) == 4)), true);
    TEST("v = mrc.get_column(1)", (v = mrc.get_column(1), (v.get(0) == 2 && v.get(1) == 5)), true);
    TEST("v = mrc.get_column(2)", (v = mrc.get_column(2), (v.get(0) == 3 && v.get(1) == 6)), true);
    ...
    TEST("mi = mrc.get_rows(indices)",
         (mi = mrc.get_rows(indices),
          (mi.get_row(0) == mrc.get_row(1) && mi.get_row(1) == mrc.get_row(0) && mi.get_row(2) == mrc.get_row(1))),
         true);
  ...
  TEST("m4=m3*5", ((m4 = m3 * 5), (m4.get(0, 0) == 5 && m4.get(0, 1) == 10 && m4.get(0, 2) == 15)), true);
  TEST("m4=5*m3", ((m4 = 5 * m3), (m4.get(0, 0) == 5 && m4.get(0, 1) == 10 && m4.get(0, 2) == 15)), true);
  TEST("m3*=5", ((m3 *= 5), (m3 == m4)), true);
  TEST("m4=m3/5", ((m4 = m3 / 5), (m4.get(0, 0) == 1 && m4.get(0, 1) == 2 && m4.get(0, 2) == 3)), true);
  TEST("m3/=5", ((m3 /= 5), (m3 == m4)), true);
  ...
  TEST("r1=r0*m6",
       ((r1 = r0 * m6),
        r1.rows() == r0.rows() && r1.columns() == r0.columns() && r1.get(0, 0) == 19 && r1.get(0, 1) == 22),
       true);
  TEST("r0*=m6", ((r0 *= m6), r0 == r1), true);
  TEST("m6*=c0", ((m6 *= c0), c1 == m6), true);
  ...
  TEST("m.extract(1,1,1,1)",
       ((m1 = m.extract(1, 1, 1, 1)), (m1.rows() == 1 && m1.columns() == 1 && m1(0, 0) == m(1, 1))),
       true);
  TEST("m.update([4],1,1)",
       ((m1 = 4), (m.update(m1, 1, 1)), (m(0, 0) == 0 && m(0, 1) == -2 && m(1, 0) == 2 && m(1, 1) == 4)),
       true);
...
test_float()
{
  ...
  TEST("vnl_matrix<float> d2(2,2,2.f)",
       ...
       true);
  TEST("d0=2.f",
       (d0 = 2.f, (d0.get(0, 0) == 2.f && d0.get(0, 1) == 2.f && d0.get(1, 0) == 2.f && d0.get(1, 1) == 2.f)),
       true);
  ...
  TEST("(d0 == d2)", (d0 == d2), false);
  TEST("d1.fill(3.f)",
       (d1.fill(3.f), (d1.get(0, 0) == 3.f && d1.get(1, 1) == 3.f && d1.get(2, 2) == 3.f && d1.get(2, 3) == 3.f)),
       true);
  TEST("d2.fill(2.f)",
...
#ifdef LEAK
static void
test_leak() // use top4.1 to watch memory usage.
{
  for (;;)
