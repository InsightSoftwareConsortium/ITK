...
test_hungarian_algorithm_1()
{
  ...
  TEST("assignment vector",
       assignment[0] == 0 && assignment[1] == 1 && assignment[2] == 2 && assignment[3] == 3 && assignment[4] == 4 &&
         assignment[5] == 5,
       true);
  ...
  TEST("assignment matrix",
       ass[0][0] == 0 && ass[0][2] == 1 && ass[1][1] == 1 && ass[2][0] == 1 && ass[3][4] == 1 && ass[4][3] == 1 &&
         ass[5][5] == 1,
       true);
  ...
  TEST("assignment vector",
       assignment2[0] == 2 && assignment2[1] == 1 && assignment2[2] == 0 && assignment2[3] == 4 &&
         assignment2[4] == 3 && assignment2[5] == 5,
       true);
...
check_solution(std::vector<unsigned> const & assign, unsigned const * solution, unsigned const N)
{
  ...
  for (unsigned i = 0; i < N; ++i)
  {
    ...
    {
      std::cout << "    " << i << " -> " << assign[i] << " (expected " << solution[i] << ")\n";
...
test_hungarian_algorithm_2()
{
...

  {
    ...
    std::vector<unsigned> assign = vnl_hungarian_algorithm<double>(cost);
    TEST("Test 4x4 cost matrix",
         assign.size() == 4 && assign[0] == 1 && assign[1] == 0 && assign[2] == 2 && assign[3] == 3,
         true);
  }
