...
{
  if (n <= 1)
    return vnl_decnum(1L);
  else
    return factorial(n - 1) * vnl_decnum(n);
}

// Combinations (n choose k)
static vnl_decnum
binom(unsigned long n, unsigned long k)
{
  vnl_decnum r(1L);
  if (k >= n || k == 0)
    return r;
...
run_large_division_tests()
{
  ...
  TEST("100 choose 44 = 49378235797073715747364762200", binom(100, 44), "49378235797073715747364762200");
}
...
run_addition_subtraction_tests()
{
  ...
  TEST("-b1000000 + b0 == -b1000000", -b1000000 + b0, -b1000000);
  TEST(
    "-b1000000 + (-b1000000) == (vnl_decnum(2L)*(-b1000000))", -b1000000 + (-b1000000), (vnl_decnum(2L) * (-b1000000)));
  TEST("-b1000000000000 + (-b1000000000000) == (vnl_decnum(2L)*(-b1000000000000))",
       -b1000000000000 + (-b1000000000000),
       (vnl_decnum(2L) * (-b1000000000000)));
  ...
  TEST("zillion + b1000000 == b1000000000000*b1000000000000*b1000000000000 + b1000000",
       zillion + b1000000,
       b1000000000000 * b1000000000000 * b1000000000000 + b1000000);
  ...
  TEST("-b1000000 - (-zillion) == zillion - b1000000", -b1000000 - (-zillion), zillion - b1000000);
  TEST("-b1000000000000 - (-b1000000000000) == b0", -b1000000000000 - (-b1000000000000), b0);
  TEST("-b1000000000000 - (b1000000000000) == -vnl_decnum(2L)*b1000000000000",
       -b1000000000000 - (b1000000000000),
       -vnl_decnum(2L) * b1000000000000);
  TEST("b1000000000000 - (-b1000000000000) == vnl_decnum(2L)*b1000000000000",
       b1000000000000 - (-b1000000000000),
       vnl_decnum(2L) * b1000000000000);
  TEST("zillion - (-zillion) == vnl_decnum(2L)*zillion", zillion - (-zillion), vnl_decnum(2L) * zillion);
  TEST("zillion - b1000000 == b1000000000000*b1000000000000*b1000000000000 - b1000000",
       zillion - b1000000,
       b1000000000000 * b1000000000000 * b1000000000000 - b1000000);
  TEST("-zillion - b1000000 == -b1000000000000*b1000000000000*b1000000000000 - b1000000",
