...
public:
  ...
  explicit vnl_vector_fixed_ref_const(const T * dataptr)
    : data_(dataptr)
  {}
  ...
  as_ref()
  {
    return vnl_vector_ref<T>(n, const_cast<T *>(data_block()));
  }
  ...
  as_vector() const
  {
    return vnl_vector<T>(const_cast<T *>(data_block()), n);
  }
...
#  endif
  ...
  {
    return vnl_c_vector<T>::two_nrm2(begin(), n);
  }
  ...
  one_norm() const
  {
    return vnl_c_vector<T>::one_norm(begin(), n);
  }
  ...
  two_norm() const
  {
    return vnl_c_vector<T>::two_norm(begin(), n);
  }
  ...
  inf_norm() const
  {
    return vnl_c_vector<T>::inf_norm(begin(), n);
  }
  ...
  rms() const
  {
    return vnl_c_vector<T>::rms_norm(begin(), n);
  }
  ...
  min_value() const
  {
    return vnl_c_vector<T>::min_value(begin(), n);
  }
  ...
  max_value() const
  {
    return vnl_c_vector<T>::max_value(begin(), n);
  }
  ...
  arg_min() const
  {
    return vnl_c_vector<T>::arg_min(begin(), n);
  }
  ...
  arg_max() const
  {
    return vnl_c_vector<T>::arg_max(begin(), n);
  }
  ...
  mean() const
  {
    return vnl_c_vector<T>::mean(begin(), n);
  }
  ...
  sum() const
  {
    return vnl_c_vector<T>::sum(begin(), n);
  }
  ...
  bool
  operator_eq(const vnl_vector_fixed_ref_const<T, n> & v) const
  {
    for (size_type i = 0; i < n; ++i)
      if ((*this)[i] != v[i])
        return false;
...
public:
  ...
  //: Equality operator
  bool
  operator==(const vnl_vector_fixed_ref_const<T, n> & that) const
  {
...
private:
  //: See assert_finite().
  const vnl_vector_fixed_ref_const<T, n> &
...
public:
  ...
  explicit vnl_vector_fixed_ref(T * dataptr)
    : base(dataptr)
  {}

  //: Copy operator
  const vnl_vector_fixed_ref<T, n> &
  operator=(const vnl_vector_fixed<T, n> & rhs) const
  {
  ...
  //: Copy operator
  const vnl_vector_fixed_ref<T, n> &
  operator=(const vnl_vector_fixed_ref<T, n> & rhs) const
  {
    std::memcpy(data_block(), rhs.data_block(), n * sizeof(T));
    return *this;
  }
  ...
  //: Copy operator
  const vnl_vector_fixed_ref<T, n> &
  operator=(const vnl_vector_fixed_ref_const<T, n> & rhs) const
  {
    std::memcpy(data_block(), rhs.data_block(), n * sizeof(T));
    return *this;
  }
  ...
  void
  put(unsigned int i, const T & v) const
  {
    data_block()[i] = v;
  }

  //: Set all values to v
  vnl_vector_fixed_ref &
  fill(const T & v)
  {
    for (size_type i = 0; i < n; ++i)
      data_block()[i] = v;
  ...
  //  Note: ptr[i] must be valid for i=0..size()-1
  const vnl_vector_fixed_ref &
  copy_in(const T * ptr) const
  {
    for (size_type i = 0; i < n; ++i)
      data_block()[i] = ptr[i];
    return *this;
  ...
  const vnl_vector_fixed_ref &
  update(const vnl_vector<T> &, unsigned int start = 0) const;
  ...
  //:
  const vnl_vector_fixed_ref<T, n> &
  operator+=(const vnl_vector_fixed<T, n> & v) const
  {
    base::add(data_block(), v.data_block(), data_block());
    return *this;
  }
  ...
  operator-=(const vnl_vector_fixed<T, n> & v) const
  {
    base::sub(data_block(), v.data_block(), data_block());
    return *this;
  }

  //:
  const vnl_vector_fixed_ref<T, n> &
  operator+=(const vnl_vector<T> & v) const
  {
    assert(v.size() == n);
    base::add(data_block(), v.data_block(), data_block());
    return *this;
...
operator+(const vnl_vector_fixed_ref_const<T, n> & v, T s)
{
...
template <class T, unsigned int n>
inline vnl_vector_fixed<T, n>
operator+(T s, const vnl_vector_fixed_ref_const<T, n> & v)
{
  vnl_vector_fixed<T, n> r;
  vnl_vector_fixed<T, n>::add(v.data_block(), s, r.data_block());
  return r;
...
template <class T, unsigned int n>
inline vnl_vector_fixed<T, n>
operator+(const vnl_vector_fixed_ref_const<T, n> & a, const vnl_vector_fixed_ref_const<T, n> & b)
{
  vnl_vector_fixed<T, n> r;
...
template <class T, unsigned int n>
inline vnl_vector_fixed<T, n>
element_product(const vnl_vector_fixed_ref_const<T, n> & a, const vnl_vector_fixed_ref_const<T, n> & b)
{
  vnl_vector_fixed<T, n> r;
...
template <class T, unsigned int n>
inline vnl_vector_fixed<T, n>
element_quotient(const vnl_vector_fixed_ref_const<T, n> & a, const vnl_vector_fixed_ref_const<T, n> & b)
{
  vnl_vector_fixed<T, n> r;
...
vnl_cross_3d(const vnl_vector_fixed_ref_const<T, 3> & v1, const vnl_vector_fixed_ref_const<T, 3> & v2)
{
...
template <class T, unsigned int n>
inline vnl_vector<T>
operator+(const vnl_vector_fixed_ref_const<T, n> & a, const vnl_vector<T> & b)
{
  return a.as_ref() + b;
}
...
template <class T, unsigned int n>
inline vnl_vector<T>
operator+(const vnl_vector<T> & a, const vnl_vector_fixed_ref_const<T, n> & b)
{
  return a + b.as_ref();
}
...
outer_product(const vnl_vector_fixed_ref_const<T, m> & a, const vnl_vector_fixed_ref_const<T, n> & b)
{
...
template <class T, unsigned int n>
inline vnl_vector_fixed<T, n>
vnl_cross_3d(const vnl_vector_fixed_ref_const<T, n> & a, const vnl_vector<T> & b)
{
...
template <class T, unsigned int n>
inline vnl_vector_fixed<T, n>
vnl_cross_3d(const vnl_vector<T> & a, const vnl_vector_fixed_ref_const<T, n> & b)
{
...
template <class T, unsigned int n>
inline vnl_matrix<T>
outer_product(const vnl_vector<T> & a, const vnl_vector_fixed_ref_const<T, n> & b)
{
...
template <class T, unsigned int n>
inline vnl_matrix<T>
outer_product(const vnl_vector_fixed_ref_const<T, n> & a, const vnl_vector<T> & b)
{
...
template <class T, unsigned int n>
inline std::ostream &
operator<<(std::ostream & o, const vnl_vector_fixed_ref_const<T, n> & v)
{
  v.print(o);
  return o;
}
...
template <class T, unsigned int n>
inline std::istream &
operator>>(std::istream & i, const vnl_vector_fixed_ref<T, n> & v)
{
  v.read_ascii(i);
  return i;
}
