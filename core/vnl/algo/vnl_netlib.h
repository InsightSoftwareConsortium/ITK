...
#define vnl_netlib_svd_proto(T)                                                                                       \
  T *x, long int const *ldx, long int const *m, long int const *n, T *sv, T *errors, T *u, long int const *ldu, T *v, \
    long int const *ldv, T *work, long int const *job, long int *info
#define vnl_netlib_svd_params x, ldx, m, n, sv, errors, u, ldu, v, ldv, work, job, info

// xQRDC
#define vnl_netlib_qrdc_proto(T)                                                                      \
  T *x, long int const *ldx, long int const *n, long int const *p, T *qraux, long int *jpvt, T *work, \
    long int const *job
#define vnl_netlib_qrdc_params x, ldx, n, p, qraux, jpvt, work, job

// xQRSL
#define vnl_netlib_qrsl_proto(T)                                                                                       \
  T const *x, long int *ldx, long int *n, long int *k, T const *qraux, T const *y, T *qy, T *qty, T *b, T *rsd, T *xb, \
