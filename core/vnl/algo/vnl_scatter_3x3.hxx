...
template <class T>
void
vnl_scatter_3x3<T>::add_outer_product(const vnl_vector_fixed<T, 3> & v)
{
...
template <class T>
void
vnl_scatter_3x3<T>::add_outer_product(const vnl_vector_fixed<T, 3> & u, const vnl_vector_fixed<T, 3> & v)
{
  vnl_scatter_3x3<T> & S = *this;
  for (int i = 0; i < 3; ++i)
    for (int j = 0; j < 3; ++j)
...
template <class T>
void
vnl_scatter_3x3<T>::sub_outer_product(const vnl_vector_fixed<T, 3> & v)
{
  vnl_scatter_3x3<T> & S = *this;
  for (int i = 0; i < 3; ++i)
  {
...
template <class T>
void
vnl_scatter_3x3<T>::sub_outer_product(const vnl_vector_fixed<T, 3> & u, const vnl_vector_fixed<T, 3> & v)
{
  vnl_scatter_3x3<T> & S = *this;
  for (int i = 0; i < 3; ++i)
    for (int j = 0; j < 3; ++j)
...
template <class T>
void
vnl_scatter_3x3<T>::force_symmetric()
{
  if (symmetricp)
    return;
  vnl_scatter_3x3<T> & S = *this;
...
#define VNL_SCATTER_3X3_INSTANTIATE(T) template class VNL_ALGO_EXPORT vnl_scatter_3x3<T>
