...
public:
  ...
  void
  set_bound_selection(const vnl_vector<long> & nbd)
  {
  ...
  void
  get_bound_selection(vnl_vector<long> & nbd) const
  {
  ...
  void
  set_lower_bound(const vnl_vector<double> & l)
  {
    this->lower_bound_ = l;
  }
  ...
  void
  get_lower_bound(vnl_vector<double> & l) const
  {
    l = this->lower_bound_;
  }
  ...
  void
  set_upper_bound(const vnl_vector<double> & u)
  {
    this->upper_bound_ = u;
  }
  ...
  void
  get_upper_bound(vnl_vector<double> & u) const
  {
    u = this->upper_bound_;
  }
  ...
  void
  set_max_variable_metric_corrections(long m)
  {
  ...
  long
  get_max_variable_metric_corrections() const
  {
  ...
  void
  set_cost_function_convergence_factor(double factor)
  {
  ...
  double
  get_cost_function_convergence_factor() const
  {
  ...
  // 1e-5.
  void
  set_projected_gradient_tolerance(double tol)
  {
  ...
  double
  get_projected_gradient_tolerance() const
  {
  ...
  double
  get_inf_norm_projected_gradient() const
  {
