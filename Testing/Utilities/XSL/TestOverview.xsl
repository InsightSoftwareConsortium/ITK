...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    <xsl:call-template name="TestOverviewByName"/>
  ...
  <xsl:template name="TestOverviewByName">
    <redirect:write select="concat(string('{$DashboardPath}'), '/TestOverviewByName.html' )" file="dan.html">
      <xsl:call-template name="InsightHeader">
        <xsl:with-param name="Title">Insight Test Overview</xsl:with-param>
        <xsl:with-param name="IconDir">../../Icons</xsl:with-param>
        <xsl:with-param name="TestsIcon">TestsBlue.gif</xsl:with-param>
