 ...
 *
 *  This test computes the KullbackLiebler information value and derivatives
 *  for various shift values in (-10,10).
 *
 */

int itkKullbackLieblerCompareHistogramImageToImageMetricTest(int, char* [] )
{
...
//---------------------------------------------------------
// Print out KullbackLiebler values
...
//---------------------------------------------------------
  ...
  std::cout << "param[4]\tKullbackLiebler\tdKullbackLiebler/dparam[4]" << std::endl;
