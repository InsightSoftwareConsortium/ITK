/*=========================================================================
  ...
  Module:    itkImageToImageTranslationNormalizedCorrelationRegistrationTest.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
 ...
 *  in the itkImageToImageTranslationNormalizedCorrelationRegistration.txx file
 *  (you need to change the type of the optimizer in the header file
 *  ie itkImageToImageTranslationNormalizedCorrelationRegistration.h)
 */ 
...
int main()
{
  ...
  typedef itk::ImageToImageTranslationNormalizedCorrelationRegistration<ReferenceType,TargetType> RegistrationType;
