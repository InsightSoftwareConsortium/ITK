/*=========================================================================
  ...
  Module:    itkImageToImageAffinePatternIntensityRegistrationTest.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
 ...
 *  in the itkImageToImageAffinePatternIntensityRegistration.txx file
 *  (you need to change the type of the optimizer in the header file
 *  ie itkImageToImageAffinePatternIntensityRegistration.h)
 */ 
...
int main()
{
  ...
  typedef itk::ImageToImageAffinePatternIntensityRegistration<ReferenceType,TargetType> RegistrationType;
