/*=========================================================================
  ...
  Module:    itkImageToImageTranslationMeanSquaresRegularStepGradientDescentRegistrationTest.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
 ...
 *  in the itkImageToImageTranslationMeanSquaresRegularStepGradientDescentRegistration.txx file
 *  (you need to change the type of the optimizer in the header file
 *  ie itkImageToImageTranslationMeanSquaresRegularStepGradientDescentRegistration.h)
 */ 

int itkImageToImageTranslationMeanSquaresRegularStepGradientDescentRegistrationTest(int, char**)
{
  ...
  typedef itk::ImageToImageTranslationMeanSquaresRegularStepGradientDescentRegistration<
