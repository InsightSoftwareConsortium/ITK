/*=========================================================================
  ...
  Module:    itkPointSetToImageTranslationMeanSquaresRegularStepGradientDescentRegistrationTest.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
int itkPointSetToImageTranslationMeanSquaresRegularStepGradientDescentRegistrationTest(int, char**)
{

  // Number of pixels to take from the target image
  unsigned long  numberOfSamples = 157;
