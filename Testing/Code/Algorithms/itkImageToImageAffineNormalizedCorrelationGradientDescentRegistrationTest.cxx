...
int itkImageToImageAffineNormalizedCorrelationGradientDescentRegistrationTest(int, char**)
{
  ...
  typedef itk::ImageToImageAffineNormalizedCorrelationGradientDescentRegistration<
  ...
  registrationMethod->GetOptimizer()->SetLearningRate(1e-4);
