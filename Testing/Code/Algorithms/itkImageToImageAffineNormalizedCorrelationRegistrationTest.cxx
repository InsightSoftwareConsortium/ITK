/*=========================================================================
  ...
  Module:    itkImageToImageAffineNormalizedCorrelationRegistrationTest.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
 ...
 *  in the itkImageToImageAffineNormalizedCorrelationRegistration.txx file
 *  (you need to change the type of the optimizer in the header file
 *  ie itkImageToImageAffineNormalizedCorrelationRegistration.h)
 */ 
...
int main()
{
  ...
  typedef itk::ImageToImageAffineNormalizedCorrelationRegistration<ReferenceType,TargetType> RegistrationType;
