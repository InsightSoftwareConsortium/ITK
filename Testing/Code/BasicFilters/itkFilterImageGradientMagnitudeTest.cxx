...
/**
 * This program tests the GradientMagnitudeImageFilter object by driving it
...
int main(int argc, char *argv[])
{
  try
    {
      // Set up filter
      itk::GradientMagnitudeImageFilter<float, 4>::Pointer
        filter = itk::GradientMagnitudeImageFilter<float, 4>::New();
