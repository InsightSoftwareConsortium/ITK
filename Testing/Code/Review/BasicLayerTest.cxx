...
int BasicLayerTest( int , char* [] )
{
  typedef itkQE::QuadEdgeGeom< int, int, bool, bool > TPrim;
  typedef TPrim::Dual                                 TDual;
  TPrim* e[5];
  ...
  //////////////////////////////////////////////////////////
  typedef TPrim::IteratorGeom IteratorGeom;
