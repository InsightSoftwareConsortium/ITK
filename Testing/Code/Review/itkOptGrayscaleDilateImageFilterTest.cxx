/*=========================================================================
  ...
  Module:    itkOptGrayscaleDilateImageFilterTest.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
int itkOptGrayscaleDilateImageFilterTest(int ac, char* av[] )
{
  ...
  typedef itk::GrayscaleDilateImageFilter< ImageType, ImageType, SRType > FilterType;
