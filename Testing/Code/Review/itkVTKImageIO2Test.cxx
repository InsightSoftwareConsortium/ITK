...
bool VTKImageIO2Tester::WriteVTKImage( const std::string &filePrefix, std::string &outputPath, bool ascii )
{
  try 
    ...
    m_NameWithIndex << filePrefix << "_" << m_CallNumber << ".vtk";
    ...
    if (!vtkIO->CanWriteFile(m_OutputFileName.str().c_str()))
      {
      return false;
      }
                                       ...
                                       bool ascii )
{
  try
    ...
    std::ostringstream m_NameWithIndex;
    m_NameWithIndex << filePrefix << "_" << index << ".vtk";
    ...
    if (!vtkIO->CanReadFile(m_OutputFileName.str().c_str()))
      {
      return false;
      }
...
int VTKImageIO2Tester::Test(int argc, char* argv[] )
{
  ...
  // unsigned char (ascii)
  if (!(this->WriteVTKImage<unsigned char, 3>( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (unsigned char - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (unsigned char - ascii)" << std::endl;
  if (!(this->ReadVTKImage<unsigned char, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  if (!(this->WriteVTKImage<unsigned char, 3>( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (unsigned char - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (unsigned char - binary)" << std::endl;
  if (!(this->ReadVTKImage<unsigned char, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  // char (ascii)
  if (!(this->WriteVTKImage<char, 3>( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (char - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (char - ascii)" << std::endl;
  if (!(this->ReadVTKImage<char, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  // char (binary)
  if (!(this->WriteVTKImage<char, 3>( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (char - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (char - binary)" << std::endl;
  if (!(this->ReadVTKImage<char, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  if (!(this->WriteVTKImage<unsigned short, 3>( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (unsigned short - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (unsigned short - ascii)" << std::endl;
  if (!(this->ReadVTKImage<unsigned short, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  if (!(this->WriteVTKImage<unsigned short, 3>( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (unsigned short - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (unsigned short - binary)" << std::endl;
  if (!(this->ReadVTKImage<unsigned short, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  // short (ascii)
  if (!(this->WriteVTKImage<short, 3>( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (short - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (short - ascii)" << std::endl;
  if (!(this->ReadVTKImage<short, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  // short (binary)
  if (!(this->WriteVTKImage<short, 3>( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (short - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (short - binary)" << std::endl;
  if (!(this->ReadVTKImage<short, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  // unsigned int (ascii)
  if (!(this->WriteVTKImage<unsigned int, 3>( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (unsigned int - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (unsigned int - ascii)" << std::endl;
  if (!(this->ReadVTKImage<unsigned int, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  // unsigned int (binary)
  if (!(this->WriteVTKImage<unsigned int, 3>( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (unsigned int - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (unsigned int - binary)" << std::endl;
  if (!(this->ReadVTKImage<unsigned int, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  // int (ascii)
  if (!(this->WriteVTKImage<int, 3>( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (int - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (int - ascii)" << std::endl;
  if (!(this->ReadVTKImage<int, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  // int (binary)
  if (!(this->WriteVTKImage<int, 3>( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (int - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (int - binary)" << std::endl;
  if (!(this->ReadVTKImage<int, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  // unsigned long (ascii)
  if (!(this->WriteVTKImage<unsigned long, 3>( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (unsigned long - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (unsigned long - ascii)" << std::endl;
  if (!(this->ReadVTKImage<unsigned long, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  if (!(this->WriteVTKImage<unsigned long, 3>( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (unsigned long - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (unsigned long - binary)" << std::endl;
  if (!(this->ReadVTKImage<unsigned long, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  // long (ascii)
  if (!(this->WriteVTKImage<long, 3>( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (long - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (long - ascii)" << std::endl;
  if (!(this->ReadVTKImage<long, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  // long (binary)
  if (!(this->WriteVTKImage<long, 3>( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (long - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (long - binary)" << std::endl;
  if (!(this->ReadVTKImage<long, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  if (!(this->WriteVTKImage< itk::RGBPixel<unsigned char>, 3>( filePrefix, outpuPath, this )))
    {
  ...
  if (!(this->ReadVTKImage< itk::RGBPixel<unsigned char>, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  if (!(this->WriteVTKImage< itk::RGBPixel<unsigned char>, 3>( filePrefix, outpuPath, false )))
    {
  ...
  if (!(this->ReadVTKImage< itk::RGBPixel<unsigned char>, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  if (!(this->WriteVTKImage< itk::RGBAPixel<unsigned char>, 3>( filePrefix, outpuPath, this )))
    {
  ...
  if (!(this->ReadVTKImage< itk::RGBAPixel<unsigned char>, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  if (!(this->WriteVTKImage< itk::RGBAPixel<unsigned char>, 3>( filePrefix, outpuPath, false )))
    {
  ...
  if (!(this->ReadVTKImage< itk::RGBAPixel<unsigned char>, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  // Vector<int> - ascii
  if (!(this->WriteVTKImage< itk::Vector<int, TEST_VECTOR_PIXEL_DIM>, 3 >( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (Vector<int> - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (Vector<int> - ascii)" << std::endl;
  if (!(this->ReadVTKImage< itk::Vector<int, TEST_VECTOR_PIXEL_DIM>, 3 >( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  // Vector<int> - binary
  if (!(this->WriteVTKImage< itk::Vector<int, TEST_VECTOR_PIXEL_DIM>, 3 >( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (Vector<int> - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (Vector<int> - binary)" << std::endl;
  if (!(this->ReadVTKImage< itk::Vector<int, TEST_VECTOR_PIXEL_DIM>, 3 >( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  // Vector<double> - ascii
  if (!(this->WriteVTKImage< itk::Vector<double, TEST_VECTOR_PIXEL_DIM>, 3 >( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (Vector<double> - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (Vector<double> - ascii)" << std::endl;
  if (!(this->ReadVTKImage< itk::Vector<double, TEST_VECTOR_PIXEL_DIM>, 3 >( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  if (!(this->WriteVTKImage< itk::Vector<double, TEST_VECTOR_PIXEL_DIM>, 3 >( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (Vector<double> - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (Vector<double> - binary)" << std::endl;
  if (!(this->ReadVTKImage< itk::Vector<double, TEST_VECTOR_PIXEL_DIM>, 3 >( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  // float - ascii
  if (!(this->WriteVTKImage<float, 3>( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (float - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (float - ascii)" << std::endl;
  if (!(this->ReadVTKImage<float, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  // float - binary
  if (!(this->WriteVTKImage<float, 3>( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (float - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (float - binary)" << std::endl;
  if (!(this->ReadVTKImage<float, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
  ...
  // double - ascii
  if (!(this->WriteVTKImage<double, 3>( filePrefix, outpuPath, this )))
    {
    std::cout << "[FAILED] writing (double - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (double - ascii)" << std::endl;
  if (!(this->ReadVTKImage<double, 3>( filePrefix, outpuPath, m_CallNumber, this )))
    {
  ...
  // double - binary
  if (!(this->WriteVTKImage<double, 3>( filePrefix, outpuPath, false )))
    {
    std::cout << "[FAILED] writing (double - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (double - binary)" << std::endl;
  if (!(this->ReadVTKImage<double, 3>( filePrefix, outpuPath, m_CallNumber, false )))
    {
