...
inline double vcl_abs(double x) { return ::fabsf(x); }
...
inline double vcl_fabs(double x) { return ::fabsf(x); }
...
inline long double vcl_acos(long double x) { return ::acos(x); }

#undef  vcl_ceil
#define vcl_ceil vcl_ceil
inline float vcl_ceil(float x) { return ::ceil(x); }
inline double vcl_ceil(double x) { return ::ceil(x); }
inline long double vcl_ceil(long double x) { return ::ceil(x); }
