...
integer *ierr;
{
    ...
    /* Local variables */
    extern /* Subroutine */ int tred1_LOCAL(), tred2_LOCAL(), rebak_LOCAL(), reduc_LOCAL(),
            tqlrat_LOCAL(), tql2_LOCAL();
...
L10:
    reduc_LOCAL(nm, n, &a[a_offset], &b[b_offset], &fv2[1], ierr);
    if (*ierr != 0) {
        goto L50;
    }
    if (*matz != 0) {
...
/*     .......... find eigenvalues only .......... */
    tred1_LOCAL(nm, n, &a[a_offset], &w[1], &fv1[1], &fv2[1]);
    tqlrat_LOCAL(n, &w[1], &fv2[1], ierr);
    goto L50;
/*     .......... find both eigenvalues and eigenvectors .......... */
L20:
    tred2_LOCAL(nm, n, &a[a_offset], &w[1], &fv1[1], &z[z_offset]);
    tql2_LOCAL(nm, n, &w[1], &fv1[1], &z[z_offset], ierr);
    if (*ierr != 0) {
        goto L50;
    }
    rebak_LOCAL(nm, n, &b[b_offset], &fv2[1], n, &z[z_offset]);
L50:
    return 0;
} /* rsg_ */

doublereal epslon_LOCAL(x)
doublereal *x;
{
    /* System generated locals */
...
/* Subroutine */ int tqlrat_LOCAL(n, d, e2, ierr)
integer *n;
doublereal *d, *e2;
integer *ierr;
{
    ...
    extern doublereal pythag_LOCAL(), epslon_LOCAL();
    static integer mml;
...
/* Subroutine */ int rebak_LOCAL(nm, n, b, dl, m, z)
integer *nm, *n;
doublereal *b, *dl;
integer *m;
doublereal *z;
...
/* Subroutine */ int reduc_LOCAL(nm, n, a, b, dl, ierr)
integer *nm, *n;
doublereal *a, *b, *dl;
integer *ierr;
{
...
/* Subroutine */ int tql2_LOCAL(nm, n, d, e, z, ierr)
integer *nm, *n;
doublereal *d, *e, *z;
integer *ierr;
{
    ...
    static integer ii;
    extern doublereal pythag_LOCAL();
...
/* Subroutine */ int tred1_LOCAL(nm, n, a, d, e, e2)
integer *nm, *n;
doublereal *a, *d, *e, *e2;
{
    /* System generated locals */
...
/* Subroutine */ int tred2_LOCAL(nm, n, a, d, e, z)
integer *nm, *n;
doublereal *a, *d, *e, *z;
{
    /* System generated locals */
