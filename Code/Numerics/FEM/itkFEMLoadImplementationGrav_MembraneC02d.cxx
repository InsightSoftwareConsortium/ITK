/*=========================================================================
  ...
  Module:    itkFEMLoadImplementationGrav_MembraneC02d.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
(MembraneC02D::ConstPointer element, Element::LoadElementPointer load)
{
  ...
  pt[2] = (element->uDOF(0)->value + element->uDOF(1)->value + element->uDOF(2)->value + element->uDOF(3)->value)/4;
  pt[3] = (element->uDOF(0)->value + element->uDOF(1)->value + element->uDOF(2)->value + element->uDOF(3)->value)/4;
  f=l0->Fg(pt);    
