...
void Element3DC0LinearTetrahedronStrain
...
::Read( std::istream& f, void* info )
{
  ...
  {
    throw FEMExceptionObjectNotFound(__FILE__,__LINE__,"Element3DC0LinearTetrahedronStrain::Read()",e.m_baseClassName,e.m_GN);
  }
...
out:
  ...
  if( !f )
  { 
    throw FEMExceptionIO(__FILE__,__LINE__,"Element3DC0LinearTetrahedronStrain::Read()","Error reading FEM element!");
  }
...
::Write( std::ostream& f, int clid ) const {
  ...
  if (!f)
  { 
    throw FEMExceptionIO(__FILE__,__LINE__,"Element3DC0LinearTetrahedronStrain::Write()","Error writing FEM element!");
  }
