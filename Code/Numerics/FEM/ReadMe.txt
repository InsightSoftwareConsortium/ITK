...
When compiling the toolkit, you and optionally choose to include visualization member functions that draw elements and nodes on the device context in Windows using MFC classes by defining the macro "_FEM_Build_Visualization_Routines_". In this case you should also define this macro before including any FEM header files. By default the visualization support is off.
