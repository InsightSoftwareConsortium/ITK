...
class Element3DC0LinearHexahedron : public ElementStd<8,VNumberOfDegreesOfFreedomPerNode>
{
typedef ElementStd<8,VNumberOfDegreesOfFreedomPerNode> TemplatedParentClass;
