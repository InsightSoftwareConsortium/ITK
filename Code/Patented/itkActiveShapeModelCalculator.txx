...
public:
   ...
   */
  InvalidActiveShapeModeError(const char *file, unsigned int lineNumber):ExceptionObject(file,
                                                                                         lineNumber) { this->
                                                                                                       SetDescription(
                                                                                                         "No valid training image are availble."); }

  /**
   * Constructor. Needed to ensure the exception object can be copied.
   */
  InvalidActiveShapeModeError(const std::string & file, unsigned int lineNumber):ExceptionObject(file,
                                                                                                 lineNumber) { this->
                                                                                                               SetDescription(
                                                                                                                 "No valid training image are available."); }
...
ActiveShapeModelCalculator< TImage >::GetMeanShape()
{
  if ( !m_Valid )
    {
...
template< class TImage >
typename ActiveShapeModelCalculator< TImage >::VectorOfDoubleType
ActiveShapeModelCalculator< TImage >::GetEigenvalues()
{
  if ( !m_Valid )
    {
    throw InvalidActiveShapeModeError(__FILE__, __LINE__);
...
ActiveShapeModelCalculator< TImage >::GetEigenvector()
{
  if ( !m_Valid )
    {
    throw InvalidActiveShapeModeError(__FILE__, __LINE__);
