...
/* Compute the inverse of the Varianceiance Matrices. */
  ...
  if ( (int)( this->GetWeight() * 100 + 0.5 ) > 1 )
    ...
    m_Diff_VarianceInverse[0][0] =
      ( m_Diff_Variance[1][1] * m_Diff_Variance[2][2] - m_Diff_Variance[2][1] * m_Diff_Variance[1][2] )
      / m_Diff_VarianceDet;
    m_Diff_VarianceInverse[0][1] =
      -( m_Diff_Variance[1][0] * m_Diff_Variance[2][2] - m_Diff_Variance[2][0] * m_Diff_Variance[1][2] )
      / m_Diff_VarianceDet;
    m_Diff_VarianceInverse[0][2] =
      ( m_Diff_Variance[1][0] * m_Diff_Variance[2][1] - m_Diff_Variance[2][0] * m_Diff_Variance[1][1] )
      / m_Diff_VarianceDet;
    m_Diff_VarianceInverse[1][0] =
      -( m_Diff_Variance[0][1] * m_Diff_Variance[2][2] - m_Diff_Variance[2][1] * m_Diff_Variance[0][2] )
      / m_Diff_VarianceDet;
    m_Diff_VarianceInverse[1][1] =
      ( m_Diff_Variance[0][0] * m_Diff_Variance[2][2] - m_Diff_Variance[2][0] * m_Diff_Variance[0][2] )
      / m_Diff_VarianceDet;
    m_Diff_VarianceInverse[1][2] =
      -( m_Diff_Variance[0][0] * m_Diff_Variance[2][1] - m_Diff_Variance[2][0] * m_Diff_Variance[0][1] )
      / m_Diff_VarianceDet;
    m_Diff_VarianceInverse[2][0] =
      ( m_Diff_Variance[0][1] * m_Diff_Variance[1][2] - m_Diff_Variance[1][1] * m_Diff_Variance[0][2] )
      / m_Diff_VarianceDet;
    m_Diff_VarianceInverse[2][1] =
      -( m_Diff_Variance[0][0] * m_Diff_Variance[1][2] - m_Diff_Variance[1][0] * m_Diff_Variance[0][2] )
      / m_Diff_VarianceDet;
    m_Diff_VarianceInverse[2][2] =
      ( m_Diff_Variance[0][0] * m_Diff_Variance[1][1] - m_Diff_Variance[1][0] * m_Diff_Variance[0][1] )
      / m_Diff_VarianceDet;
    }
