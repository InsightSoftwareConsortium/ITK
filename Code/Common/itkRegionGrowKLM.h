...
=========================================================================*/
#ifndef _itkRegionGrowKLM_h
#define _itkRegionGrowKLM_h
 ...
 * 
 * itkRegionGrowKLM is the base class for the RegionGrowKLM objects.
 ...
 * .
 * The ApplyRegionGrow() function implements the segmentation algorithm
 ...
 * format as input and produces two outputs. Using the FilterImageToImage, 
...
class ITK_EXPORT RegionGrowKLM : public RegionGrow<TInputImage,TOutputImage>
{
...
public:
   ...
   */
  typedef RegionGrowKLM   Self;

  /**
   * Standard "Superclass" typedef
   */
  typedef RegionGrow<TInputImage,TOutputImage> Superclass;
   ...
   */
  itkTypeMacro(RegionGrowKLM,RegionGrow);
   ...
   */
  typedef RGBorderKLM<TInputImage,TOutputImage>    BorderType;

  /**
   * Type definition for the smart border pointers object.
   */
  typedef DynamicBorderArrayKLM<BorderType>  RGBorderKLMPtr;

  /**
   * Set the desired threshold parameter for lambda. See itkRGBorderKLM 
...
protected:
  ...
  /**
   * Initialize the RegionGrow algorithm
   */
  void initializeKLM();
...
private:
  ...
  RGRegionKLM<TInputImage,TOutputImage> *m_pRegions;   
  RGBorderKLM<TInputImage,TOutputImage> *m_pBorders;

  RGBorderKLMPtr                        *m_pBordersDynPtrs;
  RGBorderKLMPtr                        *m_pBordersCandidateDynPtr;
  RGBorderKLM<TInputImage,TOutputImage> *m_pBorderCandidate;
   ...
   */
  void union_borders(RGRegionKLM<TInputImage,
                                 TOutputImage> *pRegion1,
                     RGRegionKLM<TInputImage,
