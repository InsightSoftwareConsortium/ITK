/*==========================================================================
  ...
  Module:    itkFastMarchExtension.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
==========================================================================*/
#ifndef _itkFastMarchExtension_h
#define _itkFastMarchExtension_h
...
>
class ITK_EXPORT FastMarchExtension :
  public FastMarching<TLevelSet>
{
public:
   ...
   */
  typedef FastMarchExtension Self;

  /**
   * Standard "Superclass" typedef
   */ 
  typedef FastMarching<TLevelSet> Superclass;
   ...
   */
  itkTypeMacro(FastMarchExtension, FastMarching);
...
#include "itkFastMarchExtension.txx"
#endif
