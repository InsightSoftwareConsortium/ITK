 ...
 * 
 * ImageReverseConstIterator is a templated class to represent a multi-dimensional
 * iterator. ImageReverseConstIterator is templated over the dimension of the image
