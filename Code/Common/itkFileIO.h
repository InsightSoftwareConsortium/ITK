#ifndef __itkFileIO_h
#define __itkFileIO_h
...
class ITK_EXPORT FileIO : public ProcessObject
{
public:
  /** 
   ...
   */
  itkTypeMacro(FileIO, Superclass);
...
protected:
	...
	/**
	 * Does the FileIO object have enough info to be of use?
	 */
	bool m_Initialized;
	 ...
	 * 3 for RGB images, and 4 for RGBA images.
	 */
	...
	/**
	 * Resize the FileIO object to new dimensions
	 */
...
/**
 * The object factory that can create instances of FileIO
 */
class FileIOMaker : public Maker<std::string, FileIO> 
{
...
protected:
  FileIOMaker(const KeyType& key) : Maker<KeyType, FileIO>(key) {}
};
