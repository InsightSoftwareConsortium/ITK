...
class ITK_EXPORT itkImageFilterGaussianFirstDerivative : public
...
public:
	itkImageFilterGaussianFirstDerivative() {};
	virtual ~itkImageFilterGaussianFirstDerivative() {};
...
#include "itkFilterImageGaussianFirstDerivative.cxx"
#endif
