...
void
RGRegionKLM<TInputImage,TOutputImage>
::SetRegionBorder( RGBorderKLM<TInputImage,TOutputImage> *pnewRegionBorder )
{
...
template<class TInputImage, class TOutputImage>
RGBorderKLM<TInputImage,TOutputImage> *
RGRegionKLM<TInputImage,TOutputImage>
...
void
RGRegionKLM<TInputImage,TOutputImage>
::DeleteRegionBorder( RGBorderKLM<TInputImage,TOutputImage> *pBorderCandidate )
{
...
void
RGRegionKLM<TInputImage,TOutputImage>
::ReorderRegionBorders( RGBorderKLM<TInputImage,TOutputImage> *pBorderCandidate )
{
...
::InsertRegionBorder(RegionBorderVecIterator RegionBorderVecIt,
                     RGBorderKLM<TInputImage,TOutputImage> *pBorderCandidate )
{
  // Ensure that the border candidate is not a null pointer
  if( pBorderCandidate == NULL )
  {
...
template<class TInputImage, class TOutputImage>
RGRegionKLM<TInputImage,TOutputImage>::RegionBorderVecIterator
RGRegionKLM<TInputImage,TOutputImage>
