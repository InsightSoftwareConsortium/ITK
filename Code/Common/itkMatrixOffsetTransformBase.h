...
//   const unsigned int itk::MatrixOffsetTransformBase< TScalarType, NInputDimensions, NOutputDimensions >::InputSpaceDimension;
//template < class TScalarType, unsigned int NInputDimensions, unsigned int NOutputDimensions>
//   const unsigned int itk::MatrixOffsetTransformBase< TScalarType, NInputDimensions, NOutputDimensions >::OutputSpaceDimension;
//template < class TScalarType, unsigned int NInputDimensions, unsigned int NOutputDimensions>
//   const unsigned int itk::MatrixOffsetTransformBase< TScalarType, NInputDimensions, NOutputDimensions >::ParametersDimension;
