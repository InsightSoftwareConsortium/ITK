...
void
RGBorderKLM<TInputImage,TOutputImage>
::SetRegion1(RGRegionKLM<TInputImage,TOutputImage> *Region1)
{
...
void
RGBorderKLM<TInputImage,TOutputImage>
::SetRegion2(RGRegionKLM<TInputImage,TOutputImage> *Region2)
{
...
::EvaluateLambda()
{
  ...
  RGRegionKLM<TInputImage,TOutputImage> *preg1 = this->GetRegion1();
  RGRegionKLM<TInputImage,TOutputImage> *preg2 = this->GetRegion2();
