...
AffineMutualInformationVW<TRefImage,TTestImage,TDerivImage>
...
TestImageType * ptr )
{
  this->MutualInformation<TRefImage,TTestImage>::SetTestImage(ptr);
...
bool resample)
{
  ...
  m_MutualInformation = dLogSumRef + dLogSumTest - dLogSumJoint;
...
void
AffineMutualInformationVW<TRefImage,TTestImage,TDerivImage>
::CalculateMutualInformationAndGradient(
bool resample)
{
