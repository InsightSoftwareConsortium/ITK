...
{
  os <<  typename NumericTraits<TComponent>::PrintType(c[0]) << "  ";
  os <<  typename NumericTraits<TComponent>::PrintType(c[1]) << "  ";
  os <<  typename NumericTraits<TComponent>::PrintType(c[2]) ;
  return os;
}
