/*=========================================================================
  ...
  Module:    itkFilterImageRecursiveGaussian.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkFilterImageRecursiveGaussian_h
#define __itkFilterImageRecursiveGaussian_h
...
/** \class FilterImageRecursiveGaussian
 * \brief Base class for recursive convolution with Gaussian kernel.
 *
 * FilterImageRecursiveGaussian is the base class for recursive filters that
...
class ITK_EXPORT FilterImageRecursiveGaussian :
...
public:
   ...
   */
  typedef FilterImageRecursiveGaussian  Self;
   ...
   */
  itkTypeMacro( FilterImageRecursiveGaussian, FilterImageToImage );
...
protected:
  FilterImageRecursiveGaussian();
  
  virtual ~FilterImageRecursiveGaussian() {};
  
  FilterImageRecursiveGaussian(const Self&) {}
...
#include "itkFilterImageRecursiveGaussian.txx"
#endif
