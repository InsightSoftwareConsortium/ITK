...
class ITK_EXPORT ThresholdImageFilter:public FilterImageToImage<TImage,TImage>
{
public:
  /**
   ...
   */
  typedef FilterImageToImage<TImage,TImage>  Superclass;
   ...
   */
  itkTypeMacro(ThresholdImageFilter, FilterImageToImage);
