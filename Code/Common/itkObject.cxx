...
void itkObject::SetGlobalWarningDisplay(bool val)
{
  itkObjectGlobalWarningDisplay = val;
}

bool itkObject::GetGlobalWarningDisplay()
{
...
#ifdef _WIN32
void* itkObject::operator new(size_t nSize, const char *, int)
{
  void* p=malloc(nSize);
  return p;
}

void* itkObject::operator new(size_t nSize)
{
  void* p=malloc(nSize);
  return p;
}

void itkObject::operator delete( void *p )
{
  free(p);
}
#endif 
...
std::ostream& operator<<(std::ostream& os, itkObject& o)
{
  o.Print(os);
  return os;
}

void itkObject::Print(std::ostream& os)
{
  itkIndent indent;
...
void itkObject::PrintHeader(std::ostream& os, itkIndent indent)
{
...
// its superclasses.
void itkObject::PrintSelf(std::ostream& os, itkIndent indent)
{
...
unsigned long int itkObject::GetMTime() 
{
  return m_MTime.GetMTime();
}

// Turn debugging output on.
void itkObject::DebugOn()
{
  m_Debug = 1;
}

// Turn debugging output off.
void itkObject::DebugOff()
{
  m_Debug = 0;
}

// Get the value of the debug flag.
bool itkObject::GetDebug()
{
  return m_Debug;
}

// Set the value of the debug flag. A non-zero value turns debugging on.
void itkObject::SetDebug(bool debugFlag)
{
  m_Debug = debugFlag;
}
...
void itkObject::BreakOnError()
{
  ;
}

// Sets the reference count (use with care)
void itkObject::SetReferenceCount(int ref)
{
