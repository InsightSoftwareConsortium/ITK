/*==========================================================================
  ...
  Module:    itkLocateLevelSetExtension.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
==========================================================================*/
#ifndef _itkLocateLevelSetExtension_h
#define _itkLocateLevelSetExtension_h
...
>
class ITK_EXPORT LocateLevelSetExtension :
  public LocateLevelSet<TLevelSet>
{
public:
  /** 
   * Standard "Self" typdedef
   */
  typedef LocateLevelSetExtension Self;

  /**
   * Standard "Superclass" typedef
   */ 
  typedef LocateLevelSet<TLevelSet> Superclass;
   ...
   */
  itkTypeMacro(LocateLevelSetExtension, LocateLevelSet);
...
protected:
  ...
  ~LocateLevelSetExtension(){};
  LocateLevelSetExtension( const Self& ) {};
...
#include "itkLocateLevelSetExtension.txx"
#endif
