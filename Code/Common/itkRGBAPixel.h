...
#define ITK_TEMPLATE_RGBAPixel(_, EXPORT, x, y) namespace itk { \
  _(1(class EXPORT RGBAPixel< ITK_TEMPLATE_1 x >)) \
  namespace Templates { typedef RGBAPixel< ITK_TEMPLATE_1 x > RGBAPixel##y; } \
  }
