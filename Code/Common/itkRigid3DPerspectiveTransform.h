...
//template < class TScalarType> const unsigned int itk::Rigid3DPerspectiveTransform<TScalarType>::SpaceDimension;
//template < class TScalarType> const unsigned int itk::Rigid3DPerspectiveTransform<TScalarType>::InputSpaceDimension;
//template < class TScalarType> const unsigned int itk::Rigid3DPerspectiveTransform<TScalarType>::OutputSpaceDimension;
