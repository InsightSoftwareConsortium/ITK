/*==========================================================================
  ...
  Module:    itkMutualInformationImageMetric.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
==========================================================================*/
#ifndef _itkMutualInformationImageMetric_h
#define _itkMutualInformationImageMetric_h

#include "itkObject.h"

namespace itk
{
/** \class MutualInformationImageMetric
 * \brief Calculate the mutual information between a reference
 * and a test image.
 *
 * MutualInformationImageMetric is an abstract class for all objects which
 ...
 *
 * The method CalculateMutualInformationImageMetric() evokes the calculation.
 * The mutual information value is obtained via method
 * GetMutualInformationImageMetric().
 *
...
class TTestImage 
>
class ITK_EXPORT MutualInformationImageMetric : public Object
{
public:
  /**
   * Standard "Self" typedef
   */
  typedef MutualInformationImageMetric Self;
   ...
   */
  itkTypeMacro(MutualInformationImageMetric, Object);
   ...
   */
  itkGetMacro( MutualInformationImageMetric, double );

  /**
   * Calculate the mutual information between the reference image 
   * and the test image.
   */
  virtual void CalculateMutualInformationImageMetric(){};

protected:
  MutualInformationImageMetric();
  ~MutualInformationImageMetric(){};
  MutualInformationImageMetric(const Self&){};
  ...
  double            m_MutualInformationImageMetric;
...
#include "itkMutualInformationImageMetric.txx"
#endif
