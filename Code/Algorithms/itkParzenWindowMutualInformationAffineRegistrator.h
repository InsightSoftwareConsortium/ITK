...
public:
   ...
   */
  void SetMutualInformationImageMetricCalculator( CalculatorType *ptr );

  /**
   * Get the mutual information calculator
   */
  typename CalculatorType::Pointer GetMutualInformationImageMetricCalculator()
    { return m_MutualInformationImageMetricCalculator; }
...
private:
  ...
  typename CalculatorType::Pointer            m_MutualInformationImageMetricCalculator;
