...
#ifndef __itkPhysicalImageMomentsCalculator_h
#define __itkPhysicalImageMomentsCalculator_h
...
class PhysicalImageMomentsCalculator
{
public:

    /// Standard self typedef
    typedef PhysicalImageMomentsCalculator<TPixel, VRank>            Self;
    ...
    /** 
     * Construct an PhysicalImageMomentsCalculator object.
     *
     * This method constructs a new PhysicalImageMomentsCalculator object 
     * that contains no
     * stored moments information; this information can be added later
     * by calling the ComputeMoments method.
     */    
    PhysicalImageMomentsCalculator();            // Create w/o summing moments

    /**
     * Compute moments of an image and save in an 
     * PhysicalImageMomentsCalculator object.
     *
     * This method constructs a new PhysicalImageMomentsCalculator object and 
     * stores in
     ...
     */
    PhysicalImageMomentsCalculator(              // Create and sum moments of an image
	ImageType &image);

    /**
     * Destroy an PhysicalImageMomentsCalculator object.
     */
...
#include "itkPhysicalImageMomentsCalculator.txx"
#endif

#endif /* __itkPhysicalImageMomentsCalculator_h */
