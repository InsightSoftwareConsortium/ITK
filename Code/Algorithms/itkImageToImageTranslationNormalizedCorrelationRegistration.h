/*=========================================================================
  ...
  Module:    itkImageToImageTranslationNormalizedCorrelationRegistration.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkImageToImageTranslationNormalizedCorrelationRegistration_h
#define __itkImageToImageTranslationNormalizedCorrelationRegistration_h
...
/**
 * \class ImageToImageTranslationNormalizedCorrelationRegistration
...
class ITK_EXPORT ImageToImageTranslationNormalizedCorrelationRegistration : public Object 
{
public:
  /**
   * Standard "Self" typedef.
   */
   typedef ImageToImageTranslationNormalizedCorrelationRegistration  Self;
   ...
   */
   itkTypeMacro(ImageToImageTranslationNormalizedCorrelationRegistration, Object);
...
protected:
  ...
  ImageToImageTranslationNormalizedCorrelationRegistration();
  virtual ~ImageToImageTranslationNormalizedCorrelationRegistration();
  ImageToImageTranslationNormalizedCorrelationRegistration(const Self&);
...
#include "itkImageToImageTranslationNormalizedCorrelationRegistration.txx"
#endif
