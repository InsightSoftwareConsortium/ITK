 ...
 * in the image buffered before CalculateMutualInformationImageMetric()
 * or CalculateMutualInformationImageMetricAndGradient() is called.
...
public:
  ...
  {
    this->CalculateMutualInformationImageMetric( true );
  }
  void CalculateMutualInformationImageMetric( bool resample = true );
  ...
  {
    this->CalculateMutualInformationImageMetricAndGradient( true );
  }
...
private:
  ...
  typedef 
    LinearInterpolateImageFunction<TTestImage> InterpolatorType;
