/*=========================================================================
  ...
  Module:    itkKullbackLieblerCompareHistogramImageToImageMetric.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkKullbackLieblerCompareHistogramImageToImageMetric_h
#define __itkKullbackLieblerCompareHistogramImageToImageMetric_h

#include "itkCompareHistogramImageToImageMetric.h"

namespace itk
{
  /** \class KullbackLieblerCompareHistogramImageToImageMetric 
    *  \brief Computes the Kubler Lieblach(KullbackLiebler) metric between the histogram
    *  of the two images to be registered and a training histogram.
    *
    *  This class is templated over the type of the fixed and moving
    *  images to be compared.
    *
    *  This class computers the KullbackLiebler-metric by comparing the histograms
...
class ITK_EXPORT KullbackLieblerCompareHistogramImageToImageMetric :
public CompareHistogramImageToImageMetric<TFixedImage, TMovingImage>
{
 public:
  /** Standard class typedefs. */
  typedef KullbackLieblerCompareHistogramImageToImageMetric Self;
  ...
  itkTypeMacro(KullbackLieblerCompareHistogramImageToImageMetric,
...
protected:
  ...
  virtual ~KullbackLieblerCompareHistogramImageToImageMetric(){}
...
private:
  ...
  KullbackLieblerCompareHistogramImageToImageMetric(Self const&);
...
#endif // __itkKullbackLieblerCompareHistogramImageToImageMetric_h
