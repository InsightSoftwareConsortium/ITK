...
public:
  ...
  typedef QuadEdgeMeshDelaunayConformingFilter< InputMeshType, OutputMeshType > InputOutputDelaunayConformingType;
  typedef typename InputOutputDelaunayConformingType::Pointer                   InputOutputDelaunayConformingPointer;

  typedef QuadEdgeMeshDelaunayConformingFilter< OutputMeshType, OutputMeshType > OutputDelaunayConformingType;
