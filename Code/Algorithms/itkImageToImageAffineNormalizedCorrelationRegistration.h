/*=========================================================================
  ...
  Module:    itkImageToImageAffineNormalizedCorrelationRegistration.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
/**
 * \class ImageToImageAffineNormalizedCorrelationRegistration
...
public:
   ...
   */
   typedef ImageToImageAffineNormalizedCorrelationRegistration  Self;
   ...
   *  Type of the Metric
   */
   typedef NormalizedCorrelationImageToImageMetric<TargetType, MapperType,double,double>   MetricType;
...
protected:
  ...
  virtual ~ImageToImageAffineNormalizedCorrelationRegistration();
  ImageToImageAffineNormalizedCorrelationRegistration(const Self&);
...
#include "itkImageToImageAffineNormalizedCorrelationRegistration.txx"
#endif
