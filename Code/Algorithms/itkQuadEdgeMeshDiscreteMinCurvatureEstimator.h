/*=========================================================================
  ...
  Module:    itkQuadEdgeMeshDiscreteMinCurvatureEstimator.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
class ITK_EXPORT QuadEdgeMeshDiscreteMinCurvatureEstimator:
...
private:
  QuadEdgeMeshDiscreteMinCurvatureEstimator(const Self &); // purposely not
                                                           // implemented
