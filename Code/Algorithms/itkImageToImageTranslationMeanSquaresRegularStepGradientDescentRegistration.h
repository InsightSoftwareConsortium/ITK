...
: public RegistrationMethod< 
            ImageToImageTranslationMeanSquaresRegularStepGradientDescentRegistrationTraits<TReference,TTarget>  >
{
public:
  /** Standard class typedefs. */
  typedef ImageToImageTranslationMeanSquaresRegularStepGradientDescentRegistration  Self;
  typedef RegistrationMethod< 
  ImageToImageTranslationMeanSquaresRegularStepGradientDescentRegistrationTraits<TReference,TTarget> >    Superclass;
