...
void DicomImageIO::ReadImageInformation()
{
  ...
  { 
    ...
    if(strcmp("US20",chaine)||strcmp("2000",chaine))
    {
      ...
      {
        m_Ifstream >> c;
        rows=rows+c*pow((double)256,(double)i);
      }
      m_Dimensions[1]=rows;
    }
    else
  ...
  if(DicomImageIO::GoToTag(m_Ifstream,0x0028,0x0011,
                                            i,max,tagcurrent))
   {
    ...
    if(strcmp("US20",chaine)||strcmp("2000",chaine))
    {
      ...
      {
        m_Ifstream >> c;
        columns=columns+c*pow((double)256,(double)i);
      }
  ...
  if(DicomImageIO::GoToTag(m_Ifstream,0x0028,0x0100,i,max,tagcurrent))
  {
    ...
    if(strcmp("US20",chaine)||strcmp("2000",chaine))
    {
      ...
      {
        m_Ifstream >> c;
        allocatedbits=allocatedbits+c*pow((double)256,(double)i);
      }
    }
    else
    {
  ...
  if(DicomImageIO::GoToTag(m_Ifstream,0x0028,0x0103,i,max,tagcurrent))
  {
    ...
    if(strcmp("US20",chaine)||strcmp("2000",chaine))
    {
      ...
      {
        m_Ifstream >> c;
        representation=representation+c*pow((double)256,(double)i);
      }
    }
    else
    {
