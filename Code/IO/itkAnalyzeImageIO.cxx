...
#include <unistd.h>
  ...
  void AnalyzeImageIO::ReadImageInformation()
  {
    ...
    //Insert Orientation.
    {
      ...
      temp[10]='\0';
      itk::EncapsulateMetaData<char *>(thisDic,"ITK_OnDiskStorageTypeName",temp);
      ...
      temp[4]='\0';
      itk::EncapsulateMetaData<char *>(thisDic,"ITK_VoxelUnits",temp);

      strncpy(temp,this->m_hdr.dime.cal_units,8);//Note this is necessary because the array is not necessarily null terminated.
      temp[8]='\0';
      itk::EncapsulateMetaData<char *>(thisDic,"Analyze_CalibrationUnits",temp);
      ...
      temp[80]='\0';
      itk::EncapsulateMetaData<char *>(thisDic,"ITK_FileNotes",temp);

      strncpy(temp,this->m_hdr.hist.aux_file,24);//Note this is necessary because the array is not necessarily null terminated.
      temp[24]='\0';
      itk::EncapsulateMetaData<char *>(thisDic,"ANALYZE_AUX_FILE_NAME",temp);
