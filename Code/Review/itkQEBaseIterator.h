...
#define itkQEDefineIteratorMethodsMacro( Op )                           \
    ...
    { return( Iterator( this, Iterator::Operator##Op, true ) ); }       \
                                                                        \
    virtual ConstIterator Begin##Op( ) const                            \
    { return( ConstIterator( this, ConstIterator::Operator##Op,         \
                             true ) ); }                                \
                                                                        \
    virtual Iterator End##Op( )                                         \
    { return( Iterator( this, Iterator::Operator##Op, false ) ); }      \
                                                                        \
...
#define itkQEDefineIteratorGeomMethodsMacro( Op )                       \
    ...
    { return( IteratorGeom( this, IteratorGeom::Operator##Op,           \
                            true ) ); }                                 \
                                                                        \
    virtual ConstIteratorGeom BeginGeom##Op( ) const                    \
    { return( ConstIteratorGeom( this, ConstIteratorGeom::Operator##Op, \
                                 true ) ); }                            \
                                                                        \
...
#define itkQEDefineAllIteratorMethodsMacro                              \
    ...
    typedef ConstIterator< Self > ConstIterator;                        \
                                                                        \
...
namespace itkQE
{
    ...
    template< typename TQuadEdge >
        class BaseIterator
        {
            ...
            {
                switch( m_OpType ) {
                case OperatorOnext    : m_Iterator = m_Iterator->GetOnext( );    break;
                case OperatorSym      : m_Iterator = m_Iterator->GetSym( );      break;
                case OperatorLnext    : m_Iterator = m_Iterator->GetLnext( );    break;
                case OperatorRnext    : m_Iterator = m_Iterator->GetRnext( );    break;
                case OperatorDnext    : m_Iterator = m_Iterator->GetDnext( );    break;
                case OperatorOprev    : m_Iterator = m_Iterator->GetOprev( );    break;
                case OperatorLprev    : m_Iterator = m_Iterator->GetLprev( );    break;
                case OperatorRprev    : m_Iterator = m_Iterator->GetRprev( );    break;
                case OperatorDprev    : m_Iterator = m_Iterator->GetDprev( );    break;
                case OperatorInvOnext : m_Iterator = m_Iterator->GetInvOnext( ); break;
                case OperatorInvLnext : m_Iterator = m_Iterator->GetInvLnext( ); break;
                case OperatorInvRnext : m_Iterator = m_Iterator->GetInvRnext( ); break;
                case OperatorInvDnext : m_Iterator = m_Iterator->GetInvDnext( ); break;
                default: break;
                } // hctiws
            }
