 ...
 *
 * InvertIntensityImageFilter invert intensity of pixels by subtracting pixel value
 * to a maximum value. The maximum value can be set with SetMaximum and defaults
