  ...
  */
  ...
  class QuadEdgeMeshEdgeMergeDecimationFilter :
    ...
    public:
      ...
      typedef QuadEdgeMeshDecimationFilter< TInput, TOutput, TCriterion >
        Superclass;

      /** Run-time type information (and related methods).   */
      itkTypeMacro( QuadEdgeMeshEdgeMergeDecimationFilter,
      ...
      typedef QuadEdgeMeshEulerOperatorJoinVertexFunction< OutputMeshType,
      OutputQEType > OperatorType;
    ...
    protected:
      ...
      */
        ...
        const OutputPointType& iPt )
      {
        ...
        for( ; ( it != elements_to_be_tested.end() ) && orientation_ok; ++it )
          {
          c_id = *it;
