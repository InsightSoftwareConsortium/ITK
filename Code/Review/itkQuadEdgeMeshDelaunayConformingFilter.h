  ...
  */
    ...
    public QuadEdgeMeshToQuadEdgeMeshFilter< TInputMesh, TOutputMesh >
  {
    public:
      ...
      typedef typename OutputMeshType::CellIdentifier
        OutputCellIdentifier;
      typedef typename OutputMeshType::EdgeCellType     OutputEdgeCellType;
      typedef typename OutputMeshType::QEType           OutputQEType;
      typedef typename OutputQEType::LineCellIdentifier
    ...
    public:
      ...
      typedef typename OutputEdgeCellListType::iterator
        OutputEdgeCellListIterator;

      typedef double CriterionValueType;
      typedef std::pair< bool, CriterionValueType > PriorityType;
      typedef MaxPriorityQueueElementWrapper< OutputEdgeCellType*,
        PriorityType,
        long > PriorityQueueItemType;
      ...
      typedef std::map< OutputEdgeCellType*,
        PriorityQueueItemType* > QueueMapType;
      typedef typename QueueMapType::iterator QueueMapIterator;

      typedef QuadEdgeMeshEulerOperatorFlipEdgeFunction< OutputMeshType,
        OutputQEType > FlipEdgeFunctionType;
      typedef typename FlipEdgeFunctionType::Pointer
    ...
    protected:
      ...
      inline CriterionValueType
        ...
        OutputPointIdentifier idA =
          iEdge->GetLnext( )->GetDestination( );
        OutputPointIdentifier idB =
          iEdge->GetRnext( )->GetOrigin( );
        ...
        CriterionValueType dotA =
          static_cast< CriterionValueType >( v1A * v2A );
        CriterionValueType dotB =
          static_cast< CriterionValueType >( v1B * v2B );
        CriterionValueType den =
    ...
    private:
      QuadEdgeMeshDelaunayConformingFilter( const Self& ); // Not impl.
