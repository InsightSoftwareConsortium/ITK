...
template< typename TInputMesh,
          typename TOutputMesh,
          typename TSolverTraits >
   void QuadEdgeMeshParam< TInputMesh, TOutputMesh, TSolverTraits >::
   GenerateData( )
{
        ...
        ++PtIterator )
   {
      OutputPointIdentifier id =
        static_cast< OutputPointIdentifier >( PtIterator->first );
