...
public:
  ...
  itkTypeMacro( QuadEdgeMeshDiscreteMaxCurvatureEstimator,
    QuadEdgeMeshDiscretePrincipalCurvaturesEstimator );
  /** New macro for creation of through a Smart Pointer   */
  itkNewMacro( Self );

protected:
  QuadEdgeMeshDiscreteMaxCurvatureEstimator() : Superclass() {}
...
private:
  QuadEdgeMeshDiscreteMaxCurvatureEstimator( const Self& );
