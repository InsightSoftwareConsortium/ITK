...
bool MRCHeaderObject::SetExtendedHeader(const void *buffer)
{
  ...
  if (this->m_ExtendedHeaderSize == 128*1024 && this->m_Header.nint == 0 && this->m_Header.nreal == 32)
    ...
    if (this->m_BigEndianHeader)
      ...
      {
      ByteSwapper<float>::SwapRangeFromSystemToLittleEndian((float *)this->m_ExtendedHeader, this->m_ExtendedHeaderSize );
      }
  }
  return true;
}
...
void MRCHeaderObject::PrintSelf(std::ostream& os, Indent indent) const
{
  ...
  os << indent << "start: " << this->m_Header.nxstart << " " << this->m_Header.nystart << " " << this->m_Header.nzstart << std::endl;
  os << indent << "grid: " << this->m_Header.mx  << " " << this->m_Header.my << " " << this->m_Header.mz << std::endl;
  os << indent << "len: " << this->m_Header.xlen << " " << this->m_Header.ylen << " " << this->m_Header.zlen << std::endl;
  os << indent << "abg angles: " << this->m_Header.alpha << " " << this->m_Header.beta << " " << this->m_Header.gamma << std::endl;
  os << indent << "map: " << this->m_Header.mapc << " " << this->m_Header.mapr << " " << this->m_Header.maps << std::endl;
  os << indent << "mmm: " << this->m_Header.amin << " " << this->m_Header.amax << " " << this->m_Header.amean << std::endl;
  ...
  os << indent << "tiltangles: (" << this->m_Header.tiltangles[0] << ", " << this->m_Header.tiltangles[1] << ", " << this->m_Header.tiltangles[2]
     << ") (" << this->m_Header.tiltangles[3] << ", " << this->m_Header.tiltangles[4] << ", " << this->m_Header.tiltangles[5] << ")" << std::endl;
  os << indent << "org: " << this->m_Header.xorg << " " << this->m_Header.yorg << " " << this->m_Header.zorg << std::endl;
  os << indent << "cmap: \"" << this->m_Header.cmap[0] << this->m_Header.cmap[1] << this->m_Header.cmap[2] << this->m_Header.cmap[3] << "\""<< std::endl;
  os << indent << "stamp: "
