...
#ifndef __ITKQUADEDGEMESH__FRONTITERATOR__TXX__
#define __ITKQUADEDGEMESH__FRONTITERATOR__TXX__
...
template< class TMesh, class TQE >
    FrontBaseIterator< TMesh, TQE >::
    FrontBaseIterator( MeshType* mesh,
                       bool      start,
                       QEType*   seed )
 ...
 */
template< class TMesh, class TQE >
    typename FrontBaseIterator< TMesh, TQE >::QEType*
    FrontBaseIterator< TMesh, TQE >::
    FindDefaultSeed( )
    {
...
#endif // __ITKQUADEDGEMESH__FRONTITERATOR__TXX__

// eof - itkQEFrontIterator.txx
