/*=========================================================================
  ...
  Module:    itkLabelImageToShapeLabelMapFilter.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
 ...
 */
template<class TInputImage, class TOutputImage=LabelMap< ShapeLabelObject< typename TInputImage::PixelType, ::itk::GetImageDimension<TInputImage>::ImageDimension> > >
