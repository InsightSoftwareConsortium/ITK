/*=========================================================================
  ...
  Module:    itkQuadEdgeMeshDelaunayConformingFilter.txx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
// ---------------------------------------------------------------------
template< typename TInputMesh, typename TOutputMesh >
void QuadEdgeMeshDelaunayConformingFilter< TInputMesh, TOutputMesh >::InitializePriorityQueue()
{
...
// ---------------------------------------------------------------------
template< typename TInputMesh, typename TOutputMesh >
void QuadEdgeMeshDelaunayConformingFilter< TInputMesh, TOutputMesh >::Process()
{
  OutputMeshType *output = this->GetOutput();
...
// ---------------------------------------------------------------------
template< typename TInputMesh, typename TOutputMesh >
void QuadEdgeMeshDelaunayConformingFilter< TInputMesh, TOutputMesh >::GenerateData()
{
