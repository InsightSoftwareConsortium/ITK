...
/* Subroutine */ int zlarfx_(side, m, n, v, tau, c, ldc, work, side_len)
char *side;
integer *m, *n;
...
/*        w := C'*v */
	...
	zgemv_("Conjugate transpose", m, n, &c_b15, &c[c_offset], ldc, &v[1], 
		&c__1, &c_b2, &work[1], &c__1, 19L);

/*        C := C - tau * v * w' */

	z__1.r = -tau->r, z__1.i = -tau->i;
	zgerc_(m, n, &z__1, &v[1], &c__1, &work[1], &c__1, &c[c_offset], ldc);
	goto L410;
L10:
...
/*        Special code for 1 x 1 Householder */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j * c_dim1 + 1;
	    i__3 = j * c_dim1 + 1;
	    z__1.r = t1.r * c[i__3].r - t1.i * c[i__3].i, z__1.i = t1.r * c[
		    i__3].i + t1.i * c[i__3].r;
	    c[i__2].r = z__1.r, c[i__2].i = z__1.i;
/* L20: */
	}
	goto L410;
L30:
...
/*        Special code for 2 x 2 Householder */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__2.r = v1.r * c[i__2].r - v1.i * c[i__2].i, z__2.i = v1.r * c[
		    i__2].i + v1.i * c[i__2].r;
	    i__3 = j * c_dim1 + 2;
	    z__3.r = v2.r * c[i__3].r - v2.i * c[i__3].i, z__3.i = v2.r * c[
		    i__3].i + v2.i * c[i__3].r;
	    ...
	    z__2.r = sum.r * t1.r - sum.i * t1.i, z__2.i = sum.r * t1.i + 
		    sum.i * t1.r;
	    z__1.r = c[i__3].r - z__2.r, z__1.i = c[i__3].i - z__2.i;
	    c[i__2].r = z__1.r, c[i__2].i = z__1.i;
	    i__2 = j * c_dim1 + 2;
	    i__3 = j * c_dim1 + 2;
...
/*        Special code for 3 x 3 Householder */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__3.r = v1.r * c[i__2].r - v1.i * c[i__2].i, z__3.i = v1.r * c[
		    i__2].i + v1.i * c[i__2].r;
	    i__3 = j * c_dim1 + 2;
	    z__4.r = v2.r * c[i__3].r - v2.i * c[i__3].i, z__4.i = v2.r * c[
		    i__3].i + v2.i * c[i__3].r;
	    z__2.r = z__3.r + z__4.r, z__2.i = z__3.i + z__4.i;
	    i__4 = j * c_dim1 + 3;
	    z__5.r = v3.r * c[i__4].r - v3.i * c[i__4].i, z__5.i = v3.r * c[
		    i__4].i + v3.i * c[i__4].r;
...
/*        Special code for 4 x 4 Householder */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__4.r = v1.r * c[i__2].r - v1.i * c[i__2].i, z__4.i = v1.r * c[
		    i__2].i + v1.i * c[i__2].r;
	    i__3 = j * c_dim1 + 2;
	    z__5.r = v2.r * c[i__3].r - v2.i * c[i__3].i, z__5.i = v2.r * c[
		    i__3].i + v2.i * c[i__3].r;
	    z__3.r = z__4.r + z__5.r, z__3.i = z__4.i + z__5.i;
	    i__4 = j * c_dim1 + 3;
	    z__6.r = v3.r * c[i__4].r - v3.i * c[i__4].i, z__6.i = v3.r * c[
		    i__4].i + v3.i * c[i__4].r;
	    z__2.r = z__3.r + z__6.r, z__2.i = z__3.i + z__6.i;
	    i__5 = j * c_dim1 + 4;
	    z__7.r = v4.r * c[i__5].r - v4.i * c[i__5].i, z__7.i = v4.r * c[
		    i__5].i + v4.i * c[i__5].r;
...
/*        Special code for 5 x 5 Householder */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__5.r = v1.r * c[i__2].r - v1.i * c[i__2].i, z__5.i = v1.r * c[
		    i__2].i + v1.i * c[i__2].r;
	    i__3 = j * c_dim1 + 2;
	    z__6.r = v2.r * c[i__3].r - v2.i * c[i__3].i, z__6.i = v2.r * c[
		    i__3].i + v2.i * c[i__3].r;
	    z__4.r = z__5.r + z__6.r, z__4.i = z__5.i + z__6.i;
	    i__4 = j * c_dim1 + 3;
	    z__7.r = v3.r * c[i__4].r - v3.i * c[i__4].i, z__7.i = v3.r * c[
		    i__4].i + v3.i * c[i__4].r;
	    z__3.r = z__4.r + z__7.r, z__3.i = z__4.i + z__7.i;
	    i__5 = j * c_dim1 + 4;
	    z__8.r = v4.r * c[i__5].r - v4.i * c[i__5].i, z__8.i = v4.r * c[
		    i__5].i + v4.i * c[i__5].r;
	    z__2.r = z__3.r + z__8.r, z__2.i = z__3.i + z__8.i;
	    i__6 = j * c_dim1 + 5;
	    z__9.r = v5.r * c[i__6].r - v5.i * c[i__6].i, z__9.i = v5.r * c[
		    i__6].i + v5.i * c[i__6].r;
...
/*        Special code for 6 x 6 Householder */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__6.r = v1.r * c[i__2].r - v1.i * c[i__2].i, z__6.i = v1.r * c[
		    i__2].i + v1.i * c[i__2].r;
	    i__3 = j * c_dim1 + 2;
	    z__7.r = v2.r * c[i__3].r - v2.i * c[i__3].i, z__7.i = v2.r * c[
		    i__3].i + v2.i * c[i__3].r;
	    z__5.r = z__6.r + z__7.r, z__5.i = z__6.i + z__7.i;
	    i__4 = j * c_dim1 + 3;
	    z__8.r = v3.r * c[i__4].r - v3.i * c[i__4].i, z__8.i = v3.r * c[
		    i__4].i + v3.i * c[i__4].r;
	    z__4.r = z__5.r + z__8.r, z__4.i = z__5.i + z__8.i;
	    i__5 = j * c_dim1 + 4;
	    z__9.r = v4.r * c[i__5].r - v4.i * c[i__5].i, z__9.i = v4.r * c[
		    i__5].i + v4.i * c[i__5].r;
	    z__3.r = z__4.r + z__9.r, z__3.i = z__4.i + z__9.i;
	    i__6 = j * c_dim1 + 5;
	    z__10.r = v5.r * c[i__6].r - v5.i * c[i__6].i, z__10.i = v5.r * c[
		    i__6].i + v5.i * c[i__6].r;
	    z__2.r = z__3.r + z__10.r, z__2.i = z__3.i + z__10.i;
	    i__7 = j * c_dim1 + 6;
	    z__11.r = v6.r * c[i__7].r - v6.i * c[i__7].i, z__11.i = v6.r * c[
		    i__7].i + v6.i * c[i__7].r;
...
/*        Special code for 7 x 7 Householder */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__7.r = v1.r * c[i__2].r - v1.i * c[i__2].i, z__7.i = v1.r * c[
		    i__2].i + v1.i * c[i__2].r;
	    i__3 = j * c_dim1 + 2;
	    z__8.r = v2.r * c[i__3].r - v2.i * c[i__3].i, z__8.i = v2.r * c[
		    i__3].i + v2.i * c[i__3].r;
	    z__6.r = z__7.r + z__8.r, z__6.i = z__7.i + z__8.i;
	    i__4 = j * c_dim1 + 3;
	    z__9.r = v3.r * c[i__4].r - v3.i * c[i__4].i, z__9.i = v3.r * c[
		    i__4].i + v3.i * c[i__4].r;
	    z__5.r = z__6.r + z__9.r, z__5.i = z__6.i + z__9.i;
	    i__5 = j * c_dim1 + 4;
	    z__10.r = v4.r * c[i__5].r - v4.i * c[i__5].i, z__10.i = v4.r * c[
		    i__5].i + v4.i * c[i__5].r;
	    z__4.r = z__5.r + z__10.r, z__4.i = z__5.i + z__10.i;
	    i__6 = j * c_dim1 + 5;
	    z__11.r = v5.r * c[i__6].r - v5.i * c[i__6].i, z__11.i = v5.r * c[
		    i__6].i + v5.i * c[i__6].r;
	    z__3.r = z__4.r + z__11.r, z__3.i = z__4.i + z__11.i;
	    i__7 = j * c_dim1 + 6;
	    z__12.r = v6.r * c[i__7].r - v6.i * c[i__7].i, z__12.i = v6.r * c[
		    i__7].i + v6.i * c[i__7].r;
	    z__2.r = z__3.r + z__12.r, z__2.i = z__3.i + z__12.i;
	    i__8 = j * c_dim1 + 7;
	    z__13.r = v7.r * c[i__8].r - v7.i * c[i__8].i, z__13.i = v7.r * c[
		    i__8].i + v7.i * c[i__8].r;
...
/*        Special code for 8 x 8 Householder */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__8.r = v1.r * c[i__2].r - v1.i * c[i__2].i, z__8.i = v1.r * c[
		    i__2].i + v1.i * c[i__2].r;
	    i__3 = j * c_dim1 + 2;
	    z__9.r = v2.r * c[i__3].r - v2.i * c[i__3].i, z__9.i = v2.r * c[
		    i__3].i + v2.i * c[i__3].r;
	    z__7.r = z__8.r + z__9.r, z__7.i = z__8.i + z__9.i;
	    i__4 = j * c_dim1 + 3;
	    z__10.r = v3.r * c[i__4].r - v3.i * c[i__4].i, z__10.i = v3.r * c[
		    i__4].i + v3.i * c[i__4].r;
	    z__6.r = z__7.r + z__10.r, z__6.i = z__7.i + z__10.i;
	    i__5 = j * c_dim1 + 4;
	    z__11.r = v4.r * c[i__5].r - v4.i * c[i__5].i, z__11.i = v4.r * c[
		    i__5].i + v4.i * c[i__5].r;
	    z__5.r = z__6.r + z__11.r, z__5.i = z__6.i + z__11.i;
	    i__6 = j * c_dim1 + 5;
	    z__12.r = v5.r * c[i__6].r - v5.i * c[i__6].i, z__12.i = v5.r * c[
		    i__6].i + v5.i * c[i__6].r;
	    z__4.r = z__5.r + z__12.r, z__4.i = z__5.i + z__12.i;
	    i__7 = j * c_dim1 + 6;
	    z__13.r = v6.r * c[i__7].r - v6.i * c[i__7].i, z__13.i = v6.r * c[
		    i__7].i + v6.i * c[i__7].r;
	    z__3.r = z__4.r + z__13.r, z__3.i = z__4.i + z__13.i;
	    i__8 = j * c_dim1 + 7;
	    z__14.r = v7.r * c[i__8].r - v7.i * c[i__8].i, z__14.i = v7.r * c[
		    i__8].i + v7.i * c[i__8].r;
	    z__2.r = z__3.r + z__14.r, z__2.i = z__3.i + z__14.i;
	    i__9 = j * c_dim1 + 8;
	    z__15.r = v8.r * c[i__9].r - v8.i * c[i__9].i, z__15.i = v8.r * c[
		    i__9].i + v8.i * c[i__9].r;
...
/*        Special code for 9 x 9 Householder */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__9.r = v1.r * c[i__2].r - v1.i * c[i__2].i, z__9.i = v1.r * c[
		    i__2].i + v1.i * c[i__2].r;
	    i__3 = j * c_dim1 + 2;
	    z__10.r = v2.r * c[i__3].r - v2.i * c[i__3].i, z__10.i = v2.r * c[
		    i__3].i + v2.i * c[i__3].r;
	    z__8.r = z__9.r + z__10.r, z__8.i = z__9.i + z__10.i;
	    i__4 = j * c_dim1 + 3;
	    z__11.r = v3.r * c[i__4].r - v3.i * c[i__4].i, z__11.i = v3.r * c[
		    i__4].i + v3.i * c[i__4].r;
	    z__7.r = z__8.r + z__11.r, z__7.i = z__8.i + z__11.i;
	    i__5 = j * c_dim1 + 4;
	    z__12.r = v4.r * c[i__5].r - v4.i * c[i__5].i, z__12.i = v4.r * c[
		    i__5].i + v4.i * c[i__5].r;
	    z__6.r = z__7.r + z__12.r, z__6.i = z__7.i + z__12.i;
	    i__6 = j * c_dim1 + 5;
	    z__13.r = v5.r * c[i__6].r - v5.i * c[i__6].i, z__13.i = v5.r * c[
		    i__6].i + v5.i * c[i__6].r;
	    z__5.r = z__6.r + z__13.r, z__5.i = z__6.i + z__13.i;
	    i__7 = j * c_dim1 + 6;
	    z__14.r = v6.r * c[i__7].r - v6.i * c[i__7].i, z__14.i = v6.r * c[
		    i__7].i + v6.i * c[i__7].r;
	    z__4.r = z__5.r + z__14.r, z__4.i = z__5.i + z__14.i;
	    i__8 = j * c_dim1 + 7;
	    z__15.r = v7.r * c[i__8].r - v7.i * c[i__8].i, z__15.i = v7.r * c[
		    i__8].i + v7.i * c[i__8].r;
	    z__3.r = z__4.r + z__15.r, z__3.i = z__4.i + z__15.i;
	    i__9 = j * c_dim1 + 8;
	    z__16.r = v8.r * c[i__9].r - v8.i * c[i__9].i, z__16.i = v8.r * c[
		    i__9].i + v8.i * c[i__9].r;
	    z__2.r = z__3.r + z__16.r, z__2.i = z__3.i + z__16.i;
	    i__10 = j * c_dim1 + 9;
	    z__17.r = v9.r * c[i__10].r - v9.i * c[i__10].i, z__17.i = v9.r * 
		    c[i__10].i + v9.i * c[i__10].r;
...
/*        Special code for 10 x 10 Householder */
	...
	for (j = 1; j <= i__1; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__10.r = v1.r * c[i__2].r - v1.i * c[i__2].i, z__10.i = v1.r * c[
		    i__2].i + v1.i * c[i__2].r;
	    i__3 = j * c_dim1 + 2;
	    z__11.r = v2.r * c[i__3].r - v2.i * c[i__3].i, z__11.i = v2.r * c[
		    i__3].i + v2.i * c[i__3].r;
	    z__9.r = z__10.r + z__11.r, z__9.i = z__10.i + z__11.i;
	    i__4 = j * c_dim1 + 3;
	    z__12.r = v3.r * c[i__4].r - v3.i * c[i__4].i, z__12.i = v3.r * c[
		    i__4].i + v3.i * c[i__4].r;
	    z__8.r = z__9.r + z__12.r, z__8.i = z__9.i + z__12.i;
	    i__5 = j * c_dim1 + 4;
	    z__13.r = v4.r * c[i__5].r - v4.i * c[i__5].i, z__13.i = v4.r * c[
		    i__5].i + v4.i * c[i__5].r;
	    z__7.r = z__8.r + z__13.r, z__7.i = z__8.i + z__13.i;
	    i__6 = j * c_dim1 + 5;
	    z__14.r = v5.r * c[i__6].r - v5.i * c[i__6].i, z__14.i = v5.r * c[
		    i__6].i + v5.i * c[i__6].r;
	    z__6.r = z__7.r + z__14.r, z__6.i = z__7.i + z__14.i;
	    i__7 = j * c_dim1 + 6;
	    z__15.r = v6.r * c[i__7].r - v6.i * c[i__7].i, z__15.i = v6.r * c[
		    i__7].i + v6.i * c[i__7].r;
	    z__5.r = z__6.r + z__15.r, z__5.i = z__6.i + z__15.i;
	    i__8 = j * c_dim1 + 7;
	    z__16.r = v7.r * c[i__8].r - v7.i * c[i__8].i, z__16.i = v7.r * c[
		    i__8].i + v7.i * c[i__8].r;
	    z__4.r = z__5.r + z__16.r, z__4.i = z__5.i + z__16.i;
	    i__9 = j * c_dim1 + 8;
	    z__17.r = v8.r * c[i__9].r - v8.i * c[i__9].i, z__17.i = v8.r * c[
		    i__9].i + v8.i * c[i__9].r;
	    z__3.r = z__4.r + z__17.r, z__3.i = z__4.i + z__17.i;
	    i__10 = j * c_dim1 + 9;
	    z__18.r = v9.r * c[i__10].r - v9.i * c[i__10].i, z__18.i = v9.r * 
		    c[i__10].i + v9.i * c[i__10].r;
	    z__2.r = z__3.r + z__18.r, z__2.i = z__3.i + z__18.i;
	    i__11 = j * c_dim1 + 10;
	    z__19.r = v10.r * c[i__11].r - v10.i * c[i__11].i, z__19.i = 
		    v10.r * c[i__11].i + v10.i * c[i__11].r;
...
/*        w := C * v */
	...
	zgemv_("No transpose", m, n, &c_b15, &c[c_offset], ldc, &v[1], &c__1, 
		&c_b2, &work[1], &c__1, 12L);

/*        C := C - tau * w * v' */

	z__1.r = -tau->r, z__1.i = -tau->i;
	zgerc_(m, n, &z__1, &work[1], &c__1, &v[1], &c__1, &c[c_offset], ldc);
	goto L410;
L210:
