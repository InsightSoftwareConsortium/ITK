...
#ifndef __itk_ROIStrandSpatialObject_txx_
#define __itk_ROIStrandSpatialObject_txx_
...
::Plane()
{
  ...
  for(i = 0; i < 3; i++)
    {
    min[i] = NumericTraits<double>::NonpositiveMin();
    max[i] = NumericTraits<double>::max();
    }
  while (it != itend)
    {
