/*=========================================================================
  ...
  Module:    itkConnectedConfidenceIntervalImageFilter.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkConnectedConfidenceIntervalImageFilter_h
#define __itkConnectedConfidenceIntervalImageFilter_h
...
/** /class ConnectedConfidenceIntervalImageFilter
 * /brief 
 *
...
public:
  ...
  typedef ConnectedConfidenceIntervalImageFilter Self;
  ...
  itkTypeMacro(ConnectedConfidenceIntervalImageFilter,
               ImageToImageFilter);
...
protected:
  ConnectedConfidenceIntervalImageFilter();
  ~ConnectedConfidenceIntervalImageFilter(){};
...
private:
  ConnectedConfidenceIntervalImageFilter(const Self&); //purposely not implemented
...
#include "itkConnectedConfidenceIntervalImageFilter.txx"
#endif
