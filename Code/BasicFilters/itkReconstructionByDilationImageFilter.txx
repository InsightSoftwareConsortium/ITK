/*=========================================================================
  ...
  Module:    itkReconstructionByDilationImageFilter.txx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkReconstructionByDilationImageFilter_txx
#define __itkReconstructionByDilationImageFilter_txx
...
ReconstructionByDilationImageFilter<TInputImage, TOutputImage>
...
template <class TInputImage, class TOutputImage>
const typename ReconstructionByDilationImageFilter<TInputImage, TOutputImage>::MarkerImageType *
ReconstructionByDilationImageFilter<TInputImage, TOutputImage>
::GetMarkerImage()
{
...
template <class TInputImage, class TOutputImage>
const typename ReconstructionByDilationImageFilter<TInputImage, TOutputImage>::MaskImageType *
ReconstructionByDilationImageFilter<TInputImage, TOutputImage>
::GetMaskImage()
{
...
::GenerateData()
{
  ...
  SetType* smallestPixels = &(pixelMap[ pixelMap.begin()->first ]);
  smallestPixels->clear();
  ...
  // set boundary condition to minimum possible value, so we will
  // never try to set pixel value outside output image
  ConstantBoundaryCondition<MaskImageType> cbc;
  cbc.SetConstant(NumericTraits<MaskImagePixelType>::NonpositiveMin());
