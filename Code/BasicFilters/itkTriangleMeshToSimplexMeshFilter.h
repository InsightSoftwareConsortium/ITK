...
Module:    itkTriangleMeshToSimplexMeshFilter.h
Language:  C++
Date:      $Date$
Version:   $Revision$
...
=========================================================================*/
#ifndef __TriangleMeshToSimplexMeshFilter_h
...
class TriangleMeshToSimplexMeshFilter : public MeshToMeshFilter<TInputMesh, TOutputMesh>
  ...
  */
  InputCellAutoPointer NewInputMeshCellPointer;
...
#endif //_TRIANGLE_MESH_TO_SIMPLEX_MESH_FILTER_H
