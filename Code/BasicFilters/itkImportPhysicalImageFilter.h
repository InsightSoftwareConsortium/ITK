/*=========================================================================
  ...
  Module:    itkImportPhysicalImageFilter.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkImportPhysicalImageFilter_h
#define __itkImportPhysicalImageFilter_h
...
/** \class ImportPhysicalImageFilter
 * \brief Import data from a standard C array into an itk::Image
 *
 * ImportPhysicalImageFilter provides a mechanism for importing data
 * into an itk::Image.  ImportPhysicalImageFilter is an image source,
 * so it behaves like any other pipeline object.
 *
...
class ITK_EXPORT ImportPhysicalImageFilter : public ImageSource<PhysicalImage<TPixel, VImageDimension, ImportImageContainer<unsigned long, TPixel> > >
{
public:
  /**
   * Standard "Self" typedef.
   */
  typedef ImportPhysicalImageFilter   Self;

  /**
   * Typedef for the output image.  
   */
  typedef PhysicalImage<TPixel, VImageDimension, ImportImageContainer<unsigned long, TPixel> > OutputImageType;
   ...
   */
  itkTypeMacro(ImportPhysicalImageFilter,ImageSource);
...
#include "itkImportPhysicalImageFilter.txx"
#endif
