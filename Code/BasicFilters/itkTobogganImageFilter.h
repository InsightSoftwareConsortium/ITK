...
class ITK_EXPORT TobogganImageFilter : 
    public ImageToImageFilter<TInputImage, Image<unsigned long, TInputImage::ImageDimension> >
{
public:
  ...
  typedef Image<unsigned long, TInputImage::ImageDimension> OutputImageType;
