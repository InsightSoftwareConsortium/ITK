...
IF(WRAP_unsigned_int)
  SET(WRAP_ITK_INT ${WRAP_ITK_INT} "UI")
ENDIF(WRAP_unsigned_int)
...
IF(WRAP_signed_int)
  SET(WRAP_ITK_SIGN_INT ${WRAP_ITK_SIGN_INT} "SI")
ENDIF(WRAP_signed_int)
...
SET(WRAP_ITK_INTEGRAL ${WRAP_ITK_SIGN_INT} ${WRAP_ITK_INT})
SET(WRAP_ITK_SCALAR ${WRAP_ITK_INTEGRAL} ${WRAP_ITK_REAL})
...
INTERSECTION(SMALLER_THAN_UL "US;UC;SL;SS;SC" "${WRAP_ITK_INTEGRAL}")
INTERSECTION(SMALLER_THAN_US "UC;SC" "${WRAP_ITK_INTEGRAL}")
INTERSECTION(SMALLER_THAN_SL "US;UC;SS;SC" "${WRAP_ITK_INTEGRAL}")
INTERSECTION(SMALLER_THAN_SS "UC;SC" "${WRAP_ITK_INTEGRAL}")
