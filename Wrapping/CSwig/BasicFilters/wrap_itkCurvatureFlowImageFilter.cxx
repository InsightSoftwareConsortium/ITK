...
namespace _cable_
{
  ...
  namespace wrappers
  {
    ...
    ITK_WRAP_OBJECT2(CurvatureFlowImageFilter, image::US2, image::US2,
                     itkCurvatureFlowImageFilterUS2US2);
    ITK_WRAP_OBJECT2(CurvatureFlowImageFilter, image::US3, image::US3,
                     itkCurvatureFlowImageFilterUS3US3);
  }
}
