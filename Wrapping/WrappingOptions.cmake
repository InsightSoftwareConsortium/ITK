...
if(ITK_WRAP_unsigned_long)
  message(
    WARNING
    "ITK_WRAP_unsigned_long is deprecated. Please use ITK_WRAP_unsigned_long_long instead."
  )
endif()
cmake_dependent_option(
...
if(ITK_WRAP_signed_long)
  message(
    WARNING
    "ITK_WRAP_signed_long is deprecated. Please use ITK_WRAP_signed_long_long instead."
  )
endif()
cmake_dependent_option(
...
if(ITK_WRAPPING)
  ...
  foreach(t float double)
    ...
    if(ITK_WRAP_vector_${t} AND NOT ITK_WRAP_${t})
      message(
        SEND_ERROR
        "To use 'ITK_WRAP_vector_${t}', please set 'ITK_WRAP_${t}' to ON"
      )
    endif()
    ...
    if(ITK_WRAP_covariant_vector_${t} AND NOT ITK_WRAP_${t})
      message(
        SEND_ERROR
        "To use 'ITK_WRAP_covariant_vector_${t}', please set 'ITK_WRAP_${t}' to ON"
      )
    endif()
    ...
    if(ITK_WRAP_complex_${t} AND NOT ITK_WRAP_${t})
      message(
        SEND_ERROR
        "To use 'ITK_WRAP_complex_${t}', please set 'ITK_WRAP_${t}' to ON"
      )
    endif()
  endforeach()
  ...
  foreach(t unsigned_char unsigned_short)
    if(ITK_WRAP_rgb_${t} AND NOT ITK_WRAP_${t})
      message(
        SEND_ERROR
        "To use 'ITK_WRAP_rgb_${t}', please set 'ITK_WRAP_${t}' to ON"
      )
    endif()
    ...
    if(ITK_WRAP_rgba_${t} AND NOT ITK_WRAP_${t})
      message(
        SEND_ERROR
        "To use 'ITK_WRAP_rgba_${t}', please set 'ITK_WRAP_${t}' to ON"
      )
    endif()
  endforeach()
