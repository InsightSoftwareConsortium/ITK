...
void
TclCommand::SetInterpreter(Tcl_Interp * interp)
{
...
Tcl_Interp *
TclCommand::GetInterpreter() const
{
...
void
TclCommand::SetCommandString(const char * commandString)
{
...
const char *
TclCommand::GetCommandString() const
{
...
void
TclCommand::Execute(Object *, const EventObject &)
{
  this->TclExecute();
}
...
void
TclCommand::Execute(const Object *, const EventObject &)
{
  this->TclExecute();
}
...
TclCommand::TclExecute() const
{
  ...
  if (Tcl_GlobalEval(m_Interpreter, const_cast<char *>(m_CommandString.c_str())) == TCL_ERROR)
  {
    ...
    itkWarningMacro("Error returned from itk/tcl callback:\n"
                    << m_CommandString.c_str() << std::endl
                    << errorInfo << " at line number " << m_Interpreter->errorLine);
  }
}
